...
class CreateGlobalchargesView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists(views_globalcharges);
    }
}
