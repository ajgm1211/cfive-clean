...
class UpdatedProcedureGcfcladmTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS select_globalcharge_adm; CREATE  PROCEDURE `select_globalcharge_adm`(IN comp_id int,IN carr_code int)
SELECT 
        `gc`.`id` AS `id`,
        `sr`.`name` AS `charge`,
