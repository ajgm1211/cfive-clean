...
class AddProcedureSelectGlobalchargeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS select_globalcharge; CREATE PROCEDURE select_globalcharge(IN account_id int)
