...
class AddProcedureExcelDonwloadFile extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS proc_getLocalChargeExcel;CREATE PROCEDURE proc_getLocalChargeExcel (
            IN idcontract INT,
            IN port_o INT,
            IN port_d INT,
            IN country_o INT,
