                                            ...
                                            <tbody style="background-color: white;">
                                               <?php $__currentLoopData = $rate->charge_lcl_air; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  ...
                                                  <td>
                                                    ...
                                                    <a href="#" class="editable-lcl-air-lcl-air" data-source="<?php echo e($surcharges); ?>" data-type="select" data-name="surcharge_id" data-value="<?php echo e($item->surcharge_id); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Select surcharge"></a>
                                                  </td>
                                                  <td>
                                                    <a href="#" class="editable-lcl-air" data-source="<?php echo e($calculation_types); ?>" data-type="select" data-name="calculation_type_id" data-value="<?php echo e($item->calculation_type_id); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Select calculation type"></a>
                                                  </td>
                                                  <td >
                                                  ...
                                                  <td>
                                                    <?php echo e($item->units*$item->price_per_unit); ?>
                                              ...
                                              <!--<tr>
                                                ...
                                                <td <?php echo e($equipmentHides['20']); ?> colspan="3"><?php echo e(number_format(@$sum20, 2, '.', '')); ?></td>
                                                <td <?php echo e($equipmentHides['40']); ?> colspan="3"><?php echo e(number_format(@$sum40, 2, '.', '')); ?></td>
                                                <td <?php echo e($equipmentHides['40hc']); ?> colspan="3"><?php echo e(number_format(@$sum40hc, 2, '.', '')); ?></td>
                                                <td <?php echo e($equipmentHides['40nor']); ?> colspan="3"><?php echo e(number_format(@$sum40nor, 2, '.', '')); ?></td>
                                                <td <?php echo e($equipmentHides['45']); ?> colspan="3"><?php echo e(number_format(@$sum45, 2, '.', '')); ?></td>
                                              ...
                                              <?php $__currentLoopData = $rate->charge_lcl_air; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($item->type_id==1): ?>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td>
                                                      <a href="#" class="editable-lcl-air calculation_type_id" data-source="<?php echo e($calculation_types); ?>" data-name="calculation_type_id" data-type="select" data-value="<?php echo e($item->calculation_type_id); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Select calculation type"></a>
                                                    </td>
                                                    <td >
                                        ...
                                        <div class="table-responsive">
                                          <table class="table table-sm table-bordered color-blue text-center">
                                            ...
                                            <tbody style="background-color: white;">
                                              ...
                                              <!--<tr>
                                                <td class="title-quote size-12px" colspan="2">Total</td>
                                                <td <?php echo e($equipmentHides['20']); ?> colspan="3"><?php echo e(number_format(@$sum_destination_20, 2, '.', '')); ?></td>
                                                <td <?php echo e($equipmentHides['40']); ?> colspan="3"><?php echo e(number_format(@$sum_destination_40, 2, '.', '')); ?></td>
                                                <td <?php echo e($equipmentHides['40hc']); ?> colspan="3"><?php echo e(number_format(@$sum_destination_40hc, 2, '.', '')); ?></td>
                                                <td <?php echo e($equipmentHides['40nor']); ?> colspan="3"><?php echo e(number_format(@$sum_destination_40nor, 2, '.', '')); ?></td>
                                                <td <?php echo e($equipmentHides['45']); ?> colspan="3"><?php echo e(number_format(@$sum_destination_45, 2, '.', '')); ?></td>
                                                <td ><?php echo e($currency_cfg->alphacode); ?></td>
                                              </tr>-->
                                              <?php endif; ?>
                                            </tbody>
                                              ...
                                              <div class="details_inland_<?php echo e($x); ?> hide">
                                                <table class="table table-sm table-bordered color-blue text-center">
                                                  ...
                                                  <tbody style="background-color: white;">
                                                    <tr >
                                                      <td>
                                                        <a href="#" class="editable-lcl-air" data-source="<?php echo e($surcharges); ?>" data-type="text" data-value="<?php echo e($inland->provider); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Charge"></a>
                                                      </td>
                                                      <td>
                                                        <a href="#" class="editable-lcl-air-amount-20 amount_20" data-type="text" data-name="amount->c20" data-value="<?php echo e(@$inland->distance); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Amount"></a> &nbsp;km
                                                      </td>
                                                      <td <?php echo e($equipmentHides['20']); ?>>
                                                        <a href="#" class="editable-lcl-air-amount-20 amount_20" data-type="text" data-name="amount->c20" data-value="<?php echo e(@$inland_rates['c20']); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Amount"></a>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['20']); ?>>
                                                        <a href="#" class="editable-lcl-air-markup-20 markup_20" data-type="text" data-name="markups->20" data-value="<?php echo e(@$inland_markups['c20']); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Markup"></a>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['20']); ?>>
                                                        <span class="total_20"><?php echo e(@$inland_rates['c20']+@$inland_markups['c20']); ?></span>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['40']); ?>>
                                                        <a href="#" class="editable-lcl-air-amount-40 amount_40"data-type="text" data-name="amount->c40" data-value="<?php echo e(@$inland_rates['c40']); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Total"></a>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['40']); ?>>
                                                        <a href="#" class="editable-lcl-air-markup-40 markup_40"data-type="text" data-name="markups->40" data-value="<?php echo e(@$inland_markups['c40']); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Total"></a>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['40']); ?>>
                                                        <span class="total_40"><?php echo e(@$inland_rates['c40']+@$inland_markups['c40']); ?></span>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['40hc']); ?>>
                                                        <a href="#" class="editable-lcl-air-amount-40hc amount_40hc"data-type="text" data-name="amount->c40hc" data-value="<?php echo e(@$inland_amounts['c40hc']); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Total"></a>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['40hc']); ?>>
                                                        <a href="#" class="editable-lcl-air-markup-40hc markup_40hc"data-type="text" data-name="markups->40hc" data-value="<?php echo e(@$inland_markups['c40hc']); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Total"></a>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['40hc']); ?>>
                                                        <span class="total_40hc"><?php echo e(@$inland_amounts['c40hc']+@$inland_markups['c40hc']); ?></span>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['40nor']); ?>>
                                                        <a href="#" class="editable-lcl-air-amount-40nor amount_40nor "data-type="text" data-name="amount->c40nor" data-value="<?php echo e(@$inland_amounts['c40nor']); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Total"></a>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['40nor']); ?>>
                                                        <a href="#" class="editable-lcl-air-markup-40nor markup_40nor"data-type="text" data-name="markups->40nor" data-value="<?php echo e(@$inland_markups['c40nor']); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Total"></a>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['40nor']); ?>>
                                                        <span class="total_40nor"><?php echo e(@$inland_amounts['c40nor']+@$inland_markups['c40nor']); ?></span>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['45']); ?>>
                                                        <a href="#" class="editable-lcl-air-amount-45 amount_45" data-type="text" data-name="amount->45" data-value="<?php echo e(@$inland_amounts['c45']); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Total"></a>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['45']); ?>>
                                                        <a href="#" class="editable-lcl-air-markup-45 markup_45" data-type="text" data-name="markups->45" data-value="<?php echo e(@$inland_markups['c45']); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Total"></a>
                                                      </td>
                                                      <td <?php echo e($equipmentHides['45']); ?>>
                                                        <span class="total_45"><?php echo e(@$inland_amounts['c45']+@$inland_markups['c45']); ?></span>
                                                      </td>
                                                      <td>
                                                        <a href="#" class="editable-lcl-air" data-source="<?php echo e($currencies); ?>" data-type="select" data-name="currency_id" data-value="<?php echo e($inland->currency_id); ?>" data-pk="<?php echo e(@$item->id); ?>" data-title="Select currency"></a>
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
