  ...
  <!-- input with currency id -->
    ...
    <div class="row">
      <div class="col-lg-10 col-md-10 col-sm-10 col-12">
        <?php if(count($company_user->company_user_id)>0): ?>
          <div class="row">
                                    ...
                                    <div class="tab-pane fade active show" id="tab_1_1">
                                      <div class="row">
                                        <div class="col-md-4">
                                          ...
                                          <div class="m-bootstrap-touchspin-brand">
                                            <div class="input-group">
                                              <input type="number" id="total_quantity" name="total_quantity" min="0" step="0.0000001" class="total_quantity form-control" placeholder="" aria-label="...">
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <div class="m-bootstrap-touchspin-brand">
                                            <div class="input-group">
                                              <input type="number" id="total_weight" name="total_weight" min="0" step="0.0000001" class="total_weight form-control" placeholder="" aria-label="...">
                                              <div class="input-group-btn">
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <div class="m-bootstrap-touchspin-brand">
                                            <div class="input-group">
                                              <input type="number" id="total_volume" name="total_volume" min="0" step="0.0000001" class="total_volume form-control" placeholder="" aria-label="...">
                                              <div class="input-group-btn">
                            ...
                            <div class="col-lg-10">
                              <div class="row">
                                <div class="col-md-2">
                                  ...
                                  <?php echo e(Form::select('modality',['1' => 'Export','2' => 'Import'],null,['class'=>'m-select2-general form-control','required'=>'true','id'=>'modality'])); ?>

                                </div>
                                <div class="col-md-2">
                                  <label>Incoterm</label>
                                  <?php echo e(Form::select('incoterm',$incoterm,null,['class'=>'m-select2-general form-control','required'=>'true'])); ?>
                                ...
                                <div class="col-md-5" id="delivery_type_air_label" style="display: none;">
                                  <label>Delivery type</label>
                                  <?php echo e(Form::select('delivery_type',['5' => 'AIRPORT(Origin) To AIRPORT(Destination)','6' => 'AIRPORT(Origin) To DOOR(Destination)','7'=>'DOOR(Origin) To AIRPORT(Destination)','8'=>'DOOR(Origin) To DOOR(Destination)'],null,['class'=>'m-select2-general form-control','id'=>'delivery_type_air'])); ?>

                                </div>
                                <div class="col-md-3">
                                  <label>Pick up date</label>
                                  <div class="input-group date">
                                    <?php echo Form::text('pick_up_date', null, ['id' => 'm_datepicker_2' ,'placeholder' => 'Select a date','class' => 'form-control m-input pick_up_date','required'=>'true','autocomplete'=>'off']); ?>
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                  <div id="origin_harbor_label">
                                    ...
                                    <?php echo e(Form::select('origin_harbor_id',$harbors,null,['class'=>'m-select2-general form-control','id'=>'origin_harbor','placeholder'=>'Select an option'])); ?>
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                  <div id="destination_harbor_label">
                                    ...
                                    <?php echo e(Form::select('destination_harbor_id',$harbors,null,['class'=>'m-select2-general form-control','id'=>'destination_harbor','placeholder'=>'Select an option'])); ?>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                  <div class="input-group date">
                                    <?php echo Form::text('validity_date', null, ['placeholder' => 'Validity','class' => 'form-control m-input','readonly'=>true,'id'=>'m_daterangepicker_1','required' => 'required']); ?>
                              ...
                              <div class="row">
                                <div class="col-md-4" id="carrier_label">
                                  ...
                                  <div class="form-group">
                                    <?php echo e(Form::select('carrier_id',$carriers,null,['class'=>'custom-select form-control','id' => 'carrier_id','placeholder'=>'Choose an option'])); ?>
                            ...
                            <div class="col-lg-10">
                              <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                  <label>Company</label>
                                  <?php echo e(Form::select('company_id',$companies,null,['placeholder' => 'Please choose a option','class'=>'m-select2-general form-control company_id','id' => 'm_select2_2_modal','required'=>true])); ?><br><br>
                                ...
                                <div class="col-md-4 col-sm-4 ol-xs-12">
                                  <label>Contact</label>
                                  <?php echo e(Form::select('contact_id',[],null,['class'=>'m-select2-general form-control contact_id','required'=>true,'id'=>'contact_id'])); ?><br><br>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <table class="table table-bordered color-blue">
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                              <div class="btn-group">
                                                <?php echo e(Form::select('origin_ammount_currency[]',$currencies,$currency_cfg->id,['class'=>'form-control origin_ammount_currency select2-origin select-2-width'])); ?>
                                        ...
                                        <td>
                                          <input id="origin_total_ammount" name="origin_total_ammount[]" value="" class="form-control origin_total_ammount" type="number" step="0.0000001" min="0"/>
                                        </td>
                                        <td>
                                          <input id="origin_ammount_markup" name="origin_ammount_markup[]" value="" class="form-control origin_ammount_markup" type="number" step="0.0000001" min="0"/>
                                        </td>
                                        <td>
                                          <div class="form-group">
                                            <div class="input-group">
                                              <input type="number" name="origin_total_ammount_2[]" step="0.0000001" min="0" value="" class="origin_total_ammount_2 form-control" aria-label="...">
                                            </div>
                                          </div>
                                        </td>
                                      </tr>
                                      <tr class="hide" id="origin_ammounts">
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <div class="input-group">
                                              <input type="text" name="origin_total_ammount_2[]" step="0.0000001" min="0" value="" class="origin_total_ammount_2 form-control" aria-label="...">
                              ...
                              <div class='row'>
                                <div class="col-md-12">
                                  <h5 class="title-quote pull-right">
                                    Sub-Total: <span id="sub_total_origin"></span>&nbsp;<?php if(isset($currency_cfg->alphacode)): ?><?php echo e($currency_cfg->alphacode); ?><?php endif; ?>
                                  ...
                                  <div class="table-responsive">
                                    <table class="table table-bordered color-blue">
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                              <div class="btn-group">
                                                <?php echo e(Form::select('freight_ammount_currency[]',$currencies,$currency_cfg->id,['class'=>'form-control freight_ammount_currency select2-freight select-2-width','required'=>true])); ?>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <div class="input-group">
                                              <input type="number" name="freight_total_ammount_2[]" step="0.0000001" min="0" value="" class="freight_total_ammount_2 form-control" aria-label="..." required>
                                            </div>
                                          </div>
                                        </td>
                                      </tr>
                                      ...
                                      <tr class="hide" id="freight_ammounts">
                                        ...
                                        <td>
                                          <input id="freight_total_ammount" name="freight_total_ammount[]" value="" class="form-control freight_total_ammount" type="number" step="0.0000001" min="0"/>
                                        </td>
                                        <td>
                                          <input id="freight_ammount_markup" name="freight_ammount_markup[]" value="" class="form-control freight_ammount_markup" type="number" step="0.0000001" min="0"/>
                                        </td>
                                        <td>
                                          <div class="form-group">
                                            <div class="input-group">
                                              <input type="number" name="freight_total_ammount_2[]"  value="" class="freight_total_ammount_2 form-control" aria-label="..." step="0.0000001" min="0"/>
                              ...
                              <div class='row'>
                                <div class="col-md-12">
                                  <h5 class="title-quote pull-right">
                                    Sub-Total: <span id="sub_total_freight"></span>&nbsp;<?php if(isset($currency_cfg->alphacode)): ?><?php echo e($currency_cfg->alphacode); ?><?php endif; ?>
                                  ...
                                  <div class="table-responsive">
                                    <table class="table table-bordered color-blue">
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                              <div class="btn-group">
                                                <?php echo e(Form::select('destination_ammount_currency[]',$currencies,$currency_cfg->id,['class'=>'form-control destination_ammount_currency select2-destination select-2-width'])); ?>
                                        ...
                                        <td>
                                          <input id="destination_total_ammount" name="destination_total_ammount[]" value="" class="form-control destination_total_ammount" type="number" step="0.0000001" min="0"/>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <div class="input-group">
                                              <input type="number" name="destination_total_ammount_2[]" step="0.0000001" min="0" value="" class="destination_total_ammount_2 form-control" aria-label="...">
                                            </div>
                                          </div>
                                        </td>
                                      </tr>
                                      ...
                                      <tr class="hide" id="destination_ammounts">
                                        ...
                                        <td>
                                          <div class="input-group">
                                            <input type="number" id="destination_price_per_unit" name="destination_price_per_unit[]" value="" min="0" step="0.0000001" class="destination_price_per_unit form-control" aria-label="..." style="width: 100px !important;">
                                            <div class="input-group-btn">
                                              <div class="btn-group">
                              ...
                              <div class='row'>
                                <div class="col-md-12">
                                  <h5 class="title-quote pull-right">
                                    Sub-Total: <span id="sub_total_destination"></span>&nbsp;<?php if(isset($currency_cfg->alphacode)): ?><?php echo e($currency_cfg->alphacode); ?><?php endif; ?>
                              ...
                              <div class='row'>
                                <div class="col-md-12">
                                  <h5 class="title-quote pull-right size-16px">
                                    Total: <span id="total"></span>&nbsp;<?php if(isset($currency_cfg->alphacode)): ?><?php echo e($currency_cfg->alphacode); ?><?php endif; ?>
                                  </h5>
                                </div>
                              </div>
                              <hr>
                              <div class="row">
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <div class="" style="margin-bottom:40px;">
                                    <?php echo Form::textarea('term', null, ['placeholder' => 'Please enter your export text','class' => 'form-control m-input','id'=>'terms_and_conditions']); ?>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-12">
                                  <br>
                                  <div class="" style="margin-bottom:40px;">
                                    <?php echo Form::textarea('payment_conditions', null, ['placeholder' => 'Please enter your payment conditions text','class' => 'form-control m-input','id'=>'payment_conditions']); ?>
                ...
                <div class="m-portlet__head">
                  <div class="m-portlet__head-tools">
                    <ul class="nav nav-tabs m-tabs m-tabs-line   m-tabs-line--right m-tabs-line-danger" role="tablist">
                      <li class="nav-item m-tabs__item" style="padding-top: 20px;padding-bottom: 20px;">
                        <a href="<?php echo e(url('settings')); ?>" class="btn btn-primary" role="tab">
                          Go to settings
                        </a>
                      </li>
                    </ul>
      ...
      <div class="col-lg-2 col-md-2 col-sm-2 col-12 desktop">
        ...
        <?php echo Form::select('pdf_language', [1=>'English',2=>'Spanish',3=>'Portuguese'],null, ['placeholder' => 'Please choose a option','class' => 'form-control','id'=>'pdf_language']); ?>
        ...
        <?php echo Form::select('pdf_ammounts', [1=>'Main Currency',2=>'Original amounts'],$user->companyUser->pdf_ammounts, ['placeholder' => 'Please choose a option','class' => 'form-control','id'=>'pdf_ammounts']); ?>

        <hr>
        <label class="title-quote title-quote size-14px">Carrier visibility</label>
        <?php echo Form::select('hide_carrier', [true=>'Hide',false=>'Show'],null, ['placeholder' => 'Please choose a option','class' => 'form-control','id'=>'hide_carrier']); ?>
...
<?php $__env->startSection('js'); ?>
  ...
  <script src="<?php echo e(asset('/js/quote.js')); ?>"></script>
