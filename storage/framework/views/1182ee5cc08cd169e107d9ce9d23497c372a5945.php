...
<?php $__env->startSection('title', 'Importation GlobalCharge'); ?>
...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--full-height">
        ...
        <?php echo Form::open(['route'=>'Upload.File.Globalcharges.Fcl','method'=>'PUT','files'=>true, 'id' => 'formupload']); ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <?php echo Form::date('date',\Carbon\Carbon::now(),['id'=>'dateid',
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="col-form-label" hidden="hidden" id="datevaiditydiv">
                                        <?php echo Form::text('validitydate','Please enter validation date',['class'=>'form-control m-input datevalidityinp','id'=>'m_daterangepicker_1','placeholder' => 'Date Validity' ]); ?>
...
<script src="<?php echo e(asset('js/Globalchargers/ImporttationGlobalchargersFcl.js')); ?>"></script>
