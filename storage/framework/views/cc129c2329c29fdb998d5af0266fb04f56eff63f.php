...
*/
    function showModal(selector,id){
        if(selector == 1){
            var url = '<?php echo e(route("load.View.add.region")); ?>';
            $('#modal-body').load(url,function(){
                $('#addRegionModal').modal();
            });
        } else if(selector == 2){
            var url = '<?php echo e(route("Region.show",":id")); ?>';
    ...
    $(document).on('click','.BorrarRegion', function(e){
        ...
        swal({
            ...
            if (result.value) {
                ...
                url='<?php echo route("Region.destroy",":id"); ?>';
                url = url.replace(':id', id);
    ...
    $(function() {
        $('#myatest').DataTable({
            processing: true,
            //serverSide: true,
            ajax: '<?php echo route("Region.create"); ?>',
            columns: [
                { data: 'id', name: 'id' },
                { data: 'name', name: 'name' },
