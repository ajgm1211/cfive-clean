  ...
  <div class="col-lg-12 no-padding">
    <div class="row card__quote-manual justify-content-between">
      <div class="col-lg-2" class="" id="carrier_label"> 
        ...
        <?php echo e(Form::select('carrieManual',$carrierMan,@$form['carrieManual'],['class'=>'m-select2-general form-control','id'=>'carrieManual','required' => 'true'])); ?>
                ...
                <div class="col-lg-12">
                  ...
                  <div class="row data-rates">
                    ...
                    <div class="col-lg-6 colorphacode">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>><?php echo e($equipmentHides['20']); ?><span class="bg-rates" id ='valor-d20<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>'><?php echo e(@$inlandDestiny['inlandDetails']['i20']['sub_in']); ?></span><i class="la la-caret-right"></i><b class="monto-down"><?php echo e(@$inlandDestiny['inlandDetails']['i20']['markup']); ?></b>
                        </div>

                        <div class="wth" <?php echo e($equipmentHides['40']); ?>><?php echo e($equipmentHides['40']); ?>

                          <span class="bg-rates" id = 'valor-d40<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>' ><?php echo e(@$inlandDestiny['inlandDetails']['i40']['sub_in']); ?></span> 
                          <i class="la la-caret-right"></i><b class="monto-down"> <?php echo e(@$inlandDestiny['inlandDetails']['i40']['markup']); ?> </b>
                        </div>

                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>><?php echo e($equipmentHides['40hc']); ?>

                          <span class="bg-rates" id = 'valor-d40h<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>'><?php echo e(@$inlandDestiny['inlandDetails']['i40HC']['sub_in']); ?> </span>
                          <i class="la la-caret-right"></i> <b class="monto-down"> <?php echo e(@$inlandDestiny['inlandDetails']['i40HC']['markup']); ?>    </b>
                        </div>
                    ...
                    <div class="col-lg-6 colorphacode">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>><?php echo e($equipmentHides['20']); ?>
                          ...
                          <span class="bg-rates" id ='valor-o20<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>'><?php echo e(@$inlandOrigin['inlandDetails']['i20']['sub_in']); ?> </span>
                          <i class="la la-caret-right"></i>     <b class="monto-down"> <?php echo e(@$inlandOrigin['inlandDetails']['i20']['markup']); ?>      </b>  
                        </div>

                        <div class="wth" <?php echo e($equipmentHides['40']); ?>><?php echo e($equipmentHides['40']); ?>

                          <span class="bg-rates" id = 'valor-o40<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>'><?php echo e(@$inlandOrigin['inlandDetails']['i40']['sub_in']); ?> </span>
                          <i class="la la-caret-right"></i> <b class="monto-down"><?php echo e(@$inlandOrigin['inlandDetails']['i40']['markup']); ?> </b>
                        </div>

                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>><?php echo e($equipmentHides['40hc']); ?>

                          <span class="bg-rates" id = 'valor-o40h<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>'><?php echo e(@$inlandOrigin['inlandDetails']['i40HC']['sub_in']); ?> </span>
                          <i class="la la-caret-right"></i>   <b class="monto-down">      <?php echo e(@$inlandOrigin['inlandDetails']['i40HC']['markup']); ?>   </b>
                        </div>
