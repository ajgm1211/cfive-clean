...
<div class="m-content">
    <div class="container">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-12" style="padding-top:20px;">
                ...
                <div class="m-portlet--mobile">
                    <div class="m-portlet__body ">
                        <?php echo Form::open(['route' => 'dashboard.filter','method'=>'GET','class' => 'form-group m-form__group']); ?>

                        <div class="filter">
                            <?php echo $__env->make('dashboard.partials.form_filter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                        <?php echo Form::close(); ?>
        ...
        <?php if(isset($pick_up_dates)): ?>
        <div class="row">  
            <div class="col-md-2 col-lg-2 col-xl-2">
                <?php if(isset($user)): ?>
                <h4><?php echo e($user->name); ?> <?php echo e($user->lastname); ?></h4>
                <br>
                <?php endif; ?>
                <h6><b>From:</b> <?php echo e($pick_up_dates['start_date']); ?></h6>
                <h6><b>To:</b> <?php echo e($pick_up_dates['end_date']); ?></h6>
            </div>
        </div>
        <hr class="separator">
        <?php endif; ?>
                ...
                <div class="m-widget24 card" style="height: 220px;">
                    <div class="m-widget24__item">
                        ...
                        <span class="m-widget24__desc widget24__stats m--font-default" style="font-size:18px;">
                            <b><?php echo e($draft); ?></b>
                        </span>
                        <div class="m--space-10"></div>
                        <div class="progress m-progress--sm">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar m--bg-default " role="progressbar" style="width: <?php echo e(round(($draft * 100) / $totalQuotes)); ?>%;"></div>
                        </div>
                        <!--<span class="m-widget24__change">
Change
</span>
<span class="m-widget24__number">
<?php echo e(round(($sent * 100) / $totalQuotes)); ?>%
</span>-->
                        <br>
                        <br>
                        <br>
                ...
                <div class="m-widget24 card" style="height: 220px; width: auto;">
                    <div class="m-widget24__item">
                        ...
                        <br>
                        <span class="m-widget24__desc widget24__stats m--font-default" style="font-size:18px;">
                            <b><?php echo e($totalDraft); ?> <?php echo e($currency); ?></b>
                        </span>
                        <div class="m--space-10"></div>
                        <div class="progress m-progress--sm">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar m--bg-default" role="progressbar" style="width: <?php echo e(round(($totalDraft * 100) / $total)); ?>%;"></div>
                        </div>
                        <!--<span class="m-widget24__change">
Change
</span>
<span class="m-widget24__number">
<?php echo e(round(($totalSent * 100) / $total)); ?>%
</span>-->
                        <br>
                        <br>
                        <br>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2" style="padding-top:20px;">
                ...
                <div class="m-widget24 card" style="height: 220px;">
                    <div class="m-widget24__item">
                        ...
                        <div class="m--space-10"></div>
                        <div class="progress m-progress--sm">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar m--bg-success" role="progressbar" style="width: <?php echo e(round(($sent * 100) / $totalQuotes)); ?>%;"></div>
                        </div>
                        <!--<span class="m-widget24__change">
Change
</span>
...
<?php echo e(round(($sent * 100) / $totalQuotes)); ?>%
                ...
                <div class="m-widget24 card" style="height: 220px;">
                    <div class="m-widget24__item">
                        ...
                        <br>
                        <span class="m-widget24__desc widget24__stats m--font-success" style="font-size:18px;">
                            <b><?php echo e($totalSent); ?> <?php echo e($currency); ?></b>
                        </span>
                        <div class="m--space-10"></div>
                        <div class="progress m-progress--sm">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar m--bg-success" role="progressbar" style="width: <?php echo e(round(($totalSent * 100) / $total)); ?>%;"></div>
                        </div>
                        <!--<span class="m-widget24__change">
Change
</span>
                ...
                <div class="m-widget24 card" style="height: 220px;">
                    <div class="m-widget24__item">
                        ...
                        <span class="m-widget24__desc widget24__stats m--font-warning" style="font-size:18px;">
                            <b><?php echo e($negotiated); ?></b>
                        </span>
                        <div class="m--space-10"></div>
                        <div class="progress m-progress--sm">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar m--bg-warning" role="progressbar" style="width: <?php echo e(round(($negotiated * 100) / $totalQuotes)); ?>%;"></div>
                        </div>
                        <!--<span class="m-widget24__change">
Change
</span>
<span class="m-widget24__number">
<?php echo e(round(($negotiated * 100) / $totalQuotes)); ?>%
</span>-->
                        <br>
                        <br>
                        <br>
                ...
                <div class="m-widget24 card" style="height: 220px;">
                    <div class="m-widget24__item">
                        ...
                        <br>
                        <span class="m-widget24__desc widget24__stats m--font-warning" style="font-size:18px;">
                            <b><?php echo e($totalNegotiated); ?> <?php echo e($currency); ?></b>
                        </span>
                        <div class="m--space-10"></div>
                        <div class="progress m-progress--sm">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar m--bg-warning" role="progressbar" style="width: <?php echo e(round(($totalNegotiated * 100) / $total)); ?>%;"></div>
                        </div>
                        <!--<span class="m-widget24__change">
Change
</span>
<span class="m-widget24__number">
<?php echo e(round(($totalNegotiated * 100) / $total)); ?>%
</span>-->
                        <br>
                        <br>
                        <br>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2" style="padding-top:20px;">
                ...
                <div class="m-widget24 card" style="height: 220px;">
                    <div class="m-widget24__item">
                        ...
                        <div class="m--space-10"></div>
                        <div class="progress m-progress--sm">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar m--bg-info" role="progressbar" style="width: <?php echo e(round(($won * 100) / $totalQuotes)); ?>%;"></div>
                        </div>
                        <!--<span class="m-widget24__change">
Change
</span>
<span class="m-widget24__number">
<?php echo e(round(($won * 100) / $totalQuotes)); ?>%
</span>-->
                        <br>
                        <br>
                        <br>
                ...
                <div class="m-widget24 card" style="height: 220px;">
                    <div class="m-widget24__item">
                        ...
                        <br>
                        <span class="m-widget24__desc widget24__stats m--font-info" style="font-size:18px;">
                            <b><?php echo e($totalWon); ?> <?php echo e($currency); ?></b>
                        </span>
                        <div class="m--space-10"></div>
                        <div class="progress m-progress--sm">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar m--bg-info" role="progressbar" style="width: <?php echo e(round(($totalWon * 100) / $total)); ?>%;"></div>
                        </div>
                        <!--<span class="m-widget24__change">
Change
</span>
<span class="m-widget24__number">
<?php echo e(round(($totalWon * 100) / $total)); ?>%
</span>-->
                        <br>
                        <br>
                        <br>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2" style="padding-top:20px;">
                ...
                <div class="m-widget24 card" style="height: 220px;">
                    <div class="m-widget24__item">
                        ...
                        <div class="m--space-10"></div>
                        <div class="progress m-progress--sm">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar m--bg-danger" role="progressbar" style="width: <?php echo e(round(($lost * 100) / $totalQuotes)); ?>%;"></div>
                        </div>
                        <!--<span class="m-widget24__change">
Change
</span>
<span class="m-widget24__number">
<?php echo e(round(($lost * 100) / $totalQuotes)); ?>%
</span>-->
                        <br>
                        <br>
                        <br>
                ...
                <div class="m-widget24 card" style="height: 220px;">
                    <div class="m-widget24__item">
                        ...
                        <br>
                        <span class="m-widget24__desc widget24__stats m--font-danger" style="font-size:18px;">
                            <b><?php echo e($totalLost); ?> <?php echo e($currency); ?></b>
                        </span>
                        <div class="m--space-10"></div>
                        <div class="progress m-progress--sm">
                            <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar m--bg-danger" role="progressbar" style="width: <?php echo e(round(($totalLost * 100) / $total)); ?>%;"></div>
                        </div>
                        <!--<span class="m-widget24__change">
Change
</span>
<span class="m-widget24__number">
<?php echo e(round(($totalLost * 100) / $total)); ?>%
</span>-->
                        <br>
                        <br>
                        <br>
