<?php $__env->startSection('title', 'Requests LCL'); ?>
...
<div class="m-content">
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-12 order-2 order-xl-1 conten_load">
                                    <div class="col-xl-12 order-1 order-xl-2 m--align-right">
                                        <a href="<?php echo e(route('ImportationLCL.index')); ?>">
    ...
    <script>
        $(function() {
            $('#myatest').DataTable({
                processing: true,
                ajax: '<?php echo route("index.Account.import.lcl"); ?>',
                columns: [
                    { data: 'id', name: 'id' },
        ...
        $(function() {
            $('#requesttable').DataTable({
                processing: true,
                //serverSide: true,
                ajax: '<?php echo route("RequestImportationLcl.create"); ?>',
                columns: [
                    { data: 'id', name: 'id' },
        ...
        function showModal(id){
            ...
            var url = '<?php echo e(route("show.status.Request.lcl",":id")); ?>';
        ...
        $(document).on('click','#delete-account-clcl',function(){
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    url='<?php echo route("Destroy.account.clcl",":id"); ?>';
                    url = url.replace(':id', id);
                    // $(this).closest('tr').remove();
                    $.ajax({
                        url:url,
