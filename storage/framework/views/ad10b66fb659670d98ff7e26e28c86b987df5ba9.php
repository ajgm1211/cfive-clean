...
<div class="m-portlet">
    ...
    <?php echo e(Form::model($globalcharges, array('route' => array('gcadm.update', $globalcharges->id), 'method' => 'PUT', 'id' => 'frmSurcharges'))); ?>
    ...
    <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-4">
                ...
                <div class="m-input-icon m-input-icon--right">
                    <?php echo Form::number('ammount', $globalcharges->ammount, ['id' => 'ammount','placeholder' => 'Please enter the 40HC','required','class' => 'form-control m-input','min' => '0','step'=>'0.01']); ?>
