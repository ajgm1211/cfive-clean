<div class="m-portlet">
    <?php echo Form::open(['route' => 'gcadm.store', 'method' => 'post','class' => 'form-group m-form__group']); ?>
    ...
    <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row">
            <div class="col-lg-4">
                ...
                <?php echo e(Form::select('type',[''=>'Select Option'],null,['id' => 'type','class'=>'m-select2-general form-control','required' => 'true'])); ?>
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-4">
                ...
                <div class="m-input-icon m-input-icon--right">
                    <?php echo e(Form::select('localcurrency_id',$currency,null,['id' => 'localcurrency','class'=>'m-select2-general form-control' ,'required' => 'true' ])); ?>
            ...
            <div class="col-lg-4">
                ...
                <?php echo Form::number('ammount', 0, ['id' => 'ammount','class' => 'form-control','min' => '0','step'=>'0.01' ,'required' => 'true']); ?>
