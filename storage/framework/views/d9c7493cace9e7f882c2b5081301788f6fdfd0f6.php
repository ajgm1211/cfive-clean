<?php $__env->startSection('title', 'Requests GlobalCharge'); ?>
...
<div class="m-content">
            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        Importation Request Global Charger FCL
                    </h3>
                </div>
            </div>
        </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-12 order-2 order-xl-1 conten_load">
                                    <div class="col-xl-12 order-1 order-xl-2 m--align-right">
                                        <a href="<?php echo e(route('ImportationGlobalchargeFcl.index')); ?>">
    ...
    <script>
        ...
        $(function() {
            $('#myatest').DataTable({
                processing: true,
                ajax: '<?php echo route("index.Account.import.gc"); ?>',
                columns: [
                    { data: 'id', name: 'id' },
        ...
        $(function() {
            $('#requesttable').DataTable({
                processing: true,
                //serverSide: true,
                ajax: '<?php echo route("RequestsGlobalchargersFcl.create2"); ?>',
                columns: [
                    { data: 'id', name: 'id' },
        ...
        function showModal(id){
            ...
            var url = '<?php echo e(route("show.status.Request.gc",":id")); ?>';
        ...
        $(document).on('click','.eliminarrequest',function(e){
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    url='<?php echo route("destroy.GlobalC",":id"); ?>';
                    url = url.replace(':id', id);
        ...
        $(document).on('click','.eliminaracount',function(e){
            ...
            swal({
                ...
                if (result.value) {
                    url='<?php echo route("delete.Accounts.Globalcharges.Fcl",[":id",2]); ?>';
                    url = url.replace(':id', id);
                    // $(this).closest('tr').remove();
                    $.ajax({
                        url:url,
