        ...
        <div class="modal-content" style="min-width: 900px; right: 200px;">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" >
                        <div id="origin_harbor_label" <?php echo e($quote->type=='AIR' ? 'hidden':''); ?>>
                          <label>Origin port</label>
                          <?php echo e(Form::select('originport[]',$harbors,null,['class'=>'m-select2-general form-control','multiple' => 'multiple','id'=>'origin_harbor',$quote->type!='AIR' ? 'required':''])); ?>

                        </div>
                        <div id="origin_airport_label" <?php echo e($quote->type!='AIR' ? 'hidden':''); ?>>
                          <label>Origin airport</label>
                          <select id="origin_airport" name="origin_airport_id" class="form-control" <?php echo e($quote->type=='AIR' ? 'required':''); ?>></select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div  id="destination_harbor_label" <?php echo e($quote->type=='AIR' ? 'hidden':''); ?>>
                          <label>Destination port</label>
                          <?php echo e(Form::select('destinyport[]',$harbors,null,['class'=>'m-select2-general form-control','multiple' => 'multiple','id'=>'destination_harbor',$quote->type!='AIR' ? 'required':''])); ?>

                        </div>
                        <div id="destination_airport_label" <?php echo e($quote->type!='AIR' ? 'hidden':''); ?>>
                          <label>Destination airport</label>
                          <select id="destination_airport" name="destination_airport_id" class="form-control" <?php echo e($quote->type=='AIR' ? 'required':''); ?>></select>
                        </div>
                    </div>
                    <div class="col-md-4" id="delivery_type_label" <?php echo e($quote->type=='AIR' ? 'hidden':''); ?>>
                    ...
                    <div class="col-md-4" id="delivery_type_air_label"C<?php echo e($quote->type!='AIR' ? 'hidden':''); ?>>
                        <label>Delivery type</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" class="" id="carrier_label" <?php echo e($quote->type=='AIR' ? 'hidden':''); ?>> 
                        <label>Carrier</label>
                        <?php echo e(Form::select('carrieManual',$carrierMan,null,['placeholder' => 'Select at option', 'class'=>'form-control m-select2-general','id'=>'carrieManual',$quote->type!='AIR' ? 'required':''])); ?>

                    </div>
                    <div class="col-md-4" id="airline_label" <?php echo e($quote->type!='AIR' ? 'hidden':''); ?>>
                        <label>Airline</label>
                        <div class="form-group">
                          <?php echo e(Form::select('airline_id',$airlines,null,['class'=>'custom-select form-control','id' => 'airline_id','placeholder'=>'Choose an option',$quote->type=='AIR' ? 'required':''])); ?>
