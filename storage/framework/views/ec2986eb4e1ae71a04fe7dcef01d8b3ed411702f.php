                  ...
                  <td colspan="6">
                    ...
                    <table  class="table  table-hover">
                      ...
                      <tr>
                        ...
                        <td><span  class="darkblue px12" ><?php echo e($arr->totalOrigin); ?> <?php echo e($arr->quoteCurrency); ?> </span> </td>
                      </tr>
                    </table>
                  </td>
                </tr> 
                  ...
                  <td colspan="6">
                    ...
                    <table class="table table-hover">
                      ...
                      <tr>
                        <td colspan="5"></td>
                        <td > <span  class="darkblue px12" >SUBTOTAL:</span></td>
                        <td> <span  class="darkblue px12" > <?php echo e($arr->totalFreight); ?> <?php echo e($arr->quoteCurrency); ?> </span> </td>
                      </tr>
                    </table>
                  </td>
                </tr>
