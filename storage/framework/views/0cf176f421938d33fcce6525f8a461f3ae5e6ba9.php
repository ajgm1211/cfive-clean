                        ...
                        <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-12 order-1 order-xl-2 m--align-right">
                                    <a href="<?php echo e(route('contracts.add')); ?>">
                                    ...
                                    <!--<a href="<?php echo e(route('RequestImportation.indexListClient')); ?>">
...
<script>
    ...
    var oTable = $('#tableRates').DataTable({
        ...
        order: [[ 3, "asc" ],[ 4, "asc" ]],
        ajax: {
            url: "<?php echo e(route('contract.table')); ?>",
            data: function (d) {
    ...
    $(function() {
        ...
        $('#tableRates').DataTable({
            ...
            autoWidth: true,
            order: [[ 3, "asc" ],[ 4, "asc" ]],
            ajax:  "<?php echo e(route('contract.table')); ?>",
            "columnDefs": [
                { className: "truncate", "targets": [ 0,1] }
            ],
            columns: [
...
*/
        $('#tableContracts').DataTable({
            ajax:  "<?php echo e(route('contract.tableG')); ?>",
            "columnDefs": [
                { className: "truncate", "targets": [ 0,1] }
            ],
            columns: [
