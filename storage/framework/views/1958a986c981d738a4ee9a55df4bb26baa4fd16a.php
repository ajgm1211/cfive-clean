<?php $__env->startSection('title', 'Quotes Automatic'); ?>
...
<div class="m-content container">
  <div class="m-portlet--mobile">
    ...
    <div class="">
      <div class="row">
        <div class="col-xl-12">
          <?php echo Form::open(['route' => 'quotes.listRate','id' =>'formId', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed','onsubmit' => 'setdateinput()']); ?>
                                ...
                                <div class='row'>
                                  <div class="col-md-3">
                                    ...
                                    <div class="m-bootstrap-touchspin-brand">
                                      <?php echo Form::text('twuenty', 0, ['id' => 'm_touchspin_2_1' ,'class' => 'col-lg-12 form-control']); ?>
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <div class="m-bootstrap-touchspin-brand">
                                      <?php echo Form::text('forty', 0, ['id' => 'm_touchspin_2_1' ,'class' => 'col-lg-12 form-control']); ?>
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <div class="m-bootstrap-touchspin-brand">
                                      <?php echo Form::text('fortyhc', 0, ['id' => 'm_touchspin_2_1' ,'class' => 'col-lg-12 form-control']); ?>
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <div class="m-bootstrap-touchspin-brand">
                                      <?php echo Form::text('fortynor', 0, ['id' => 'm_touchspin_2_1' ,'class' => 'col-lg-12 form-control']); ?>
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <div class="m-bootstrap-touchspin-brand">
                                      <?php echo Form::text('fortyfive', 0, ['id' => 'm_touchspin_2_1' ,'class' => 'col-lg-12 form-control']); ?>
                            ...
                            <div class="col-lg-10">
                              <div class="row">
                                <div class="col-md-2">
                                  ...
                                  <?php echo e(Form::select('modality',['1' => 'Export','2' => 'Import'],null,['class'=>'m-select2-general form-control'])); ?>
                                ...
                                <div class="col-md-3">
                                  ...
                                  <div class="input-group date">
                                    <?php echo Form::text('date', null, ['id' => 'm_datepicker_2' ,'placeholder' => 'Select date','class' => 'form-control m-input date' ,'required' => 'true','autocomplete'=>'off']); ?>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8 hide" id="origin_address_label">
                                  ...
                                  <?php echo Form::text('origin_address', '', ['placeholder' => 'Please enter a origin address','class' => 'form-control m-input','id'=>'origin_address']); ?>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8 hide" id="destination_address_label">
                                  ...
                                  <?php echo Form::text('destination_address', '', ['placeholder' => 'Please enter a destination address','class' => 'form-control m-input','id'=>'destination_address']); ?>
                              ...
                              <div class="col-lg-10">
                                ...
                                <div class="row">
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <label>Company</label>
                                    <?php echo e(Form::select('company_id_quote', $companies,null,['placeholder' => 'Please choose a option','class'=>'m-select2-general form-control','id' => 'm_select2_2_modal','required'=>'true'])); ?><br><br>
                                  ...
                                  <div class="col-md-4 col-sm-4 ol-xs-12">
                                    <label>Contact</label>
                                    <?php echo e(Form::select('contact_id',[],null,['class'=>'m-select2-general form-control','required'=>'true'])); ?><br><br>
                                  ...
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <?php echo e(Form::select('price_id',[],null,['class'=>'m-select2-general form-control'])); ?>
