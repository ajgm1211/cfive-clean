<?php $__env->startSection('title','Import Information '.$contract['id'].' - '.$contract['number'].' / '.$contract['name']); ?>
                    ...
                    <div class="col-xl-12 order-2 order-xl-1 conten_load">
                        <center>
                            <div class="form-group">
                                ...
                                <br>
                                <div class="col-md-12">
                                    <a href="<?php echo e(route('Failed.Rates.Developer.For.Contracts',[$id,1])); ?>" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                        Failed Rates
                                        <i class="fa flaticon-tool-1"></i>
                                    </a>
                                    <a href="<?php echo e(route('Failed.Surcharge.F.C.D',[$id,1])); ?>" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                                        Failed Surcharge
                                        <i class="fa flaticon-tool-1"></i>
                                    </a>
                                </div>
