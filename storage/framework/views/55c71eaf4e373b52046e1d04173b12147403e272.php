...
<div class="m-portlet">
  ...
  <?php echo e(Form::model($globalcharges, array('route' => array('globalchargeslcl.store', $globalcharges->id), 'id' => 'frmGlobalChargesLcl'))); ?>
  ...
  <div class="m-portlet__body">
    ...
    <div class="form-group m-form__group row">
      <div class="col-lg-4">
        ...
        <?php echo e(Form::select('type', $surcharge,$globalcharges->surcharge_id,['id' => 'type','class'=>'m-select2-general form-control '])); ?>
    ...
    <div class="form-group m-form__group row">
      ...
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          <?php echo e(Form::select('calculationtype[]', $calculationT,$globalcharges->calculationtypelcl_id,['id' => 'calculationtype','class'=>'m-select2-general form-control ','multiple' => 'multiple'])); ?>
    ...
    <div class="form-group m-form__group row">
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          <?php echo e(Form::select('localcarrier[]', $carrier,$globalcharges->globalcharcarrierslcl->pluck('carrier_id'),['id' => 'localcarrier','class'=>'m-select2-general form-control','multiple' => 'multiple'])); ?>
      ...
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          <?php echo Form::text('ammount', $globalcharges->ammount, ['id' => 'ammount','placeholder' => 'Please enter the 40HC','required','class' => 'form-control m-input']); ?>
      ...
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          <?php echo Form::text('minimum', $globalcharges->minimum, ['id' => 'minimum','placeholder' => 'Please enter the Minimum','class' => 'form-control m-input']); ?>
    ...
    <div class="form-group m-form__group row">
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          <?php echo e(Form::select('localcurrency_id', $currency,$globalcharges->currency_id,['id' => 'localcurrency','class'=>'m-select2-general form-control' ])); ?>
