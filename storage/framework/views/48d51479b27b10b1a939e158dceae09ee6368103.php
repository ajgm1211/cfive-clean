...
<!--<div class="m-portlet">
    <?php echo Form::open(['route' => 'prices.store','class' => 'form-group m-form__group']); ?>

        <div class="m-portlet__body">
            <div class="m-form__section m-form__section--first">
                <div class="form-group m-form__group">
                    <?php echo $__env->make('prices.partials.form_add_prices', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </div>
...
<?php $__env->startSection('title', 'New Price Level'); ?>
                ...
                <?php echo Form::open(['route' => 'prices.store','class' => 'form-group m-form__group']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group m-form__group align-items-center">
                                <?php echo e(Form::select('companies[]',$companies,null,['multiple','class'=>'custom-select form-control','id' => 'select-2'])); ?>
                                                        ...
                                                        <div class="col-md-8 freight_fixed_markup_1" style="display: none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('freight_markup_currency[]',$currencies,$currency_cfg->id,['id'=>'freight_markup_currency_1','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 local_fixed_markup_1" style="display: none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('local_currency_import[]',$currencies,$currency_cfg->id,['id'=>'local_currency_markup_1','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 local_fixed_markup_1_2" style="display: none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('local_currency_export[]',$currencies,$currency_cfg->id,['id'=>'local_currency_markup_1_2','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 inland_fixed_markup_1" style="display: none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('inland_currency_import[]',$currencies,$currency_cfg->id,['id'=>'inland_currency_markup_1','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 inland_fixed_markup_1_2" style="display: none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('inland_currency_export[]',$currencies,$currency_cfg->id,['id'=>'inland_currency_markup_1_2','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="input-group freight_fixed_markup_2" style="display: none;">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('freight_markup_currency[]',$currencies,$currency_cfg->id,['id'=>'freight_markup_currency_2','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 local_fixed_markup_2" style="display: none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('local_currency_import[]',$currencies,$currency_cfg->id,['id'=>'local_currency_markup_2','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 local_fixed_markup_2_2" style="display: none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('local_currency_export[]',$currencies,$currency_cfg->id,['id'=>'local_currency_markup_2_2','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 inland_fixed_markup_2" style="display: none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('inland_currency_import[]',$currencies,$currency_cfg->id,['id'=>'inland_currency_markup_2','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 inland_fixed_markup_2_2" style="display: none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('inland_currency_export[]',$currencies,$currency_cfg->id,['id'=>'inland_currency_markup_2_2','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 freight_fixed_markup_3" style="display:none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('freight_markup_currency[]',$currencies,$currency_cfg->id,['id'=>'freight_currency_markup_3','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 local_fixed_markup_3" style="display:none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('local_currency_import[]',$currencies,$currency_cfg->id,['id'=>'local_currency_markup_3','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 local_fixed_markup_3_2" style="display:none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('local_currency_export[]',$currencies,$currency_cfg->id,['id'=>'local_currency_markup_3_2','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 inland_fixed_markup_3" style="display:none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('inland_currency_import[]',$currencies,$currency_cfg->id,['id'=>'inland_currency_markup_3','class'=>'form-control select-2-width'])); ?>
                                                    ...
                                                    <div class="row" style="font-size: 11px !important;">
                                                        ...
                                                        <div class="col-md-8 inland_fixed_markup_3_2" style="display:none;">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-btn">
                                                                    <div class="btn-group">
                                                                        <?php echo e(Form::select('inland_currency_export[]',$currencies,$currency_cfg->id,['id'=>'inland_currency_markup_3_2','class'=>'form-control destination_ammount_currency select-2-width'])); ?>
