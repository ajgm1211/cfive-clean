<div class="m-portlet">
  ...
  <?php echo e(Form::open(array('route' => array('contracts.storeLocalCharge', $id)),['class' => 'form-group m-form__group'])); ?>
  ...
  <div class="m-portlet__body">
    ...
    <div class="form-group m-form__group row">
      ...
      <div class="col-lg-4">
        <div class="divport" >
          ...
          <?php echo e(Form::select('port_origlocal[]', $harbor,null,['id' => 'portOrigAdd','class'=>'m-select2-general  form-control ','multiple' => 'multiple' ,'style' => 'width:100%;'])); ?>
      ...
      <div class="col-lg-4">
        <div class="divport" >
          ...
          <div class="m-input-icon m-input-icon--right">
            <?php echo e(Form::select('port_destlocal[]', $harbor,null,['id' => 'portDestAdd','class'=>'m-select2-general  form-control ','multiple' => 'multiple','style' => 'width:100%;'])); ?>
        ...
        <div class="divcountry" hidden="true">
          ...
          <?php echo e(Form::select('country_dest[]',$countries,null,['id' => 'country_destAdd','class'=>'m-select2-general form-control','multiple' => 'multiple'  ])); ?>
    ...
    <div class="form-group m-form__group row">
      ...
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          <?php echo e(Form::select('calculationtype_id[]', $calculationT,null,['id' => 'calculationtypeAdd','class'=>'m-select2-general form-control ','multiple' => 'multiple','style' => 'width:80%;'])); ?>
    ...
    <div class="form-group m-form__group row">
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          <?php echo Form::number('ammount', null, ['id' => 'ammountAdd','placeholder' => 'Please enter the 40HC','class' => 'form-control m-input','min' => '0','step'=>'0.01']); ?>
