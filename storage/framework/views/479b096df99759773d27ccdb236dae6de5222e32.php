...
<?php $__env->startSection('title','Failed Surcharge '.$contract['id'].' - '.$contract['number'].' / '.$contract['name']); ?>
    ...
    <div class="m-portlet m-portlet--mobile">
                    ...
                    <div class="tab-pane " id="FailSurcharge" role="tabpanel">
                        ...
                        <div class="m-portlet__head">
                            <label >
                                ...
                                <strong id="strfail"><?php echo e($countfailsurcharge); ?></strong>
                                <input type="hidden" value="<?php echo e($countfailsurcharge); ?>" id="strfailinput" />
                            </label>
                            &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<?php echo e(route('Reprocesar.Surchargers',$id)); ?>" class="btn btn-primary">Reprocess &nbsp;<span class="la la-refresh"></span></a>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                            <br>
                        </div>
                        ...
                        <div class="tab-pane active" id="GoodSurcharge" role="tabpanel">
                            ...
                            <div class="m-portlet__head">
                                <label>
                                    ...
                                    <strong id="strgood">
                                        <?php echo e($countgoodsurcharge); ?>

                                    </strong>
                                    <input type="hidden" value="<?php echo e($countgoodsurcharge); ?>" id="strgoodinput" />
                                </label>
                            </div>
        ...
        <script>
            $(function() {
                $('#myatest').DataTable({
                    processing: true,
                    ajax: '<?php echo route("Failed.Surcharge.V.F.C",[$id,1]); ?>',
                    columns: [
                ...
                $('#myatest2').DataTable({
                    processing: true,
                    //serverSide: true,
                    ajax: '<?php echo route("Failed.Surcharge.V.F.C",[$id,2]); ?>',
                    columns: [
                        { data: 'surchargelb', name: 'surchargelb' },
                        { data: 'origin_portLb', name: 'origin_portLb' },
                        { data: 'destiny_portLb', name: 'destiny_portLb' },
            ...
            function showModalsavetosurcharge(id,operation){
                ...
                if(operation == 1){
                    var url = '<?php echo e(route("Edit.Surchargers.Fail.For.Contracts", ":id")); ?>';
                    url = url.replace(':id', id);
                    $('#edit-modal-body').load(url,function(){
                        $('#modaleditSurcharge').modal();
                    });
                }else if(operation == 2){
                    var url = '<?php echo e(route("Edit.Surchargers.Good.For.Contracts", ":id")); ?>';
                    url = url.replace(':id', id);
                    $('#edit-modal-body').load(url,function(){
                        $('#modaleditSurcharge').modal();
                    });
            ...
            $(document).on('click','#delete-Fail-Surcharge',function(){
                ...
                swal({
                    ...
                    if (result.value) {
                        ...
                        url='<?php echo route("Destroy.SurchargersF.For.Contracts",":id"); ?>';
                        url = url.replace(':id', id);
            ...
            $(document).on('click','#delete-Surcharge',function(){
                ...
                swal({
                    ...
                    if (result.value) {
                        ...
                        url='<?php echo route("Destroy.SurchargersG.For.Contracts",":id"); ?>';
                        url = url.replace(':id', id);
                        // $(this).closest('tr').remove();
                        $.ajax({
                            url:url,
