    ...
    <main>
        ...
        <table border="0" cellspacing="1" cellpadding="1" <?php echo e($quote->pdf_option->show_type=='detailed' ? '':'hidden'); ?>>
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $freight_charges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php 
                        $total= 0;
                        $total40= 0;
                        $total40hc= 0;
                    ...
                    <?php $__currentLoopData = $rate->charge; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            if($v->type_id==3){
                                $total20=$v->total_20;
                                $total40=$v->total_40;
                    ...
                    <tr class="text-center color-table">
                        ...
                        <td><?php echo e($rate->destination_port->name); ?>, <?php echo e($rate->destination_port->code); ?></td>
                        <td <?php echo e($quote->pdf_option->show_carrier==1 ? '':'hidden'); ?>><?php echo e($rate->carrier->name); ?></td>
                        <td <?php echo e($equipmentHides['20']); ?>><?php echo e(@$total20); ?></td>
                        <td <?php echo e($equipmentHides['40']); ?>><?php echo e(@$total40); ?></td>
                        <td <?php echo e($equipmentHides['40hc']); ?>><?php echo e(@$total40hc); ?></td>
                        <td <?php echo e($equipmentHides['40nor']); ?>><?php echo e(@$total40nor); ?></td>
                        <td <?php echo e($equipmentHides['45']); ?>><?php echo e(@$total45); ?></td>                            
                ...
                <table border="0" cellspacing="1" cellpadding="1" >
                    ...
                    <?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="text-center color-table">
                            ...
                            <td <?php echo e($quote->pdf_option->show_carrier==1 ? '':'hidden'); ?>><?php echo e($rate->carrier->name); ?></td>
                            <td <?php echo e($equipmentHides['20']); ?>><?php echo e(@$sum20+@$inland20); ?></td>
                            <td <?php echo e($equipmentHides['40']); ?>><?php echo e(@$sum40+@$inland40); ?></td>
                            <td <?php echo e($equipmentHides['40hc']); ?>><?php echo e(@$sum40hc+@$inland40hc); ?></td>
                            <td <?php echo e($equipmentHides['40nor']); ?>><?php echo e(@$sum40nor+@$inland40nor); ?></td>
                            <td <?php echo e($equipmentHides['45']); ?>><?php echo e(@$sum45+@$inland45); ?></td>
