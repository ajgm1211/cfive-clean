      ...
      <div class="m-portlet custom-portlet no-border">
        ...
        <div class="m-portlet__body display-none portlet-padding pay">
          ...
          <div class="card card-body bg-light">
            <span class="payment_conditions_span"><?php echo $quote->payment_conditions; ?></span>
            <div class="payment_conditions_textarea" hidden>
              <textarea name="payment_conditions" class="form-control payment_conditions editor" id="payment_conditions"><?php echo $quote->payment_conditions; ?></textarea>
            </div>
            <div class="row">
