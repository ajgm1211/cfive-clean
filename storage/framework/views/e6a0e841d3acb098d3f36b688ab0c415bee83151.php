...
<?php if($selector == 1): ?>
<?php $__env->startSection('title', 'Importation FCL R. '.$requestfcl['id'].' / '.$requestfcl['namecontract']); ?>
<?php elseif($selector == 2): ?>
<?php $__env->startSection('title', 'Importation FCL C. '.$contract['id'].' / '.$contract['name']); ?>
<?php endif; ?>
...
new registration
        ...
        <?php echo Form::open(['route'=>'Upload.File.New.Contracts','method'=>'PUT','files'=>true, 'id' => 'formupload']); ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <?php echo Form::text('name',$requestfcl['namecontract'],['id'=>'nameid',
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input placeholder="Contract Validity" class="form-control m-input" readonly="" id="m_daterangepicker_1" required="required" name="validation_expire" type="text" value="<?php echo e($requestfcl['validation']); ?>">
                                </div>
                                <div class="col-lg-3">
                                    <label for="numberid" class=" ">Company User</label>
                                    <?php echo Form::select('CompanyUserId',$companysUser,$requestfcl['company_user_id'],['id'=>'CompanyUserId',
                                    'required',
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <?php echo Form::text('request_id',$requestfcl['id'],['id'=>'request_id',
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="" id="carrierMul">
                                        <?php echo Form::select('carrierM[]',$carrier,$requestfcl->Requestcarriers->pluck('carrier_id'),['class'=>'m-select2-general form-control','id'=>'carrierM','required','multiple'=>'multiple']); ?>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="" id="direction">
                                        <?php echo Form::select('direction',$direction,$requestfcl['direction_id'],['class'=>'m-select2-general form-control','required','id'=>'direction']); ?>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-3">
                                    <label for="nameid" class="">Contract Name</label>
                                    <?php echo Form::text('nameD',$contract['name'],['id'=>'nameid',
                                    'placeholder'=>'Contract Name',
                                    'required','disabled',
                                    'class'=>'form-control m-input']); ?>

                                </div>
                                <input type="hidden" name="name" value="<?php echo e($contract['name']); ?>">
                                <div class="col-lg-3">
                                    <label for="validation_expire" class=" ">Validation</label>
                                    <input placeholder="Contract Validity" class="form-control m-input" readonly="" id="m_daterangepicker_1" disabled required="required" name="validation_expire" type="text" value="<?php echo e($contract['validity'].' / '.$contract['expire']); ?>">
                                </div>
                                <div class="col-lg-3">
                                    <label for="numberid" class=" ">Company User</label>
                                    <?php echo Form::select('CompanyUserIdd',$companysUser,$contract['company_user_id'],['id'=>'CompanyUserId',
                                    'required','disabled',
                                    'class'=>'form-control m-input','onchange' => 'selectvalidate()']); ?>

                                </div>
                                <input type="hidden" name="CompanyUserId" value="<?php echo e($contract['company_user_id']); ?>">                                
                            </div>
                            <div class="form-group m-form__group row">
                                <div class="col-lg-2"> </div>
                                ...
                                <div class="col-lg-3">
                                    <label for="request_id" class=" ">Request id</label>
                                    <?php echo Form::text('request_idd',$request_id,['id'=>'request_id',
                                ...
                                <div class="col-lg-3">
                                    <label class="">Carriers</label>
                                    <div class="" id="carrierMul">
                                        <?php echo Form::select('carrierM[]',$carrier,$contract->carriers->pluck('carrier_id'),['class'=>'m-select2-general form-control','disabled','id'=>'carrierM','required','multiple'=>'multiple']); ?>
                                ...
                                <div class="col-lg-3">
                                    <label class="">Direction</label>
                                    <div class="" id="direction">
                                        <?php echo Form::select('direction',$direction,$contract['direction_id'],['class'=>'m-select2-general form-control','disabled','required','id'=>'direction']); ?>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-3" id="divorigin">
                                    ...
                                    <div class="col-form-label" id="origininpCount" hidden="hidden" >
                                        ...
                                        <?php echo Form::select('originCount[]',$country,null,['class'=>'m-select2-general form-control  ','id'=>'originCountry','multiple'=>'multiple']); ?>

                                    </div>
                                    <div class="col-form-label" id="origininpRegion" hidden="hidden" >
                                        <label for="originRegion" class=" ">Regions</label>
                                        <?php echo Form::select('originRegion[]',$region,null,['class'=>'m-select2-general form-control  ','id'=>'originRegion','multiple'=>'multiple']); ?>
                                ...
                                <div class="col-3" id="divdestiny">
                                    ...
                                    <div class="col-form-label" id="destinyinpCount" hidden="hidden" >
                                        ...
                                        <?php echo Form::select('destinyCount[]',$country,null,['class'=>'m-select2-general form-control  ','id'=>'destinyCountry','multiple'=>'multiple']); ?>

                                    </div>
                                    <div class="col-form-label" id="destinyinpRegion" hidden="hidden" >
                                        <label for="destinyRegion" class=" ">Regions</label>
                                        <?php echo Form::select('destinyRegion[]',$region,null,['class'=>'m-select2-general form-control  ','id'=>'destinyRegion','multiple'=>'multiple']); ?>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-3" id="divtyped">
                                    ...
                                    <div class="col-form-label" hidden="hidden" id="typedestinyinp">
                                        <?php echo Form::select('typedestiny',$typedestiny,null,['class'=>'m-select2-general form-control','id'=>'typedestiny']); ?>
...
<script>
    ...
    function validar(){
        ...
        url='<?php echo route("validate.import",":id"); ?>';
