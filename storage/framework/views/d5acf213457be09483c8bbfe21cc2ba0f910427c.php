...
<div class="m-portlet">
  ...
  <?php echo e(Form::model($localcharges, array('route' => array('update-local-charge', $localcharges->id), 'method' => 'PUT', 'id' => 'frmSurcharges'))); ?>
  ...
  <div class="m-portlet__body">
    ...
    <div class="form-group m-form__group row">
      ...
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          <?php echo e(Form::select('carrier_id[]', $carrier,$localcharges->localcharcarriers->pluck('carrier_id'),['id' => 'localcarrier','class'=>'m-select2-general form-control','multiple' => 'multiple','required' => 'true'])); ?>
      ...
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          <?php echo e(Form::select('calculationtype_id', $calculationT,$localcharges->calculationtype_id,['id' => 'calculationtype','class'=>'m-select2-general form-control ','style' => 'width:80%;'])); ?>
    ...
    <div class="form-group m-form__group row">
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          <?php echo Form::number('ammount', $localcharges->ammount, ['id' => 'ammount','placeholder' => 'Please enter the 40HC','class' => 'form-control m-input','min' => '0','step'=>'0.01']); ?>
