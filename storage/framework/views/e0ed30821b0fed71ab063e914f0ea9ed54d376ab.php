                ...
                <div class="tab-pane active" id="m_portlet_tab_1_1">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php echo Form::open(['route'=>'RequestImportation.store2','method'=>'POST','id'=>'form','files'=>true]); ?>
...
<script>
    ...
    var oTable = $('#requesttable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo route("Similar.Contracts.Request",$user->company_user_id); ?>',
            data: function (d) {
    ...
    $(function() {
        ...
        $('#form').ajaxForm({
            ...
            complete: function(xhr) {
                ...
                //window.location.href = "<?php echo e(route('RequestImportation.indexListClient')); ?>";
            },
