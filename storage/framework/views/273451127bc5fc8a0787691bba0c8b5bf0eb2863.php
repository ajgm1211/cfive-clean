...
<?php $__env->startSection('title', 'New Request LCL'); ?>
        ...
        <div class="m-portlet__body">
            <div class="tab-content">
                <div class="tab-pane active" id="m_portlet_tab_1_1">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <?php echo Form::open(['route'=>'RequestImportationLcl.store2','method'=>'POST','id'=>'form','files'=>true]); ?>
                            ...
                            <input type="hidden" name="CompanyUserId" value="<?php echo e($user->company_user_id); ?>" />
...
<script>
    ...
    var oTable = $('#requesttable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo route("Similar.Contracts.Request.Lcl",$user->company_user_id); ?>',
            data: function (d) {
    ...
    $(function() {
        ...
        $('#form').ajaxForm({
            ...
            complete: function(xhr) {
                ...
                if(count == 1){
                    swal({
                        ...
                        if (willDelete) {
                            ...
                            window.location.href = "<?php echo e(route('contractslcl.index')); ?>";
                        } else {
                            count = 0;
                            $('#modaledit').modal('hide');
                            window.location.href = "<?php echo e(route('contractslcl.index')); ?>";
                ...
                //window.location.href = "<?php echo e(route('RequestImportationLcl.indexListClient')); ?>";
            }
        });
