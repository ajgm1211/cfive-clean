								...
								<tr id='tr_l<?php echo e(++$loop->index); ?>'>
									...
									<td>
										...
										<div id="divport<?php echo e($loop->index); ?>"  class="val">
											<?php echo str_replace(["[","]","\""], ' ', $globalcharges->globalcharport->pluck('portOrig')->unique()->pluck('display_name') ); ?> 
										</div>
										<?php endif; ?>
										<?php if(!$globalcharges->globalcharcountry->isEmpty()): ?>
										<div id="divcountry<?php echo e($loop->index); ?>"  class="val">
											<?php echo str_replace(["[","]","\""], ' ', $globalcharges->globalcharcountry->pluck('countryOrig')->unique()->pluck('name') ); ?> 
										</div>
										<?php endif; ?>
									</td>
									<td>
										...
										<div id="divportDest<?php echo e($loop->index); ?>"  class="val">
											<?php echo str_replace(["[","]","\""], ' ', $globalcharges->globalcharport->pluck('portDest')->unique()->pluck('display_name') ); ?> 
										</div>
										<?php endif; ?>
										<?php if(!$globalcharges->globalcharcountry->isEmpty()): ?>
										<div id="divcountryDest<?php echo e($loop->index); ?>"  class="val">
											<?php echo str_replace(["[","]","\""], ' ', $globalcharges->globalcharcountry->pluck('countryDest')->unique()->pluck('name') ); ?> 
										</div>
										<?php endif; ?>
									</td>
									<td>
									...
									<td>
										<div id="divcarrier<?php echo e($loop->index); ?>"  class="val">
											<?php echo str_replace(["[","]","\""], ' ', $globalcharges->GlobalCharCarrier->pluck('carrier')->pluck('name') ); ?>

										</div>
									</td>
									<td>   
										<div id="divcalculation<?php echo e($loop->index); ?>"  class="val"><?php echo $globalcharges->calculationtype->name; ?></div>
									<td> 
