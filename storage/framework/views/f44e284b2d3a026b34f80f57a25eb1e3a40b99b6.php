...
<div class="padding">
  <?php echo Form::open(['id'=>'FormQuote' , 'class' => 'form-group m-form__group dfw']); ?>
          ...
          <div>
            <div class="row">
              <div class="col-lg-2">
                ...
                <?php echo e(Form::select('type',['1' => 'FCL','2' => 'LCL','3'=>'AIR'],null,['id'=>'quoteType','class'=>'m-select2-general form-control'])); ?>

              </div>

              <div class="col-lg-2" id="equipment_id">
                <label>Equipment</label>
                <?php echo e(Form::select('equipment[]',['20' => '20\'','40' => '40','40HC'=>'40HC','40NOR'=>'40NOR','45'=>'45'],@$form['equipment'],['class'=>'m-select2-general form-control','id'=>'equipment','multiple' => 'multiple','required' => 'true'])); ?>
              ...
              <div class="col-lg-2">
                <label>Contact</label>
                <div class="m-input-icon m-input-icon--right">
                  <?php echo e(Form::select('contact_id',[],null,['id' => 'contact_id', 'class'=>'m-select2-general form-control','required'=>'true'])); ?>

                  <?php echo e(Form::hidden('contact_id_num', @$form['contact_id'] , ['id' => 'contact_id_num'  ])); ?>
              ...
              <div class="col-lg-2">
                ...
                <?php echo e(Form::select('price_id',[],null,['id' => 'price_id' ,'class'=>'form-control m-select2-general'])); ?>

                <?php echo e(Form::hidden('price_id_num', @$form['price_id'] , ['id' => 'price_id_num'  ])); ?>
            ...
            <div class="row">
              ...
              <div class="col-lg-2">
                ...
                <div class="input-group date">
                  <?php echo Form::text('date', @$form['date'], ['id' => 'm_daterangepicker_1' ,'placeholder' => 'Select date','class' => 'form-control m-input date' ,'required' => 'true','autocomplete'=>'off']); ?>
              ...
              <div class="col-lg-2" id="delivery_type_label">
                ...
                <?php echo e(Form::select('delivery_type',['1' => 'PORT(Origin) To PORT(Destination)','2' => 'PORT(Origin) To DOOR(Destination)','3'=>'DOOR(Origin) To PORT(Destination)','4'=>'DOOR(Origin) To DOOR(Destination)'],@$form['delivery_type'],['class'=>'m-select2-general form-control','id'=>'delivery_type'])); ?>
              ...
              <div class="col-lg-2 <?php echo e($hideO); ?>" id="origin_address_label">
                <label>Origin address</label>
                <?php echo Form::text('origin_address',@$form['origin_address'], ['placeholder' => 'Please enter a origin address','class' => 'form-control m-input','id'=>'origin_address']); ?>

              </div>
              <div class="col-lg-2 <?php echo e($hideD); ?>" id="destination_address_label">
                <label>Destination address</label>
                <?php echo Form::text('destination_address',@$form['destination_address'] , ['placeholder' => 'Please enter a destination address','class' => 'form-control m-input','id'=>'destination_address']); ?>
            ...
            <div class="row">
              <div class="col-lg-2 for-check">   
                <?php echo e(Form::checkbox('chargeOrigin',null,@$chargeOrigin,['id'=>'mode1', 'class' => 'include-checkbox'])); ?>

                <label for="mode1" class="label-check">Include origin charges</label>
                </div>
                
              <div class="col-lg-2 for-check">
                <?php echo e(Form::checkbox('chargeDestination',null,@$chargeDestination,['id'=>'mode2', 'class' => 'include-checkbox'])); ?>

                <label for="mode2" class="label-check">Include destination charges</label>
              </div>
                
              <div class="col-lg-2 for-check">
                <?php echo e(Form::checkbox('chargeFreight',null,@$chargeFreight,['id'=>'mode3', 'class' => 'include-checkbox'])); ?>
            ...
            <div class="row">
              <div class="col-lg-2">
                ...
                <?php echo e(Form::select('incoterm_id',$incoterm,@$form['incoterm_id'],['id' => 'incoterm' ,'class'=>'form-control m-select2-general','required' => 'true'])); ?>
      ...
      <div class="m-portlet__body no-padding">
        <div class="tab-content">
          <div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 padding-right-table" style="padding-left: 0;">
                      <div style="display:flex; justify-content:space-between">
                        <div class="wth" style="display:flex; justify-content:center;" <?php echo e($equipmentHides['20']); ?> ><span class="portcss">20'</span></div>
                        <div class="wth" style="display:flex; justify-content:center;" <?php echo e($equipmentHides['40']); ?> ><span class="portcss">40</span></div>
                        <div class="wth" style="display:flex; justify-content:center;" <?php echo e($equipmentHides['40hc']); ?> ><span class="portcss">40HC'</span></div>
                        <div class="wth" style="display:flex; justify-content:center;" <?php echo e($equipmentHides['40nor']); ?> ><span class="portcss">40NOR'</span></div>
                        <div class="wth" style="display:flex; justify-content:center;" <?php echo e($equipmentHides['45']); ?> ><span class="portcss">45'</span></div>
                      </div>
                    </div>
            ...
            <div class="card-p__quotes input-select<?php echo e($loop->iteration); ?>"  style="margin-bottom: 50px;">
              <div class="row initial-card" id='principal<?php echo e($loop->iteration); ?>' >
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6" style="padding-right: 35px;">
                      <div class="table-r__quotes">
                        <div class="wth " <?php echo e($equipmentHides['20']); ?>><span class="darkblue validate"><?php echo e($arr->total20); ?> </span><span class="currency"> <?php echo e($arr->typeCurrency); ?></span></div>
                        <div class="wth" <?php echo e($equipmentHides['40']); ?>><span class="darkblue validate"><?php echo e($arr->total40); ?> </span><span class="currency"><?php echo e($arr->typeCurrency); ?> </span></div>
                    ...
                    <div class="col-lg-1 no-padding d-flex align-items-center pos-btn">
                      <input type="checkbox" id="input-select<?php echo e($loop->iteration); ?>" class="input-select no-check btnrate checkboxx" rate-id ='<?php echo e($arr->id); ?> infocheck' name="info[]" value="<?php echo e(json_encode($arr)); ?>">
...
<a  id='display_l<?php echo e($loop->iteration); ?>' onclick="display(<?php echo e($loop->iteration); ?>)" class="l"  title="Cancel" ><i  class="la la-angle-down blue"></i></a>
</div>
</div>-->
              ...
              <?php if(!$arr->localorigin->isEmpty()): ?>

              <div class="row no-margin margin-card" id='origin<?php echo e($loop->iteration); ?>' hidden='true' >
                <div class="col-lg-12">
                  <div class="row">
                  ...
                  <div class="row bg-light">
                    ...
                    <div class="col-lg-7">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>><span class="portalphacode">20'</span></div>
                        <div class="wth" <?php echo e($equipmentHides['40']); ?>><span class="portalphacode">40'</span></div>
                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>><span class="portalphacode">40HC'</span></div>
                        <div class="wth"  <?php echo e($equipmentHides['40nor']); ?>><span class="portalphacode">40NOR'</span></div>
                        <div class="wth" <?php echo e($equipmentHides['45']); ?>><span class="portalphacode">45'</span></div>
                      </div>
                    </div>
                  ...
                  <div class="row data-rates">
                    <div class="col-lg-2 colorphacode"><?php echo e(str_replace(["[","]","\""], ' ', $localorigin['99']->pluck('surcharge_name')  )); ?></div>
                    ...
                    <div class="col-lg-7 colorphacode">
                      <div class="d-flex justify-content-between">
                        ...
                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>>  
                          <?php echo e(isset($localorigin['40hc']) ?  str_replace(["[","]","\""], ' ', $localorigin['40hc']->pluck('monto')) :'0.00'); ?> + <?php echo e(isset($localorigin['40hc']) ?   str_replace(["[","]","\""], ' ', $localorigin['40hc']->pluck('markup')) : '0.00'); ?>     <i class="la la-caret-right arrow-down"></i>     <b class="monto-down"> <?php echo e(isset($localorigin['40hc']) ?   str_replace(["[","]","\""], ' ', $localorigin['40hc']->pluck('montoMarkup')) : '0.00'); ?>     </b> 
                        </div>
                        <div class="wth" <?php echo e($equipmentHides['40nor']); ?>>  
                        ...
                        <div class="wth" <?php echo e($equipmentHides['45']); ?>>     
                  ...
                  <div class="row bg-light">
                    ...
                    <div class="col-lg-7">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>><span class="portalphacode"><?php echo e($arr->tot20O); ?> </span></div>
                        <div class="wth" <?php echo e($equipmentHides['40']); ?>><span class="portalphacode"><?php echo e($arr->tot40O); ?></span></div>
                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>><span class="portalphacode"><?php echo e($arr->tot40hcO); ?></span></div>
                        <div class="wth" <?php echo e($equipmentHides['40nor']); ?>><span class="portalphacode"><?php echo e($arr->tot40norO); ?></span></div>
                        <div class="wth" <?php echo e($equipmentHides['45']); ?>><span class="portalphacode"><?php echo e($arr->tot45O); ?></span></div>
                      </div>
                    </div>
                    <div class="col-lg-1" ><span class="portalphacode"><?php echo e($arr->typeCurrency); ?></span></div>
                  </div>
                </div>
              </div>
              <?php endif; ?>
              <!-- Gastos Freight-->
              <div class="row no-margin margin-card" id='freight<?php echo e($loop->iteration); ?>'  hidden='true' >
                <div class="col-lg-12">
                  <div class="row">
                  ...
                  <div class="row data-rates">
                    ...
                    <div class="col-lg-1 colorphacode" style="white-space: nowrap"><?php echo e($rates['detail']); ?></div>
                  ...
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php $__currentLoopData = $arr->localfreight; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localfreight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                  <div class="row data-rates">
                    <div class="col-lg-2 colorphacode"><?php echo e(str_replace(["[","]","\""], ' ', $localfreight['99']->pluck('surcharge_name')  )); ?></div>
                    <div class="col-lg-1 colorphacode"><?php echo e(str_replace(["[","]","\""], ' ', $localfreight['99']->pluck('calculation_name')  )); ?></div>
                    <div class="col-lg-8 colorphacode">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>>
                        ...
                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>>  
                          <span class="bg-rates"> <?php echo e(isset($localfreight['40hc']) ?  str_replace(["[","]","\""], ' ', $localfreight['40hc']->pluck('monto')) :'0.00'); ?></span> <span class="bg-rates">+ <?php echo e(isset($localfreight['40hc']) ?   str_replace(["[","]","\""], ' ', $localfreight['40hc']->pluck('markup')) : '0.00'); ?></span>     <i class="la la-caret-right arrow-down"></i>      <b class="monto-down"><?php echo e(isset($localfreight['40hc']) ?   str_replace(["[","]","\""], ' ', $localfreight['40hc']->pluck('montoMarkup')) : '0.00'); ?>     </b>
                        </div>
                        <div class="wth" <?php echo e($equipmentHides['40nor']); ?>>  
                          <span class="bg-rates"><?php echo e(isset($localfreight['40nor']) ?  str_replace(["[","]","\""], ' ', $localfreight['40nor']->pluck('monto')) :'0.00'); ?></span> <span class="bg-rates">+ <?php echo e(isset($localfreight['40nor']) ?   str_replace(["[","]","\""], ' ', $localfreight['40nor']->pluck('markup')) : '0.00'); ?>   </span>  <i class="la la-caret-right arrow-down"></i>      <b class="monto-down"><?php echo e(isset($localfreight['40nor']) ?   str_replace(["[","]","\""], ' ', $localfreight['40nor']->pluck('montoMarkup')) : '0.00'); ?>     </b>
                        </div>
                        <div class="wth" <?php echo e($equipmentHides['45']); ?>>     
                          <span class="bg-rates"><?php echo e(isset($localfreight['45']) ?  str_replace(["[","]","\""], ' ', $localfreight['45']->pluck('monto')) :'0.00'); ?></span> <span class="bg-rates">+ <?php echo e(isset($localfreight['45']) ?   str_replace(["[","]","\""], ' ', $localfreight['45']->pluck('markup')) : '0.00'); ?>     </span><i class="la la-caret-right arrow-down"></i>   <b class="monto-down">   <?php echo e(isset($localfreight['45']) ?   str_replace(["[","]","\""], ' ', $localfreight['45']->pluck('montoMarkup')) : '0.00'); ?>     </b>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row bg-light">
                    ...
                    <div class="col-lg-8">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>><span class="portalphacode"><?php echo e($arr->tot20F); ?> </span></div>
                        <div class="wth" <?php echo e($equipmentHides['40']); ?>><span class="portalphacode"><?php echo e($arr->tot40F); ?></span></div>
                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>><span class="portalphacode"><?php echo e($arr->tot40hcF); ?></span></div>
                        <div class="wth" <?php echo e($equipmentHides['40nor']); ?>><span class="portalphacode"><?php echo e($arr->tot40norF); ?></span></div>
                        <div class="wth" <?php echo e($equipmentHides['45']); ?>><span class="portalphacode"><?php echo e($arr->tot45F); ?></span></div>
                      </div>
                    </div>
                    <div class="col-lg-1" ><span class="portalphacode"><?php echo e($arr->typeCurrency); ?></span></div>
                  </div>
              ...
              <!-- Gastos Destino-->
              <?php if(!$arr->localdestiny->isEmpty()): ?>
              <div class="row no-margin margin-card" id='destiny<?php echo e($loop->iteration); ?>'  hidden='true' >
                <div class="col-lg-12">
                  <div class="row">
                  ...
                  <div class="row bg-light">
                    ...
                    <div class="col-lg-8">
                      <div class="d-flex justify-content-between">
                        <div class="wthwth" <?php echo e($equipmentHides['20']); ?>><span class="portalphacode">20'</span></div>
                        <div class="wthwth" <?php echo e($equipmentHides['40']); ?>><span class="portalphacode">40'</span></div>
                        <div class="wthwth" <?php echo e($equipmentHides['40hc']); ?>><span class="portalphacode">40HC'</span></div>
                        <div class="wthwth"  <?php echo e($equipmentHides['40nor']); ?>><span class="portalphacode">40NOR'</span></div>
                        <div class="wthwth" <?php echo e($equipmentHides['45']); ?>><span class="portalphacode">45'</span></div>
                      </div>
                    </div>
                    <div class="col-lg-1" ><span class="portalphacode">Currency</span></div>
                  </div>
                  ...
                  <div class="row data-rates">
                    <div class="col-lg-2 colorphacode"><?php echo e(str_replace(["[","]","\""], ' ', $localdestiny['99']->pluck('surcharge_name')  )); ?></div>
                    <div class="col-lg-1 colorphacode"><?php echo e(str_replace(["[","]","\""], ' ', $localdestiny['99']->pluck('calculation_name')  )); ?></div>
                    <div class="col-lg-8 colorphacode">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>>
                        ...
                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>>  
                          <span class="bg-rates">   <?php echo e(isset($localdestiny['40hc']) ?  str_replace(["[","]","\""], ' ', $localdestiny['40hc']->pluck('monto')) :'0.00'); ?></span> <span class="bg-rates"> + <?php echo e(isset($localdestiny['40hc']) ?   str_replace(["[","]","\""], ' ', $localdestiny['40hc']->pluck('markup')) : '0.00'); ?></span>     <i class="la la-caret-right"></i>      <b class="monto-down"><?php echo e(isset($localdestiny['40hc']) ?   str_replace(["[","]","\""], ' ', $localdestiny['40hc']->pluck('montoMarkup')) : '0.00'); ?>   </b>  
                        </div>
                        <div class="wth" <?php echo e($equipmentHides['40nor']); ?>>  
                          <span class="bg-rates">  <?php echo e(isset($localdestiny['40nor']) ?  str_replace(["[","]","\""], ' ', $localdestiny['40nor']->pluck('monto')) :'0.00'); ?></span> <span class="bg-rates"> + <?php echo e(isset($localdestiny['40nor']) ?   str_replace(["[","]","\""], ' ', $localdestiny['40nor']->pluck('markup')) : '0.00'); ?></span>     <i class="la la-caret-right"></i>      <b class="monto-down"><?php echo e(isset($localdestiny['40nor']) ?   str_replace(["[","]","\""], ' ', $localdestiny['40nor']->pluck('montoMarkup')) : '0.00'); ?>     </b>
                        </div>
                        <div class="wth" <?php echo e($equipmentHides['45']); ?>>     
                          <span class="bg-rates"> <?php echo e(isset($localdestiny['45']) ?  str_replace(["[","]","\""], ' ', $localdestiny['45']->pluck('monto')) :'0.00'); ?></span> <span class="bg-rates"> + <?php echo e(isset($localdestiny['45']) ?   str_replace(["[","]","\""], ' ', $localdestiny['45']->pluck('markup')) : '0.00'); ?>    </span> <i class="la la-caret-right"></i>      <b class="monto-down"><?php echo e(isset($localdestiny['45']) ?   str_replace(["[","]","\""], ' ', $localdestiny['45']->pluck('montoMarkup')) : '0.00'); ?>     </b>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row bg-light">
                    ...
                    <div class="col-lg-8">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>><span class="portalphacode"><?php echo e($arr->tot20D); ?> </span></div>
                        <div class="wth" <?php echo e($equipmentHides['40']); ?>><span class="portalphacode"><?php echo e($arr->tot40D); ?></span></div>
                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>><span class="portalphacode"><?php echo e($arr->tot40hcD); ?></span></div>
                        <div class="wth" <?php echo e($equipmentHides['40nor']); ?>><span class="portalphacode"><?php echo e($arr->tot40norD); ?></span></div>
                        <div class="wth" <?php echo e($equipmentHides['45']); ?>><span class="portalphacode"><?php echo e($arr->tot45D); ?></span></div>
                      </div>
                    </div>
                    <div class="col-lg-1" ><span class="portalphacode"><?php echo e($arr->typeCurrency); ?></span></div>
                  </div>
              ...
              <?php endif; ?>
              <!-- Gastos Inlands-->
              <?php if(!$arr->inlandDestiny->isEmpty() || !$arr->inlandOrigin->isEmpty() ): ?>
              <div class="row no-margin margin-card" id='inland<?php echo e($loop->iteration); ?>'  hidden='true' >
                <div class="col-lg-12">
                  <div class="row">
                  ...
                  <?php if(!$arr->inlandDestiny->isEmpty()): ?>
                  <div class="row data-rates">
                    <div class="col-lg-12"> <span class="darkblue">Destiny</span><br><br></div>

                  </div>
                  <?php endif; ?>
                  <?php $__currentLoopData = $arr->inlandDestiny; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inlandDestiny): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                  <div class="row data-rates">
                    <div class="col-lg-2 colorphacode" ><?php echo e($inlandDestiny['providerName']); ?></div>
                    <div class="col-lg-2 colorphacode"><?php echo e($inlandDestiny['km']); ?> KM</div>
                    <div class="col-lg-6 colorphacode">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>><?php echo e($equipmentHides['20']); ?> <?php echo e(@$inlandDestiny['inlandDetails']['i20']['sub_in']); ?> &nbsp;+<b class="monto-down"><?php echo e(@$inlandDestiny['inlandDetails']['i20']['markup']); ?></b>
                          <i class="la la-caret-right"></i> <span class="bg-rates" id ='valor-d20<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>'>  <?php echo e(number_format(@$inlandDestiny['inlandDetails']['i20']['montoInlandT'], 2, '.', '')); ?>  </span>
                        </div>

                        <div class="wth" <?php echo e($equipmentHides['40']); ?>><?php echo e($equipmentHides['40']); ?>

                          <?php echo e(@$inlandDestiny['inlandDetails']['i40']['sub_in']); ?>

                          + &nbsp;<b class="monto-down"> <?php echo e(@$inlandDestiny['inlandDetails']['i40']['markup']); ?> </b><i class="la la-caret-right"></i> <span class="bg-rates" id = 'valor-d40<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>' > <?php echo e(number_format(@$inlandDestiny['inlandDetails']['i40']['montoInlandT'] , 2, '.', '')); ?> </span> 
                        </div>

                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>><?php echo e($equipmentHides['40hc']); ?>

                          <?php echo e(@$inlandDestiny['inlandDetails']['i40HC']['sub_in']); ?>

                          + &nbsp; <b class="monto-down"> <?php echo e(@$inlandDestiny['inlandDetails']['i40HC']['markup']); ?>    </b><i class="la la-caret-right"></i>   <span class="bg-rates" id = 'valor-d40h<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>'> <?php echo e(number_format(@$inlandDestiny['inlandDetails']['i40HC']['montoInlandT'], 2, '.', '')); ?>  </span>
                        </div>

                        <div class="wth"  <?php echo e($equipmentHides['40nor']); ?>>N/A</div>
                        <div class="wth" <?php echo e($equipmentHides['45']); ?>>N/A</div>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-1 no-padding d-flex align-items-center pos-btn">
                      ...
                      <label  tabindex="0" role="button" data-toggle="m-tooltip" data-trigger="focus" title="You have to select the Rate in order to choose an Inland." data-content="You have to select the Rate in order to choose an Inland."  data-inland="<?php echo e($loop->iteration); ?>"  data-rate="<?php echo e($arr->id); ?>" class="btn-input__select-add d-flex  labelSelectDest<?php echo e($arr->id); ?>  justify-content-center align-items-center visible__select-add add-click" style="background-color:transparent !important; color: #cecece !important;">Add</label>

                      <input type="checkbox" id="inputID-select<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>" data-inland="<?php echo e($loop->iteration); ?>" data-rate='<?php echo e($arr->id); ?>'   class="input-select inlands no-check " name="inlandD<?php echo e($arr->id); ?>[]" value="<?php echo e(json_encode($inlandDestiny)); ?> ">

                      <label for="inputID-select<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>" data-inland="<?php echo e($loop->iteration); ?>" data-rate='<?php echo e($arr->id); ?>'  class="btn-input__select-add d-flex labelDest<?php echo e($arr->id); ?> labelI labelI<?php echo e($arr->id); ?>-<?php echo e($loop->iteration); ?> justify-content-center align-items-center"  >Add</label>

                    </div>

                  </div><br>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php if(!$arr->inlandOrigin->isEmpty()): ?>
                  <div class="row data-rates">
                    <div class="col-lg-12"> <span class="darkblue">Origin</span><br><br></div>

                  </div>
                  <?php endif; ?>
                  <?php $__currentLoopData = $arr->inlandOrigin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inlandOrigin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                  <div class="row data-rates">
                    <div class="col-lg-2 colorphacode" ><?php echo e($inlandOrigin['providerName']); ?></div>
                    <div class="col-lg-2 colorphacode" ><?php echo e($inlandOrigin['km']); ?> KM</div>

                    <div class="col-lg-6 colorphacode">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>><?php echo e($equipmentHides['20']); ?>

                          <?php echo e(@$inlandOrigin['inlandDetails']['i20']['sub_in']); ?> 
                          <i class="la la-caret-right"></i>     <b class="monto-down"> <?php echo e(@$inlandOrigin['inlandDetails']['i20']['markup']); ?>      </b>  <span class="bg-rates" id ='valor-o20<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>'>  <?php echo e(number_format(@$inlandOrigin['inlandDetails']['i20']['montoInlandT'], 2, '.', '')); ?> </span>
                        </div>

                        <div class="wth" <?php echo e($equipmentHides['40']); ?>><?php echo e($equipmentHides['40']); ?>

                          <?php echo e(@$inlandOrigin['inlandDetails']['i40']['sub_in']); ?> 
                          <i class="la la-caret-right"></i> <b class="monto-down"><?php echo e(@$inlandOrigin['inlandDetails']['i40']['markup']); ?> </b> <span class="bg-rates" id = 'valor-o40<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>'> <?php echo e(number_format(@$inlandOrigin['inlandDetails']['i40']['montoInlandT'], 2, '.', '')); ?> </span>
                        </div>

                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>><?php echo e($equipmentHides['40hc']); ?>

                          <?php echo e(@$inlandOrigin['inlandDetails']['i40HC']['sub_in']); ?>

                          <i class="la la-caret-right"></i>   <b class="monto-down">      <?php echo e(@$inlandOrigin['inlandDetails']['i40HC']['markup']); ?>   </b> <span class="bg-rates" id ='valor-o40h<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>'> <?php echo e(number_format(@$inlandOrigin['inlandDetails']['i40HC']['montoInlandT'], 2, '.', '')); ?> </span>
                        </div>
                    ...
                    <div class="col-lg-1 no-padding d-flex align-items-center pos-btn">
                      ...
                      <input type="checkbox" id="inputIO-select<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>" data-inland="<?php echo e($loop->iteration); ?>" data-rate='<?php echo e($arr->id); ?>'   class="input-select inlandsO no-check" name="inlandO<?php echo e($arr->id); ?>[]" value="<?php echo e(json_encode($inlandOrigin)); ?>">

                      <label for="inputIO-select<?php echo e($loop->iteration); ?>-<?php echo e($arr->id); ?>" data-inland="<?php echo e($loop->iteration); ?>" data-rate='<?php echo e($arr->id); ?>'  class="btn-input__select-add d-flex labelOrig<?php echo e($arr->id); ?> labelO labelO<?php echo e($arr->id); ?>-<?php echo e($loop->iteration); ?> justify-content-center align-items-center"  >Add</label>
                  ...
                  <div class="row bg-light">
                    <input type='hidden' id='sub_inland_20_o<?php echo e($arr->id); ?>' value="0">
                    <input  type='hidden' id='sub_inland_40_o<?php echo e($arr->id); ?>' value="0">
                    <input  type='hidden' id='sub_inland_40h_o<?php echo e($arr->id); ?>' value="0">

                    <input type='hidden' id='sub_inland_20_d<?php echo e($arr->id); ?>' value="0">
                    <input type='hidden'  id='sub_inland_40_d<?php echo e($arr->id); ?>' value="0">
                    <input type='hidden'  id='sub_inland_40h_d<?php echo e($arr->id); ?>' value="0">

                    <div class="col-lg-4 col-lg-offset-" ><span class="portalphacode">Subtotal Inlands Charges</span></div>
                    <div class="col-lg-6">
                      <div class="d-flex justify-content-between">
                        <div class="wth" <?php echo e($equipmentHides['20']); ?>><span class="portalphacode"><div id='sub_inland_20<?php echo e($arr->id); ?>'>0.00</div> </span></div>
                        <div class="wth" <?php echo e($equipmentHides['40']); ?>><span class="portalphacode"><div id='sub_inland_40<?php echo e($arr->id); ?>'>0.00</div></span></div>
                        <div class="wth" <?php echo e($equipmentHides['40hc']); ?>><span class="portalphacode"><div id='sub_inland_40h<?php echo e($arr->id); ?>'>0.00</div></span></div>
                        <div class="wth" <?php echo e($equipmentHides['40nor']); ?>><span class="portalphacode"><div  >N/A</div></span></div>
                        <div class="wth" <?php echo e($equipmentHides['45']); ?>><span class="portalphacode"><div>N/A</div></span></div>
                      </div>
                    </div>
                    <div class="col-lg-1" ><span class="portalphacode"><?php echo e($arr->typeCurrency); ?></span></div>
                    <div class="col-lg-1" ><span class="portalphacode"></span></div>
              ...
              <?php if(isset($arr->contract->remarks)): ?>
              <div class="row no-margin margin-card" id='remark<?php echo e($loop->iteration); ?>'  hidden='true' >
                <div class="col-lg-12">
                  <div class="row">
...
<script>
  ...
  function AbrirModal(action,id){
    ...
    if(action == "addContact"){
      var url = '<?php echo e(route("contacts.addCM")); ?>';
      $('.modal-body').load(url,function(){
