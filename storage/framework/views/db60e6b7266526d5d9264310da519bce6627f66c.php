...
<?php $__env->startSection('title', 'New Request GlobalChargers'); ?>
...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--full-height">
        ...
        <?php echo Form::open(['route'=>'RequestsGlobalchargersFcl.store','method'=>'POST','files'=>true]); ?>
        ...
        $(function() {
            ...
            $('form').ajaxForm({
                ...
                complete: function(xhr) {
                    ...
                    if(count == 1){
                        swal({
                            ...
                            if (willDelete) {
                                ...
                                window.location.href = "<?php echo e(route('globalcharges.index')); ?>";
                            } else {
                                count = 0;
                                $('#modaledit').modal('hide');
                                window.location.href = "<?php echo e(route('globalcharges.index')); ?>";
                    ...
                    //window.location.href = "<?php echo e(route('RequestsGlobalchargersFcl.indexListClient')); ?>";
                }
            });
