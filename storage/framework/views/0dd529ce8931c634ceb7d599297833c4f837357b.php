...
<div class="d-md-none m--margin-bottom-10"></div>
               ...
               <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="top-start" style="position: absolute; transform: translate3d(0px, -136px, 0px); top: 0px; left: 0px; will-change: transform;">
                     ...
                     <a href="<?php echo e(route('DownLoad.Files',1)); ?>" class="dropdown-item" >
                        <span>
                     ...
                     <a href="<?php echo e(route('view.fail.company')); ?>" class="dropdown-item" >
                        <span>
                           <i class="la la-search"></i>
                           &nbsp;
                           Failed Companies
         ...
         <table class="m-datatable text-center" id="html_table" >
            ...
            <tbody>
               ...
               <tr>
                  <td><?php echo e($company->business_name); ?></td>
                  <td><?php echo e($company->phone); ?></td>
                  <td><?php echo e($company->email); ?></td>
                  <td><?php echo e($company->tax_number); ?></td>
                  ...
                  <td>
                     ...
                     <ul>
                        <li><?php echo e($groupUser->user->name); ?> </li>
                     </ul>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </td>
                  <td><?php echo e($company->contact->count()); ?></td>
                  <td>
                     ...
                     <ul>
                        <li><?php echo e($price->name); ?></li>
                     </ul>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </td>
                  <td>
                     <a href="<?php echo e(route('companies.show',setearRouteKey($company->id))); ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill">
                        <i class="la la-eye"></i>
                     </a>
                     <button onclick="AbrirModal('edit',<?php echo e($company->id); ?>)" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"  title="Edit">
                        <i class="la la-edit"></i>
                     </button>
                     <button id="delete-company" data-company-id="<?php echo e($company->id); ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"  title="Delete">
      ...
      <div class="modal-dialog modal-lg" role="document">
         <div class="modal-content">
            ...
            <div id="edit-modal-body-E" class="modal-body-E">
               <br>
               <?php echo Form::open(['route' => 'Upload.Company', 'method' => 'POST', 'files' => 'true']); ?>
...
<script src="<?php echo e(asset('js/companies.js')); ?>" type="text/javascript"></script>
