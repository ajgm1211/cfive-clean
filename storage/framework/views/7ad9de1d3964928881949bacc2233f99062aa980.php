            ...
            <div class="col-md-12">
                <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--left" role="tablist" style="border-bottom: none;">
                    ...
                    <li class="nav-item m-tabs__item size-14px" >
                        <a  href="<?php echo e(url('/v2/quotes/search')); ?>" class="btn-backto"><span class="fa fa-arrow-left"></span> Back to search</a>
                    </li>                    
                </ul>                
                        ...
                        <div class="tab-content">
                            <div class="row quote-info-mb">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?php echo e(Form::select('type',['FCL'=>'FCL','LCL'=>'LCL','AIR'=>'AIR'],$quote->type,['class'=>'form-control type select2','hidden','disabled'])); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" >
                                    ...
                                    <?php echo e(Form::select('equipment[]',['20' => '20','40' => '40','40HC'=>'40HC','40NOR'=>'40NOR','45'=>'45'],@$equipment,['class'=>'form-control equipment','multiple' => 'multiple','required' => 'true','hidden','disabled'])); ?>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <span class="kind_of_cargo_span"><?php echo e($quote->kind_of_cargo); ?></span>
                                    <?php echo e(Form::select('user_id',[''=>'Select an option','General'=>'General','Perishable'=>'Perishable','Dangerous'=>'Dangerous','Valuable Cargo'=>'Valuable Cargo','All Live Animals'=>'All Live Animals','Human Remains'=>'Human Remains','Pharma'=>'Pharma'],$quote->kind_of_cargo,['class'=>'form-control kind_of_cargo select2','hidden'])); ?>

                                </div>
                                <div class="col-md-4">
                                    <br>
                                    <label class="title-quote"><b>Commodity:&nbsp;&nbsp;</b></label>
                                    <span class="commodity_span"><?php echo e($quote->commodity); ?></span>
                                    <?php echo Form::text('commodity', $quote->commodity, ['placeholder' => 'Commodity','class' => 'form-control m-input commodity','hidden']); ?>
                                            ...
                                            <table class="table table-sm table-bordered table-hover table color-blue text-center">
                                                ...
                                                <tbody style="background-color: white;">
                                                    ...
                                                    <tr class="text-center">
                                                      <td class="tds"><?php echo e($package_load->type_cargo==1 ? 'Pallets':'Packages'); ?></td>
                                                      <td class="tds"><?php echo e($package_load->quantity); ?></td>
                                                      <td class="tds"><?php echo e($package_load->height); ?> cm</td>
                                                      <td class="tds"><?php echo e($package_load->width); ?> cm</td>
                                                      <td class="tds"><?php echo e($package_load->large); ?> cm</td>
                                                      <td class="tds"><?php echo e($package_load->weight); ?> kg</td>
                                                      <td class="tds"><?php echo e($package_load->total_weight); ?> kg</td>
                                                      <td class="tds"><?php echo e($package_load->volume); ?> m<sup>3</sup></td>
                                                  </tr>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
