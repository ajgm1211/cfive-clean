            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
               <div class="row align-items-center">
                  ...
                  <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                     <a href="<?php echo e(route('quotes-v2.search')); ?>" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                     <span>
                        <span>
                           Search Rates
                        </span>
   ...
   <script>
      ...
      $(function() {
         $('#tablequote').DataTable({
            ...
            serverSide: true,
            order: [[ 3, "asc" ],[ 4, "asc" ]],
            ajax:  "<?php echo e(route('quotes-v2.index.datatable')); ?>",
            columns: [
               {data: 'id', name: 'id'},
