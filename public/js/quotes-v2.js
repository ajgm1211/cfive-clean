...
$(document).ready(function () {
  ...
  $('.editable-amount-rate').editable({
    ...
    success: function (response, newValue) {
      ...
      var total = 0;
      var total_currency = 0;
      var markup_m20 = parseFloat($(this).closest('tr').find('.markup_' + code).html());
      alert(markup_m20);
      if (markup_m20 == '') {
        markup_m20 = 0;
      }
      ...
      //Mostrando sub total de gastos
      $(this).closest('div.rates').find('.sum_total_amount_' + code).html(sum_c20);
  ...
  $('.editable-amount-markup').editable({
    ...
    success: function (response, newValue) {
      ...
      var total = 0;
      var total_currency = 0;
      var amount_c20 = parseFloat($(this).closest('tr').find('.amount_'+code).html());
      ...
      //Mostrando sub total de gastos
      $(this).closest('div.rates').find('.sum_total_markup_'+code).html(sum_m20);
