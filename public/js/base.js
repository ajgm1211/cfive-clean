                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        if (data === 'Company deleted successfully!') {
                                            ...
                                            swal(
                                                'Error!',
                                                'This company has associated quotes. You can\'t delete companies with associated quotes.',
                                                'error'
                                            )
                                            console.log(data.message);
                                        }
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data === 'Company deleted successfully!') {
                                    ...
                                    swal(
                                        'Error!',
                                        'This company has associated quotes. You can not delete companies with associated quotes.',
                                        'warning'
                                    )
                                    console.log(data);
                                }
