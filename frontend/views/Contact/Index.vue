  ...
  <div class="col-12">
    <div class="head">
      ...
      <div class="head-btns">
        ...
        <DropdownHeadboard :items="items" :whitelabel="user.whitelabel"></DropdownHeadboard>
        <b-dropdown id="dropdown-left" text="Import">
          ...
          <b-dropdown-item
            v-if="user.whitelabel == 1"
            href="#"
            :disabled="toggleTWL"
            @click="AddToWhiteLevelModal()"
            ref="tranferTWL"
            >Transfer to WL</b-dropdown-item
          >
