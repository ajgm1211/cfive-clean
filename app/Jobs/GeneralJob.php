...
class GeneralJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        } elseif (strnatcasecmp($this->accion, 'duplicated_lcl') == 0) {
            $id = $requestArrayD['id'];
            $requestArray = $requestArrayD['data'];
        ...
        } elseif (strnatcasecmp($this->accion, 'edit_mult_rates_fcl') == 0) {
            $id = $requestArrayD['id'];
            $requestArray = $requestArrayD['data'];
        ...
        } elseif (strnatcasecmp($this->accion, 'edit_mult_rates_lcl') == 0) {
            $id = $requestArrayD['id'];
            $requestArray = $requestArrayD['data'];
