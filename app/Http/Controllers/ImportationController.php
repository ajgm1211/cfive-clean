...
//          );
        ...
        foreach($surcharMas_locals_found as $surcharMas_local_found){
            ...
            array_push($array['surcharMas_locals_found'], 
                       $surcharMas_local_found->surcharge->name. '    - '.
                       $surcharMas_local_found->direction->name. '    - '.
                       $surcharMas_local_found->calculationtype->name. '    - '.
        ...
        foreach($surcharMas_locals_not_found as $surcharMas_local_not_found){
            ...
            array_push($array['surcharMas_locals_not_found'], 
                       $surcharMas_local_not_found->surcharge->name. '    - '.
                       $surcharMas_local_not_found->direction->name. '    - '.
                       $surcharMas_local_not_found->calculationtype->name. '    - '.
