...
class ImportationController extends Controller
{
	...
	public function loadArrayEditMult(Request $request){
		...
		//dd($array);
		return view('importation.Body-Modals.FailEditByDetalls',compact('array','array_count'));
	}
	...
	public function showRatesMultiplesPorDetalles(Request $request){
		...
		dd($fail_rates_total);
		return view('importation.Body-Modals.FailEditByDetalls',compact('fail_rates_total','schedulesT','harbor','carrier','currency'));
