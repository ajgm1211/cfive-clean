            ...
            if ($data1 != null) {
                for ($i = 0; $i < count($data1); $i++) {
                    if (strpos($data1[$i]->carrier, $data->carrier->name) !== false && $data1[$i]->deleted_at == null) {
                        if (
                            strpos($data1[$i]->port_orig, $data->port_origin->code) && strpos($data1[$i]->port_dest, $data->port_destiny->code) || $data1[$i]->port_orig == "ALL" && strpos($data1[$i]->port_dest, $data->port_destiny->code)
