...
class Company extends Model implements Auditable
{
  ...
  protected $fillable = ['business_name','phone','address','email','associated_contacts','associated_quotes','currency_id','company_user_id','owner','tax_number','logo','pdf_language'];
