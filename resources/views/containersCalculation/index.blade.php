	...
	<div class="m-portlet m-portlet--mobile">
		...
		<div class="m-portlet m-portlet--tabs">
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="calculationts" role="tabpanel">
					<div class="m-portlet__body">
						<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
							<div class="row align-items-center">
								<div class="col-xl-12 order-2 order-xl-1 conten_load">
									...
									<div class="col-xl-12 order-1 order-xl-2 m--align-right">
										<a href="#" onclick="showModal('addCalculation',0)">
											<button type="button" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill" >
												<span>
													<span>
														Add&nbsp;
							...
							<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
								<div class="row align-items-center">
									<div class="col-xl-12 order-2 order-xl-1 conten_load">
										<table class="table tableData"  id="calculationsTable" width="100%">
											<thead width="100%">
												<tr>
													<th width="5%" >
														Id
...
<script>
	...
	function showModal(action,id){
		...
		if(action == "add"){
			...
			var url = '{{ route("CalculationType.edit",":id") }}';
			url = url.replace(':id', id);
			$('#modal-content').load(url,function(){
				$('#changeStatus').modal({show:true});
			});
	...
	var databableCT = $('#calculationsTable').DataTable({
		processing: true,
		ajax: '{!! route("CalculationType.create") !!}',
		columns: [
			{ data: 'id', name: 'id' },
			{ data: 'name', name: 'name' },
			{ data: 'code', name: 'code' },
