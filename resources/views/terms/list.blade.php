                ...
                <tbody> 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('terms.edit', ['id' => setearRouteKey($arr->id)]) }}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"  onclick="AbrirModal('edit',{{  $arr->id }})" title="Edit ">
