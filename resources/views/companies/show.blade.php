                ...
                <div class="col-md-4">
                            ...
                            <div class="m-portlet m-portlet--brand m-portlet--head-solid-bg">
                                <div class="m-portlet__body text-center">
                                    ...
                                    <div class="" style="line-height: .5;">
                                        <img src="{{Storage::disk('s3_upload')->url($company->logo)}}"
                                            class="img img-fluid"
                                            style="width: 100px; height: auto; margin-bottom:25px">
                                    </div>
                                    <br>
                                    @endif
                                    <h2 class="size-18px color-blue" style="text-transform: uppercase;">
                                        <b>{{$company->business_name}}</b> </h2>
                                    <hr>
                                    <button
                                        class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill dropdown-toggle"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                        ...
                                        style="position: absolute; transform: translate3d(0px, -136px, 0px); top: 0px; left: 0px; will-change: transform;">
                                        ...
                                        <a id="delete-company-show" href="#" class="dropdown-item"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="m-portlet m-portlet--brand m-portlet--head-solid-bg">
                                <div class="m-portlet__body">
                                    <h4 class="size-16px color-blue" data-toggle="collapse" data-target="#about_company"
                                        style="cursor: pointer"><i class="fa fa-angle-down"></i> &nbsp;<b>About
                                    ...
                                    <div class="collapse show" id="about_company">
                                        ...
                                        <p class="color-black">
                                            ...
                                            <input type="text" class="form-control" id="business_name_input"
                                                value="{{$company->business_name}}" hidden>
                                            <a id='edit_business_name' onclick="display_business_name()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill pull-right"
                                                title="Edit ">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a id='save_business_name' onclick="save_business_name({{$company->id}})"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Save" hidden="true">

                                                <i class="la la-save"></i>
                                            </a>
                                            <a id='cancel_business_name' onclick="cancel_business_name()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Cancel" hidden="true">
                                        ...
                                        <p class="color-black">
                                            ...
                                            <input type="text" class="form-control" id="phone_input"
                                                value="{{$company->phone}}" hidden>
                                            <a id='edit_phone' onclick="display_phone()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill pull-right"
                                                title="Edit ">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a id='save_phone' onclick="save_phone({{$company->id}})"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Save" hidden="true">
                                                <i class="la la-save"></i>
                                            </a>
                                            <a id='cancel_phone' onclick="cancel_phone()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Cancel" hidden="true">
                                                <i class="la la-reply"></i>
                                            </a>
                                        ...
                                        <p class="color-black">
                                            ...
                                            <input type="email" class="form-control" id="email_input"
                                                value="{{$company->email}}" hidden>
                                            <a id='edit_email' onclick="display_email()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill pull-right"
                                                title="Edit ">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a id='save_email' onclick="save_email({{$company->id}})"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Save" hidden="true">
                                                <i class="la la-save"></i>
                                            </a>
                                            <a id='cancel_email' onclick="cancel_email()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Cancel" hidden="true">
                                                <i class="la la-reply"></i>
                                            </a>
                                        ...
                                        <p class="color-black">
                                            ...
                                            <input type="text" class="form-control" id="tax_number_input"
                                                value="{{$company->tax_number}}" hidden>
                                            <a id='edit_tax_number' onclick="display_tax_number()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill pull-right"
                                                title="Edit ">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a id='save_tax_number' onclick="save_tax_number({{$company->id}})"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Save" hidden="true">
                                                <i class="la la-save"></i>
                                            </a>
                                            <a id='cancel_tax_number' onclick="cancel_tax_number()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Cancel" hidden="true">
                                                <i class="la la-reply"></i>
                                            </a>
                                        ...
                                        <p class="color-black">
                                            ...
                                            <a id='save_pdf_language' onclick="save_pdf_language({{$company->id}})"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Save" hidden="true">
                                                <i class="la la-save"></i>
                                            </a>
                                            <a id='cancel_pdf_language' onclick="cancel_pdf_language()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Cancel" hidden="true">
                                                <i class="la la-reply"></i>
                                            </a>
                                        ...
                                        <p class="color-black">
                                            ...
                                            <a id='edit_address' onclick="display_address()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill pull-right"
                                                title="Edit ">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a id='save_address' onclick="save_address({{$company->id}})"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Save" hidden>

                                                <i class="la la-save"></i>
                                            </a>
                                            <a id='cancel_address' onclick="cancel_address()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Cancel" hidden>
                                                <i class="la la-reply"></i>
                                            </a>
                                        ...
                                        <div id="price_level_list">
                                            <ul id="price_level_ul">
                                                ...
                                                <li style="margin-left: -25px;" class="color-black">{{$price->name}}
                                                </li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        ...
                                        <p>
                                            ...
                                            <a id='edit_prices' onclick="display_price_level()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill pull-right"
                                                title="Edit ">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a id='save_prices' onclick="save_price_level({{$company->id}})"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Save" hidden>
                                                <i class="la la-save"></i>
                                            </a>
                                            <a id='cancel_prices' onclick="cancel_price_level()"
                                                class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"
                                                title="Cancel" hidden>
                                                <i class="la la-reply"></i>
                                            </a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="m-portlet m-portlet--brand m-portlet--head-solid-bg">
                                <div class="m-portlet__body">
                                    <h4 class="size-16px color-blue" data-toggle="collapse" data-target="#about_company"
                                        style="cursor: pointer"><i class="fa fa-angle-down"></i> &nbsp;<b>Payment
                                            conditions</b></h4>
                                    <hr>
                                    <div class="collapse show" id="about_company">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="m-portlet m-portlet--brand m-portlet--head-solid-bg">
                                <div class="m-portlet__body">
                                    <h4 class="size-16px color-blue" data-toggle="collapse"
                                        data-target="#company_contacts" style="cursor: pointer"><i
                                            class="fa fa-angle-down"></i> &nbsp;<b>Contacts</b></h4>
                                    <hr>
                                    <div class="collapse show" id="company_contacts">
                                        @if(!$company->contact->isEmpty())
                                        @foreach($company->contact as $contact)
                                        <ul>
                                            <li>{{$contact->first_name}} {{$contact->last_name}} <a href="#"
                                                    data-contact-id="{{$contact->id}}" id="delete-contact"><span
                                                        class="pull-right"><i class="fa fa-close"></i></span></a></li>
                                        </ul>
                                        @endforeach
                                        @else
                                        <p>No contacts</p>
                                        ...
                                        <div class="text-center">
                                            <button class="btn btn-default"
                                                onclick="AbrirModal('addContact',{{$company->id}})">
                                                Add contact
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="m-portlet m-portlet--brand m-portlet--head-solid-bg">
                                <div class="m-portlet__body">
                                    <h4 class="size-16px color-blue" data-toggle="collapse"
                                        data-target="#company_owners" style="cursor: pointer"><i
                                            class="fa fa-angle-down"></i> &nbsp;<b>Owners</b></h4>
                                    <hr>
                                    <div class="collapse show" id="company_owners">
                                        ...
                                        <ul>
                                            <li>{{$groupUser->user->name}} {{$groupUser->user->lastname}} <a href="#"
                                                    data-owner-id="{{$groupUser->user_id}}" id="delete-owner"><span
                                                        class="pull-right"><i class="fa fa-close"></i></span></a></li>
                                        </ul>
                                        @endforeach
                                        @else
...
<script src="{{ asset('/assets/demo/default/custom/components/datatables/base/html-table-quotes.js')}}"
