...
<div class="form-group m-form__group">
    ...
    {{ Form::select('pdf_language',['0'=>'Choose a language','english'=>'English','spanish'=>'Spanish','portuguese'=>'Portuguese', 'italian'=>'Italian', 'Catalan'=>'Catalan', 'french'=>'French'],null,['class'=>'custom-select form-control','id' => 'pdf_language']) }}
</div>
