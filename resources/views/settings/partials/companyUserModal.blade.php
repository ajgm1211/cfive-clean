                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-form__group">
                                ...
                                {{ Form::select('currency_id',[149=>'USD',46=>'EUR'],null,['placeholder' => 'Please choose a currency','class'=>'custom-select form-control','id' => 'currency_id','required'=>'true']) }}
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group m-form__group">
                                <label for="pdf_language">PDF language</label>
                                {{ Form::select('pdf_language',['1'=>'English','2'=>'Spanish','3'=>'Portuguese', '4'=>'Italian', '5'=>'Catalan', '6'=>'French'],null,['placeholder' => 'Please choose a option','class'=>'custom-select form-control','id' => 'pdf_language','required'=>'true']) }}
                            </div>
                        </div>
                        <!--<div class="col-md-12">
                            <div class="form-group m-form__group">
