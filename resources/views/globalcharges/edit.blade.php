        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="m-radio-inline">
              ...
              <label class="m-radio">
                {{ Form::radio('typeroute', 'country', null ,['id' => 'rdroutePC' , 'onclick' => 'activarCountry(\'divportcountry\')' ]) }} Port to Country
                <span></span>
              </label>
              <label class="m-radio">
                {{ Form::radio('typeroute', 'country', null ,['id' => 'rdrouteCP' , 'onclick' => 'activarCountry(\'divcountryport\')' ]) }}  Country to Port
                <span></span>
              </label>
            </div>
          </div>
    ...
    <div class="form-group m-form__group row">
      ...
      <div class="col-lg-4">
        ...
        <div class="divportcountry" hidden="true">
          ...
          {{ Form::select('portcountry_orig[]', $harbor,[],['id' => 'portcountry_orig','class'=>'m-select2-general form-control ','multiple' => 'multiple' ]) }}

        </div>
        <div class="divcountryport" hidden="true">

          <i class="la la-anchor icon__modal"></i>{!! Form::label('origCP', 'Origin Country') !!}
          {{ Form::select('countryport_orig[]', $countries,[],['id' => 'countryport_orig','class'=>'m-select2-general form-control col-lg-12','multiple' => 'multiple' ]) }}
      ...
      <div class="col-lg-4">
        ...
        <div class="divportcountry" hidden="true" >
          ...
          {{ Form::select('portcountry_dest[]',$countries,[],[ 'id' => 'portcountry_dest','class'=>'m-select2-general form-control' ,'multiple' => 'multiple'   ]) }}

        </div>
        <div class="divcountryport" hidden="true" >
          <i class="la la-anchor icon__modal"></i>{!! Form::label('destCP', 'Destination Port') !!}
          {{ Form::select('countryport_dest[]', $harbor,[],['id' => 'countryport_dest','class'=>'m-select2-general form-control ','multiple' => 'multiple' ]) }}
        </div>
      </div>
    </div>
    <div class="form-group m-form__group row">
