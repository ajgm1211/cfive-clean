...
<div class="form-group m-form__group">
    {!! Form::text('to', null, ['placeholder' => 'To','class' => 'form-control m-input','required' => 'required']) !!}
    
</div>

<div class="form-group m-form__group">
    {!! Form::text('subjct', null, ['placeholder' => 'Subject','class' => 'form-control m-input','required' => 'required']) !!}
