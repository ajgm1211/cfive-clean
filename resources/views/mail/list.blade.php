                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            List of emails template to send
                        </h3>
                    </div>
                </div>
            </div>
                    ...
                    <tbody> 
                        @foreach ($data as $arr)
                            <tr>
                                ...
                                <td>{{ $arr->user_id }}</td>
                                <td> 
                                    <a href="{{ route('mail.send', ['id' => $arr->id]) }}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill"  onclick="AbrirModal('send',{{  $arr->id }})" title="Send ">
