  ...
  <div class="m-portlet__body">
    ...
    <div class="form-group m-form__group row">
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          {!! Form::text('ammount', 0, ['id' => 'ammountAdd','placeholder' => 'Please enter amount','class' => 'form-control m-input','step'=>'0.01']) !!}
          <span class="m-input-icon__icon m-input-icon__icon--right">
            <span>
      ...
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          {!! Form::text('minimum', 0, ['id' => 'minimumAdd','placeholder' => 'Please enter minimum','class' => 'form-control m-input']) !!}
          <span class="m-input-icon__icon m-input-icon__icon--right">
            <span>
              <i class="la la-bookmark-o"></i>
            </span>
