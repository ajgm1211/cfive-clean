				...
				<div class="row align-items-center">
					<div class="col-xl-12 order-2 order-xl-1 conten_load">
						<div class="col-xl-12 order-1 order-xl-2 m--align-right">
							<a href="#" class=" " onclick="showModal(1,0)" > 
								<button type="button" class="col-2 btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill" >
									<span>
										<span>
											Add&nbsp;
										</span>
						...
						<table class="table m-table m-table--head-separator-primary"  id="myatest" >
							<thead >
								<tr>
									...
									<th style="width:13%">Country ID</th>
