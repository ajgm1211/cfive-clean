...
@else
    <div class="alert alert-danger alert-dismissible fade show">    
        <div class="m-form__section m-form__section--first">
                <div class="form-group m-form__group" style="font-size: 15px; font-weight: 500;">
                    <strong>Warning!</strong><br>
                    This user has associated delegation. You can not delete users with associated delegations.
                </div>
            </div>
    </div>
@endif
