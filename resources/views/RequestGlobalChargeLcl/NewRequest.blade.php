...
<div class="m-content">
    ...
    <div class="m-portlet m-portlet--full-height">
        ...
        {!! Form::open(['route'=>'RequestsGlobalchargersLcl.store','method'=>'POST','id' => 'form','files'=>true])!!}
                                ...
                                <div class="col-lg-12 col-lg-offset-12 ">
                                    <center>
                                        <div class="col-lg-2 col-lg-offset-2 ">
                                            <br />
                                            <button type="button" onclick="fileempty()" id="button-submit" class="btn btn-primary form-control">
                                                Load Request
                                            </button>
                                        </div>
                                    </center>
