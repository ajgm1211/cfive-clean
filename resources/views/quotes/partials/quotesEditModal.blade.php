            ...
            <div class="modal-body">
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group">
                        ...
                        {{ Form::select('company_id',$companies,$quote->company->id,['placeholder' => 'Please choose a client','class'=>'custom-select form-control','id' => 'm_select2_2_modal']) }}
                    </div>
                    <div class="form-group m-form__group">
                        {!! Form::label('origin', 'Origin') !!}<br>
                        {{ Form::select('origin',$countries,$quote->origin_country->id,['placeholder' => 'Please choose an origin','class'=>'custom-select form-control','id' => 'select-origin-2']) }}
                    </div>
                    <div class="form-group m-form__group">
                        {!! Form::label('destination', 'Destination') !!}<br>
                        {{ Form::select('destination',$countries,$quote->destination_country->id,['placeholder' => 'Please choose a destination','class'=>'custom-select form-control','id' => 'select-destination-2']) }}
                    </div>
                    <div class="form-group m-form__group">
