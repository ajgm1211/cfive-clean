...
@endsection
@section('title', 'Importation - Filter Surchergers.')
@section('content')
        ...
        <div class="m-portlet__body">
            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                ...
                <div class="table-responsive">
                    <table class="table m-table m-table--head-separator-primary" id="importationcompanyFiltros" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Name</th>
...
<script>
    ...
    $(document).on('click', '#delete-surcharger', function(){
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        if(data.success == 1){
                            swal(
                                'Deleted!',
                                'Your Surcharger has been deleted.',
                                'success'
                            );
                            $('#importationcompanyFiltros').DataTable().ajax.reload();
                        }else if(data == 2){
