...
<div class="m-portlet">
    ...
    {{ Form::model($globalcharges, array('route' => array('gclcladm.update', $globalcharges->id), 'method' => 'PUT', 'id' => 'frmSurcharges')) }}
    <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-4">
                ...
                <div class="m-input-icon m-input-icon--right">
                    {!! Form::number('ammount', $globalcharges->ammount, ['id' => 'ammount','placeholder' => 'Please enter the 40HC','required','class' => 'form-control m-input','step'=>'0.01', 'required' =>'true']) !!}
                    <span class="m-input-icon__icon m-input-icon__icon--right">
                        <span>
