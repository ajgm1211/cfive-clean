...
new registration
        ...
        @if($type == 1)
        {!! Form::open(['route'=>'ImportationLCL.create','method'=>'get'])!!} <!-- W/M -->
        @elseif($type == 2)
        {!! Form::open(['route'=>'process.contract.fcl.Rat.Surch','method'=>'get'])!!} <!-- W/M + Surchargers -->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    {!!  Form::text('comments',$value['comments'],['id'=>'comments',
