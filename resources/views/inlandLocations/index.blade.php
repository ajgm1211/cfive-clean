@extends('layouts.app')
@section('title', 'Inland Locations')
@section('content')
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="#"  data-inlandl-id="{{$arr->id}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill delete-inlandl" title="Delete" >
