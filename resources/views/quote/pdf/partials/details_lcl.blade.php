        <div id="details" class="clearfix details">
            ...
            <!--only Client -->
            <div style="line-height: 10px; width:350px" class="incoterm {{@$quote->company->business_name=='' ? '':'hide' }}">
            ...
            <!-- Client -->
            <div class="client {{@$quote->company->business_name=='' ? 'hide':'' }}" style="line-height: 10px; width:350px; float:right">
