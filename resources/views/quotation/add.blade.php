    ...
    <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-12">
                          ...
                          <div class="form-group m-form__group row">
                            <div class="col-md-12">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-1">
                                  <div class="m-bootstrap-touchspin-brand">
                                    <input id="origin_total_ammount" name="origin_total_ammount[]" class="form-control origin_total_ammount" type="number" min="0" value="{{ $total[0] }}"/>
                                  </div>
                                </div>
                                <div class="col-md-1" >
                                  <div class="m-bootstrap-touchspin-brand">
                                    <div class="form-group">
                                      <div class="input-group">
                                        <input type="text" name="origin_total_ammount_2[]"  class="form-control origin_total_ammount_2" aria-label="..." value="{{ $origin->origin->subtotal_local   }}">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class='row'>
                                ...
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <span>
                                      <h5 class="size-12px">
                                        Sub-Total:<span id="sub_total_origin">{{ $info->totalOrigin }}</span>&nbsp;@if(isset($currency_cfg->alphacode)){{$currency_cfg->alphacode}}@endif
                                        <input type="hidden" id="total_origin_ammount" name="sub_total_origin" class="form-control" value="{{ $info->totalOrigin }}"/>
                                      </h5>
                                    </span>
                                  </div>
                                </div>
                          ...
                          <div class="form-group m-form__group row">
                            <div class="col-md-12">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-2">
                                  <div class="m-bootstrap-touchspin-brand">
                                    <input id="destination_ammount_detatil" name="destination_ammount_detail[]" class="form-control" type="text" value="{{ $destiny->destiny->calculation_name }}"/>
                                  </div>
                                </div>
                                <div class="col-md-1">
                                  <div class="m-bootstrap-touchspin-brand">
                                    <input id="destination_ammount_units" name="destination_ammount_units[]" class="form-control destination_ammount_units" type="number" min="0" value="{{ $destiny->destiny->cantidad }}"/>
                                  </div>
                                </div>
                                <div class="col-md-3">
                                  <div class="m-bootstrap-touchspin-brand">
                                    <div class="input-group">
                                      <input type="number" id="destination_ammount" name="destination_price_per_unit[]" min="1" step="0.01" class="destination_price_per_unit form-control" aria-label="..." value="{{ $destiny->destiny->monto }}">
                                      <div class="input-group-btn">
                                        <div class="btn-group">
                                ...
                                <div class="col-md-1">
                                  <div class="m-bootstrap-touchspin-brand">
                                    <input id="destination_ammount_markup" name="destination_ammount_markup[]" class="form-control destination_ammount_markup" type="number" min="0" value="{{ $destiny->destiny->markup }}" />
                                  </div>
                                </div>
                                <div class="col-md-1">
                                  <div class="m-bootstrap-touchspin-brand">
                                    <input id="destination_total_ammount" name="destination_total_ammount[]" class="form-control destination_total_ammount" type="number" min="0" value="{{$total[0] }}"/>
                                  </div>
                                </div>
                                <div class="col-md-1" >
                                  <div class="m-bootstrap-touchspin-brand">
                                    <div class="form-group">
                                      <div class="input-group">
                                        <input type="text" name="destination_total_ammount_2[]"  class="form-control" aria-label="..." value="{{ $destiny->destiny->subtotal_local }}">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <span>
                                      ...
                                      <h5>
                                        Sub-Total:<span id="sub_total_destination">{{ $info->totalDestiny }} </span>&nbsp;@if(isset($currency_cfg->alphacode)){{$currency_cfg->alphacode}}@endif
                                        <input type="hidden" id="total_destination_ammount" name="sub_total_destination" class="form-control"  value="{{ $info->totalDestiny }}"/>
                                      </h5>
                                    </span>
                                  </div>
                                </div>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group text-right">
                                    <h3><b>Total: {{$info->totalQuote}}</b> <span id="total"> @if(isset($currency_cfg->alphacode)){{$currency_cfg->alphacode}}@endif</span> </h3>
                                  </div>
                                </div>
                              </div>
                            </div>
          ...
          <input type="hidden" class="form-control" id="owner" name="owner[]" value="{{ $origin->origin->surcharge_name }} ">
          <input type="hidden" class="form-control" id="owner" name="owner[]" value="{{ $origin->origin->surcharge_name }} ">
          <input type="hidden" class="form-control" id="owner" name="owner[]" value="{{ $origin->origin->surcharge_name }} ">
          <input type="hidden" class="form-control" id="owner" name="owner[]" value="{{ $origin->origin->surcharge_name }} ">
          <input type="hidden" class="form-control" id="owner" name="owner[]" value="{{ $origin->origin->surcharge_name }} ">
