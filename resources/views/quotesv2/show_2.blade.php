...
<div class="m-content bg-quotes">
  ...
  <div class="row">
    <div class="col-md-12">
      <a href="#0" class="btn-backto"><span class="fa fa-arrow-left"></span> Back to search</a>
          ...
          <div class="tab-content">
            ...
            <div class="row quote-info-mb">
              <div class="col-md-4">
                ...
                <span class="status_span Status_{{$quote->status}} span_draft" style="border-radius: 10px;">{{$quote->status}} <i class="fa fa-check"></i></span>
              </div>
              <div class="col-md-4">
            ...
            <div class="flex-list" style=" margin-bottom:-30px; margin-top: 0;">
              <ul>
                <li style="max-height: 20px;">                                            
                  ...
                  <img src="{{ url('imgcarrier/'.$rate->carrier->image) }}"  class="img img-responsive" width="55" height="auto" style="margin-top: 15px;" />
                  @endif
                </li>
                      ...
                      <tbody style="background-color: white;">
                        ...
                        <tr style="height:40px;">
                          ...
                          <td {{ $equipmentHides['20'] }} class="tds">
                            <a href="#" class="editable-amount-20 amount_20 td-a"data-type="text" data-name="amount->c20" data-value="{{@$freight_amounts['c20']}}" data-pk="{{$item->id}}" data-title="Amount"></a>
                            +
                            <a href="#" class="editable-markup-20 markup_20 td-a"data-type="text" data-name="markups->c20" data-value="{{@$freight_markups['c20']}}" data-pk="{{$item->id}}" data-title="Markup"></a>

                            <span class="total_20 td-a">{{@$freight_amounts['c20']+@$freight_markups['c20']}}</span>
                          </td>
                          <td {{ $equipmentHides['40'] }} class="tds">
                            <a href="#" class="editable-amount-40 amount_40 td-a" data-type="text" data-name="amount->c40" data-value="{{@$freight_amounts['c40']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            +
                            <a href="#" class="editable-markup-40 markup_40 td-a"data-type="text" data-name="markups->c40" data-value="{{@$freight_markups['c40']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <span class="total_40 td-a">{{@$freight_amounts['c40']+@$freight_markups['c40']}}</span>
                          </td>
                          <td {{ $equipmentHides['40hc'] }} class="tds">
                            <a href="#" class="editable-amount-40hc amount_40hc td-a"data-type="text" data-name="amount->c40hc" data-value="{{@$freight_amounts['c40hc']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <a href="#" class="editable-markup-40hc markup_40hc td-a"data-type="text" data-name="markups->c40hc" data-value="{{@$freight_markups['c40hc']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <span class="total_40hc td-a">{{@$freight_amounts['c40hc']+@$freight_markups['c40hc']}}</span>
                          </td>
                          <td {{ $equipmentHides['40nor'] }} class="tds">
                            <a href="#" class="editable-amount-40nor amount_40nor td-a"data-type="text" data-name="amount->c40nor" data-value="{{@$freight_amounts['c40nor']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            +
                            <a href="#" class="editable-markup-40nor markup_40nor td-a"data-type="text" data-name="markups->c40nor" data-value="{{@$freight_markups['c40nor']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <span class="total_40nor td-a">c{{@$freight_amount['c40nor']+@$freight_markups['c40nor']}}</span>
                          </td>
                          <td {{ $equipmentHides['45'] }} class="tds">
                            <a href="#" class="editable-amount-45 amount_45 td-a" data-type="text" data-name="amount->c45" data-value="{{@$freight_amounts['c45']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            +
                            <a href="#" class="editable-markup-45 markup_45 td-a" data-type="text" data-name="markups->c45" data-value="{{@$freight_markups['c45']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <span class="total_45 td-a">{{@$freight_amount['45']+@$freight_markups['45']}}</span>
                          </td>
                          <td class="tds">
                    ...
                    <table class="table table-sm table-bordered color-blue text-center">
                      ...
                      <tbody style="background-color: white;">
                        ...
                        <tr style="height: 40px;">
                          ...
                          <td {{ $equipmentHides['20'] }} class="tds">
                            <a href="#" class="editable-amount-20 amount_20 td-a"data-type="text" data-name="amount->c20" data-value="{{@$origin_amounts['c20']}}" data-pk="{{$item->id}}" data-title="Amount"></a>
                            +
                            <a href="#" class="editable-markup-20 markup_20 td-a"data-type="text" data-name="markups->c20" data-value="{{@$origin_markups['c20']}}" data-pk="{{$item->id}}" data-title="Markup"></a>

                            <span class="total_20 td-a">{{@$origin_amounts['c20']+@$origin_markups['c20']}}</span>
                          </td>
                          <td {{ $equipmentHides['40'] }}  class="tds">
                            <a href="#" class="editable-amount-40 amount_40 td-a"data-type="text" data-name="amount->c40" data-value="{{@$origin_amounts['c40']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            +
                            <a href="#" class="editable-markup-40 markup_40 td-a"data-type="text" data-name="markups->c40" data-value="{{@$origin_markups['c40']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            <span class="total_40 td-a">{{@$origin_amounts['c40']+@$origin_markups['c40']}}</span>
                          </td>
                          <td {{ $equipmentHides['40hc'] }}  class="tds">
                            <a href="#" class="editable-amount-40hc amount_40hc td-a"data-type="text" data-name="amount->c40hc" data-value="{{@$origin_amounts['c40hc']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            +
                            <a href="#" class="editable-amount-40hc markup_40hc td-a"data-type="text" data-name="markups->c40hc" data-value="{{@$origin_markups['c40hc']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                          ...
                          <td {{ $equipmentHides['40nor'] }}  class="tds">
                            ...
                            +
                            <a href="#" class="editable-markup-40nor markup_40nor td-a"data-type="text" data-name="markups->40nor" data-value="{{@$origin_markups['c40nor']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <span class="total_40nor td-a">{{@$origin_amounts['c40nor']+@$origin_markups['c40nor']}}</span>
                          </td>
                          <td {{ $equipmentHides['45'] }}  class="tds">
                            <a href="#" class="editable-amount-45 amount_45 td-a" data-type="text" data-name="amount->c45" data-value="{{@$origin_amounts['c45']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            +
                            <a href="#" class="editable-markup-45 markup_45 td-a" data-type="text" data-name="markups->c45" data-value="{{@$origin_markups['c45']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <span class="total_45 td-a">{{@$origin_amounts['c45']+@$origin_markups['c45']}}</span>
                          </td>
                          <td  class="tds">
                            <a href="#" class="editable td-a" data-source="{{$currencies}}" data-type="select" data-value="{{$item->currency_id}}" data-pk="{{$item->id}}" data-title="Select currency"></a>
                          </td>
                        </tr>
                        @php
                        $a++;
                    ...
                    <table class="table table-sm table-bordered color-blue text-center">
                      ...
                      <tbody style="background-color: white;">
                        ...
                        <tr>
                          ...
                          <td {{ $equipmentHides['20'] }} class="tds">
                            <a href="#" class="editable destination_amount_20 td"data-type="text" data-name="amount->c20" data-value="{{@$destination_amounts['c20']}}" data-pk="{{$item->id}}" data-title="Amount"></a>
                            +
                            <a href="#" class="editable destination_markup_20 td-a"data-type="text" data-name="markups->c20" data-value="{{@$destination_markups['c20']}}" data-pk="{{$item->id}}" data-title="Markup"></a>

                            <span class="total_20 td-a">{{@$destination_amounts['c20']+@$destination_markups['c20']}}</span>
                          </td>
                          <td {{ $equipmentHides['40'] }} class="tds">
                            <a href="#" class="editable destination_amount_40 td-a"data-type="text" data-name="amount->c40" data-value="{{@$destination_amounts['c40']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            +
                            <a href="#" class="editable destination_markup_40 td-a"data-type="text" data-name="markups->c40" data-value="{{@$destination_markups['c40']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <span class="total_40 td-a">{{@$destination_amounts['c40']+@$destination_markups['c40']}}</span>
                          </td>
                          <td {{ $equipmentHides['40hc'] }} class="tds">
                            <a href="#" class="editable destination_amount_40hc td-a"data-type="text" data-name="amount->c40hc" data-value="{{@$destination_amounts['c40hc']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            +
                            <a href="#" class="editable destination_markup_40hc td-a"data-type="text" data-name="markups->c40hc" data-value="{{@$destination_markups['c40hc']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <span class="total_40hc td-a">{{@$destination_amounts['c40hc']+@$destination_markups['c40hc']}}</span>
                          </td>
                          <td {{ $equipmentHides['40nor'] }} class="tds">
                            <a href="#" class="editable destination_amount_40nor td-a"data-type="text" data-name="amount->c40nor" data-value="{{@$destination_amounts['c40nor']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            +
                            <a href="#" class="editable destination_markup_40nor td-a"data-type="text" data-name="markups->c40hc" data-value="{{@$destination_markups['c40nor']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <span class="total_40nor td-a">{{@$destination_amounts['c40nor']+@$destination_markups['c40nor']}}</span>
                          </td>
                          <td {{ $equipmentHides['45'] }} class="tds">
                            <a href="#" class="editable destination_amount_45 td-a" data-type="text" data-name="amount->c45" data-value="{{@$destination_amounts['c45']}}" data-pk="{{$item->id}}" data-title="Total"></a>
                            +
                            <a href="#" class="editable destination_markup_45 td-a" data-type="text" data-name="markups->c45" data-value="{{@$destination_markups['c45']}}" data-pk="{{$item->id}}" data-title="Total"></a>

                            <span class="total_45 td-a">{{@$destination_amounts['c45']+@$destination_markups['c45']}}</span>
                          </td>
                          <td class="tds">
                            <a href="#" class="editable td-a" data-source="{{$currencies}}" data-name="markups->45" data-type="select" data-value="{{$item->currency_id}}" data-pk="{{$item->id}}" data-title="Select currency"></a>
                          </td>
                        </tr>
                        @php
                        $a++;
          ...
          <div class="tab-content" id="show_detailed">
            ...
            <div class="row" style="padding-top: 10px;">
              ...
              <div class="col-md-3 group_destination_charges">
                <div class="form-check">
                  <input class="form-check-input pdf-feature check" data-quote-id="{{$quote->id}}" data-name="grouped_destination_charges" data-type="checkbox" type="checkbox" name="grouped_destination_charges" value="1" {{$quote->pdf_option->grouped_destination_charges==1 ? 'checked':''}}>
    ...
    <div class="col-md-12">
      <div class="m-portlet custom-portlet" style="box-shadow: none; background-color: #fff !important; border:none;">
        <div class="m-portlet__head">
          ...
          <div class="m-portlet__head-tools">
            <div class="btn-open" id="remks"><span class="fa fa-angle-down"></span></div>
            <!--<ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--right m-tabs-line-danger" role="tablist" style="border-bottom: none;">
<li class="nav-item m-tabs__item" id="edit_li">
...
Edit&nbsp;&nbsp;<i class="fa fa-pencil"></i>
        ...
        <div class="m-portlet__body remks">
          <div class="row">
            <div class="col-md-12">
              <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line-danger" role="tablist" style="border-bottom: none; margin-bottom: 10px">
                <li class="nav-item m-tabs__item" id="edit_li">
          ...
          <div class="card card-body remarks_span_{{$v}}">
