                                            ...
                                            <li class="m-width-120" style="border-left:none;">                                  
                                                @if($quote->type!='AIR')
                                                    @if(isset($rate->carrier->image) && $rate->carrier->image!='')
                                                        <img src="http://cargofive-production-21.s3.eu-central-1.amazonaws.com/imgcarrier/{{$rate->carrier->image}}"  class="img img-responsive" width="50" height="auto" style="margin-top: 10px;" />
                                                    @endif
                                                @else
