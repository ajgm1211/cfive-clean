        ...
        <div class="row">
            <div class="col-md-12">
                <div class="m-portlet custom-portlet no-border">
                    ...
                    if(isset($freight_markups['c20'])){
                        $sum_m20+=$item->total_markup20;
                    }
                    if(isset($freight_markups['c40'])){
                        $sum_m40+=@$item->total_markup40;
                    }
                    if(isset($freight_markups['c40hc'])){
                        $sum_m40hc+=@$item->total_markup40hc;
                    }
                    if(isset($freight_markups['c40nor'])){
                        $sum_m40nor+=@$item->total_markup40nor;
                    }
                    if(isset($freight_markups['c45'])){
