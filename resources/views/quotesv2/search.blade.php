                    ...
                    <div class="col-lg-8 colorphacode">
                      <div class="d-flex justify-content-between">
                        ...
                        <div class="wth" {{ $equipmentHides['20R'] }}>     
                          <span class="bg-rates"> {{ isset($localorigin['20R']) ?  str_replace(["[","]","\""], ' ', $localorigin['20R']->pluck('monto')) :'0.00' }}</span> <span class="bg-rates">+ {{ isset($localorigin['20R']) ?   str_replace(["[","]","\""], ' ', $localorigin['20R']->pluck('markup')) : '0.00' }}     </span><i class="la la-caret-right arrow-down"></i>     <b class="monto-down"> {{ isset($localorigin['20R']) ?   str_replace(["[","]","\""], ' ', $localorigin['20R']->pluck('montoMarkup')) : '0.00' }}     </b>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row data-rates">
                    ...
                    <div class="col-lg-8 colorphacode">
                      <div class="d-flex justify-content-between">
                        ...
                        <div class="wth" {{ $equipmentHides['20R'] }}>     
                          <span class="bg-rates">{{ isset($localfreight['20R']) ?  str_replace(["[","]","\""], ' ', $localfreight['20R']->pluck('monto')) :'0.00' }}</span> <span class="bg-rates">+ {{ isset($localfreight['20R']) ?   str_replace(["[","]","\""], ' ', $localfreight['20R']->pluck('markup')) : '0.00' }}     </span><i class="la la-caret-right arrow-down"></i>   <b class="monto-down">   {{ isset($localfreight['20R']) ?   str_replace(["[","]","\""], ' ', $localfreight['20R']->pluck('montoMarkup')) : '0.00' }}     </b>
                        </div>
                  ...
                  <div class="row data-rates">
                    ...
                    <div class="col-lg-8 colorphacode">
                      <div class="d-flex justify-content-between">
                        ...
                        <div class="wth" {{ $equipmentHides['20R'] }}>     
                          <span class="bg-rates"> {{ isset($localdestiny['20R']) ?  str_replace(["[","]","\""], ' ', $localdestiny['20R']->pluck('monto')) :'0.00' }}</span> <span class="bg-rates"> + {{ isset($localdestiny['20R']) ?   str_replace(["[","]","\""], ' ', $localdestiny['20R']->pluck('markup')) : '0.00' }}    </span> <i class="la la-caret-right"></i>      <b class="monto-down">{{ isset($localdestiny['20R']) ?   str_replace(["[","]","\""], ' ', $localdestiny['20R']->pluck('montoMarkup')) : '0.00' }}     </b>
                        </div>
                      </div>
                    </div>
