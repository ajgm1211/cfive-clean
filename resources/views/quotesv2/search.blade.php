                                                ...
                                                <div class="m-bootstrap-touchspin-brand">
                                                    <div class="input-group">
                                                        <input type="number" id="total_quantity" name="total_quantity"
                                                            min="0" step="0.0001" class="total_quantity form-control"
                                                ...
                                                <div class="m-bootstrap-touchspin-brand">
                                                    <div class="input-group">
                                                        <input type="number" id="total_weight" name="total_weight"
                                                            min="0" step="0.0001" class="total_weight form-control"
                                                            placeholder="" aria-label="...">
                                                        <div class="input-group-btn">
                                                            <button type="button"
                                                ...
                                                <div class="m-bootstrap-touchspin-brand">
                                                    <div class="input-group">
                                                        <input type="number" id="total_volume" name="total_volume"
                                                            min="0" step="0.0001" class="total_volume form-control"
                                                            placeholder="" aria-label="...">
                                                        <div class="input-group-btn">
                                                            <button type="button"
                                                                class="btn btn-default dropdown-toggle"
                                        ...
                                        <div class="template">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group">
                                                        <input type="number" id="weight" name="weight[]" min="0"
                                                            step="0.0001" class="weight weight_2 form-control size-12px"
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <p class=""><span class="quantity"></span> <span
                                                            class="volume"></span> <span class="weight"></span></p>
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                            ...
                            <div class="col-lg-12 no-padding">
                                <div class="row  justify-content-between">
                                    <div class="col-lg-9 d-flex message  align-items-end align-self-end">
                                        ...
                                        <p class="warning-p"><span><i class="la la-info-circle"></i>The equipments do
                                                not belong to the same group.</span> You can create a quote manually.
                                        </p>
                                        @endif
                                        @endif
                                        @if(isset($arreglo) && isset($validateEquipment) )
                                        @if($arreglo->isEmpty() && $validateEquipment['count'] < 2 ) <p
                                            class="warning-p"><span><i class="la la-info-circle"></i>No freight rates
                                                were found for this trade route.</span> You can create a quote manually.
                                            </p>
                                            @endif
                                            @endif
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 padding-right-table" style="padding-left: 0;">
                                            <div style="display:flex; justify-content:space-between">
                                                ...
                                                <div class="wth" style="display:flex; justify-content:center;"
                                                    {{ $equipmentHides[$container->code] }}><span
                                                        class="portcss">{{ $container->code }}</span></div>
                                                @endforeach
                        ...
                        <div class="card-p__quotes input-select{{$loop->iteration}}" style="margin-bottom: 50px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6" style="padding-right: 35px;">
                                            <div class="table-r__quotes">
                                                @foreach($containers as $container)
                                                <div class="wth " {{ $equipmentHides[$container->code] }}><span
                                                        class="darkblue validate tot{{$container->code}}-{{$arr->id}}">{{$arr->{'totalT'.$container->code}  }}
                                                    </span><span class="currency" style="margin-left:5px">
                                                        {{ $arr->typeCurrency }}</span></div>
                                                <input type='hidden' id='tot{{$container->code}}-{{$arr->id}}'
                                        ...
                                        <div class="col-lg-1 no-padding d-flex align-items-center pos-btn">
                                            <input type="checkbox" id="input-select{{$loop->iteration}}"
                                        ...
                                        <div class="col-lg-12 b-top no-padding padding-min">
                                            <div class="row justify-content-between">
                                                ...
                                                <div class="col-lg-1">
                                                    <div class="btn-detail__quotes btn-remarks">
                                                        <a id='display_r{{$loop->iteration}}'
                                                            ...
                                                            class="l btn-nowrap" title="Cancel">
                                                ...
                                                <div class="col-lg-2 d-flex align-items-center">
                                                    <span class="portalphacode" style="margin-right:5px;">Schedule Type:
                                                    </span> {{ $arr->sheduleType  }}
                                                </div>
                                                <div class="col-lg-1 d-flex align-items-center">
                                                    <span class="portalphacode"
                                                        style="margin-right:15px; white-space:nowrap"> TT: </span>
                                                    {{ $arr->transit_time   }}
                                                </div>
                                                <div class="col-lg-2 d-flex align-items-center">
                                                    <span class="portalphacode" style="margin-right:15px;"> Via: </span>
                                                    {{  $arr->via }}
                                                </div>
                                                @endif
                                                <div
                                                    class="col-lg-2 no-padding d-flex justify-content-end align-items-center">
                                                    ...
                                                    <div class="downexcel" style="margin-right: 10px;">
                                                        ...
                                                        <a id='excel_l{{$loop->iteration}}'
                                                            ...
                                                            class="l detailed-cost" title="Cancel">
                                                    ...
                                                    <div class="btn-detail__quotes btn-d">
                                                        <a id='display_l{{$loop->iteration}}'
                                                            ...
                                                            class="l detailed-cost btn-nowrap" title="Cancel">
                            ...
                            <div class="row no-margin margin-card" id='origin{{$loop->iteration}}' hidden='true'>
                                <div class="col-lg-12">
                                    ...
                                    <div class="row bg-light">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="d-flex justify-content-between">
                                                @foreach($containers as $container)
                                                <div class="wth" {{ $equipmentHides[$container->code] }}><span
                                                        class="portalphacode">{{ $container->code }} </span></div>
                                                @endforeach
                                        ...
                                        <div class="col-lg-8 colorphacode">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="wth" {{ $equipmentHides[$container->code] }}>
                                                    <span class="bg-rates">
                                                        {{ isset($localorigin[$container->code]) ?   str_replace(["[","]","\""], ' ', $localorigin[$container->code]->pluck('monto')) : '0.00' }}</span>
                                                    <span class="bg-rates">+
                                                        {{ isset($localorigin[$container->code]) ?   str_replace(["[","]","\""], ' ', $localorigin[$container->code]->pluck('markup')) : '0.00' }}
                                                    </span><i class="la la-caret-right arrow-down"></i> <b
                                                        class="monto-down">
                                                        {{ isset($localorigin[$container->code]) ?   str_replace(["[","]","\""], ' ', $localorigin[$container->code]->pluck('montoMarkup')) : '0.00' }}</b>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
                                    ...
                                    @endforeach
                                    <div class="row bg-light">
                                        <div class="col-lg-3 col-lg-offset-"><span class="portalphacode">Subtotal Origin
                                                Charges</span></div>
                                        <div class="col-lg-8">
                                            <div class="d-flex justify-content-between">
                                                @foreach($containers as $container)
                                                ...
                                                <div class="wth" {{ $equipmentHides[$container->code] }}><span
                                                        class="portalphacode">{{ $arr->{'tot'.$container->code.'O'}  }}
                                                    </span></div>
                                                @endforeach
                                            </div>
                                        </div>
                                        <div class="col-lg-1"><span
                                                class="portalphacode">{{ $arr->typeCurrency }}</span></div>
                                    </div>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="row no-margin margin-card" id='freight{{$loop->iteration}}' hidden='true'>
                                <div class="col-lg-12">
                                    ...
                                    <div class="row data-rates">
                                        ...
                                        <div class="col-lg-1 colorphacode" style="white-space: nowrap">
                                            {{ $rates['detail'] }}</div>
                                        <div class="col-lg-8 colorphacode">
                                            <div class="d-flex justify-content-between">
                                                @foreach($containers as $container)
                                                <div class="wth" {{ $equipmentHides[$container->code] }}> <span
                                                        class="bg-rates">{{ @$rates['price'.$container->code] }}</span>
                                                    <span
                                                        class="bg-rates">+{{ number_format(@$rates['markup'.$container->code], 2, '.', '')   }}</span>
                                                    <i class="la la-caret-right arrow-down"></i> <b
                                                        class="monto-down">{{  @$rates['monto'.$container->code] }}</b>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
                                    ...
                                    <div class="row data-rates">
                                        ...
                                        <div class="col-lg-8 colorphacode">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="wth" {{ $equipmentHides[$container->code] }}>
                                                    <span class="bg-rates">
                                                        {{ isset($localfreight[$container->code]) ?   str_replace(["[","]","\""], ' ', $localfreight[$container->code]->pluck('monto')) : '0.00' }}</span><span
                                                        class="bg-rates">+
                                                        {{ isset($localfreight[$container->code]) ?   str_replace(["[","]","\""], ' ', $localfreight[$container->code]->pluck('markup')) : '0.00' }}</span>
                                                    <i class="la la-caret-right arrow-down"></i> <b class="monto-down">
                                                        {{ isset($localfreight[$container->code]) ?   str_replace(["[","]","\""], ' ', $localfreight[$container->code]->pluck('montoMarkup')) : '0.00' }}
                                                    </b>
                                                </div>
                                                @endforeach
                                            </div>
                                    ...
                                    @endforeach
                                    <div class="row bg-light">
                                        <div class="col-lg-3 col-lg-offset-"><span class="portalphacode">Subtotal
                                                Freight Charges</span></div>
                                        <div class="col-lg-8">
                                            <div class="d-flex justify-content-between">
                                                @foreach($containers as $container)
                                                <div class="wth" {{ $equipmentHides[$container->code] }}><span
                                                        class="portalphacode">{{ $arr->{'tot'.$container->code.'F'}  }}
                                                    </span></div>
                                                @endforeach
                                            </div>
                                        </div>
                                        <div class="col-lg-1"><span
                                                class="portalphacode">{{$rates['currency_rate']}}</span></div>
                                    </div>
                                </div>
                            </div>
                            <!-- Gastos Destino-->
                                    ...
                                    <div class="row data-rates">
                                        ...
                                        <div class="col-lg-8 colorphacode">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="wth" {{ $equipmentHides[$container->code] }}>
                                                    <span class="bg-rates">
                                                        {{ isset($localdestiny[$container->code]) ?   str_replace(["[","]","\""], ' ', $localdestiny[$container->code]->pluck('monto')) : '0.00' }}
                                                    </span><span class="bg-rates"> +
                                                        {{ isset($localdestiny[$container->code]) ?   str_replace(["[","]","\""], ' ', $localdestiny[$container->code]->pluck('markup')) : '0.00' }}
                                                    </span> <i class="la la-caret-right arrow-down"></i> <b
                                                        class="monto-down">{{ isset($localdestiny[$container->code]) ?   str_replace(["[","]","\""], ' ', $localdestiny[$container->code]->pluck('montoMarkup')) : '0.00' }}
                                                    </b>
                                                </div>
                                                @endforeach
                                            </div>
                                    ...
                                    <div class="row bg-light">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="d-flex justify-content-between">
                                                @foreach($containers as $container)
                                                <div class="wth" {{ $equipmentHides[$container->code] }}><span
                                                        class="portalphacode">{{ $arr->{'tot'.$container->code.'D'}  }}
                                                    </span></div>
                                                @endforeach
                                            </div>
                                        </div>
                            ...
                            <div class="row no-margin margin-card" id='inland{{$loop->iteration}}' hidden='true'>
                                <div class="col-lg-12">
                                    ...
                                    <div class="row bg-light">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="d-flex justify-content-between">
                                                <div class="wth" {{ $equipmentHides['20DV'] }}><span
                                                        class="portalphacode">20'</span></div>
                                                <div class="wth" {{ $equipmentHides['40DV'] }}><span
                                                        class="portalphacode">40'</span></div>
                                                <div class="wth" {{ $equipmentHides['40HC'] }}><span
                                                        class="portalphacode">40HC'</span></div>
                                                <div class="wth" {{ $equipmentHides['40NOR'] }}><span
                                                        class="portalphacode">40NOR'</span></div>
                                                <div class="wth" {{ $equipmentHides['45HC'] }}><span
                                                        class="portalphacode">45'</span></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-1"><span class="portalphacode">Currency</span></div>
                                    ...
                                    <div class="row data-rates">
                                        ...
                                        <div class="col-lg-6 colorphacode">
                                            <div class="d-flex justify-content-between">
                                                <div class="wth" {{ $equipmentHides['20DV'] }}>
                                                    {{ $equipmentHides['20DV'] }}
                                                    {{ @$inlandDestiny['inlandDetails']['20DV']['sub_in']  }} &nbsp;+<b
                                                        class="monto-down">{{ @$inlandDestiny['inlandDetails']['20DV']['markup']  }}</b>
                                                    <i class="la la-caret-right"></i> <span class="bg-rates"
                                                        id='valor-d20{{$loop->iteration}}-{{$arr->id}}'>
                                                        {{ number_format(@$inlandDestiny['inlandDetails']['20DV']['montoInlandT'], 2, '.', '') }}
                                                    </span>
                                                </div>

                                                <div class="wth" {{ $equipmentHides['40DV'] }}>
                                                    {{ $equipmentHides['40DV'] }}
                                                    {{ @$inlandDestiny['inlandDetails']['40DV']['sub_in']  }}
                                                    + &nbsp;<b class="monto-down">
                                                        {{ @$inlandDestiny['inlandDetails']['40DV']['markup']  }} </b><i
                                                        class="la la-caret-right"></i> <span class="bg-rates"
                                                        id='valor-d40{{$loop->iteration}}-{{$arr->id}}'>
                                                        {{ number_format(@$inlandDestiny['inlandDetails']['40DV']['montoInlandT'] , 2, '.', '')   }}
                                                    </span>
                                                </div>
                                                ...
                                                <div class="wth" {{ $equipmentHides['40HC'] }}>
                                                    ...
                                                    + &nbsp; <b class="monto-down">
                                                        {{ @$inlandDestiny['inlandDetails']['40HC']['markup']  }} </b><i
                                                        class="la la-caret-right"></i> <span class="bg-rates"
                                                        id='valor-d40h{{$loop->iteration}}-{{$arr->id}}'>
                                                        {{  number_format(@$inlandDestiny['inlandDetails']['40HC']['montoInlandT'], 2, '.', '')  }}
                                                    </span>
                                                </div>
                                        ...
                                        <div class="col-lg-1 no-padding d-flex align-items-center pos-btn">
                                            ...
                                            <label tabindex="0" role="button" data-toggle="m-tooltip"
                                                ...
                                                data-inland="{{$loop->iteration}}" data-rate="{{$arr->id}}"
                                            ...
                                            <input type="checkbox" id="inputID-select{{$loop->iteration}}-{{$arr->id}}"
                                                data-inland="{{$loop->iteration}}" data-rate='{{$arr->id}}'
                                                class="input-select inlands no-check " name="inlandD{{$arr->id}}[]"
                                                value="{{ json_encode($inlandDestiny) }} ">

                                            <label for="inputID-select{{$loop->iteration}}-{{$arr->id}}"
                                                data-inland="{{$loop->iteration}}" data-rate='{{$arr->id}}'
                                    ...
                                    <div class="row data-rates">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div class="wth" {{ $equipmentHides['20DV'] }}>
                                                    ...
                                                    <i class="la la-caret-right"></i> <b class="monto-down">
                                                        {{ @$inlandOrigin['inlandDetails']['20DV']['markup']  }} </b>
                                                    <span class="bg-rates"
                                                        id='valor-o20{{$loop->iteration}}-{{$arr->id}}'>
                                                        {{  number_format(@$inlandOrigin['inlandDetails']['20DV']['montoInlandT'], 2, '.', '') }}
                                                    </span>
                                                </div>
                                                ...
                                                <div class="wth" {{ $equipmentHides['40DV'] }}>
                                                    ...
                                                    <i class="la la-caret-right"></i> <b
                                                        class="monto-down">{{ @$inlandOrigin['inlandDetails']['40DV']['markup']  }}
                                                    </b> <span class="bg-rates"
                                                        id='valor-o40{{$loop->iteration}}-{{$arr->id}}'>
                                                        {{ number_format(@$inlandOrigin['inlandDetails']['40DV']['montoInlandT'], 2, '.', '')  }}
                                                    </span>
                                                </div>
                                                ...
                                                <div class="wth" {{ $equipmentHides['40HC'] }}>
                                                    ...
                                                    <i class="la la-caret-right"></i> <b class="monto-down">
                                                        {{ @$inlandOrigin['inlandDetails']['40HC']['markup']  }} </b>
                                                    <span class="bg-rates"
                                                        id='valor-o40h{{$loop->iteration}}-{{$arr->id}}'>
                                                        {{ number_format(@$inlandOrigin['inlandDetails']['40HC']['montoInlandT'], 2, '.', '')  }}
                                                    </span>
                                                </div>
                                        ...
                                        <div class="col-lg-1 no-padding d-flex align-items-center pos-btn">
                                            ...
                                            <input type="checkbox" id="inputIO-select{{$loop->iteration}}-{{$arr->id}}"
                                                data-inland="{{$loop->iteration}}" data-rate='{{$arr->id}}'
                                                class="input-select inlandsO no-check" name="inlandO{{$arr->id}}[]"
                                                value="{{ json_encode($inlandOrigin) }}">

                                            <label for="inputIO-select{{$loop->iteration}}-{{$arr->id}}"
                                                data-inland="{{$loop->iteration}}" data-rate='{{$arr->id}}'
                                    ...
                                    <div class="row bg-light">
                                        ...
                                        <div class="col-lg-4 col-lg-offset-"><span class="portalphacode">Subtotal
                                                Inlands Charges</span></div>
                                        <div class="col-lg-6">
                                            <div class="d-flex justify-content-between">
                                                <div class="wth" {{ $equipmentHides['20DV'] }}><span
                                                        class="portalphacode">
                                                        <div id='sub_inland_20{{ $arr->id }}'>0.00</div>
                                                    </span></div>
                                                <div class="wth" {{ $equipmentHides['40DV'] }}><span
                                                        class="portalphacode">
                                                        <div id='sub_inland_40{{ $arr->id }}'>0.00</div>
                                                    </span></div>
                                                <div class="wth" {{ $equipmentHides['40HC'] }}><span
                                                        class="portalphacode">
                                                        <div id='sub_inland_40h{{ $arr->id }}'>0.00</div>
                                                    </span></div>
                                                <div class="wth" {{ $equipmentHides['40NOR'] }}><span
                                                        class="portalphacode">
                                                        <div>N/A</div>
