                    ...
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 {{$hideO}}" id="origin_address_label">
                                ...
                                <span id='textA' class='hide'>{!! Form::text('origin_address',@$form['origin_address'],
                            ...
                            <div class="col-lg-2 {{$hideD}}" id="destination_address_label">
                                ...
                                <span
                                    id='selectD'>{{ Form::select('destinationA',[],null,['id'=>'destinationA','placeholder'=>'Select','class'=>'m-select2-general form-control']) }}</span>
                                <span id='textD' class='hide'>{!!
                            ...
                            <div class="col-lg-12 no-padding">
                                <div class="row  justify-content-between">
                                    <div class="col-lg-9 d-flex message  align-items-end align-self-end">
                                        ...
                                        <p class="warning-p"><span><i class="la la-info-circle"></i>The equipemts do not
                                                ...
                                                <div
                                                    ...
                                                    <div class="btn-detail__quotes btn-d">
                                                        <a id='display_l{{$loop->iteration}}'
                                                            ...
                                                            class="l detailed-cost btn-nowrap" title="Details">
                            ...
                            <div class="row no-margin margin-card" id='inland{{$loop->iteration}}' hidden='true'>
                                <div class="col-lg-12">
                                    ...
                                    <div class="row bg-light">
                                        ...
                                        <div class="col-lg-1"><span class="portalphacode">Currency</span></div>
                                        <div class="col-lg-1"><span class="portalphacode">Select</span></div>
                                    </div><br>
                                    ...
                                    <div class="row bg-light">
                                        @foreach($containers as $container)
                                        <input type='hidden' id='sub_inland_{{ $container->code }}_o{{ $arr->id }}'
                                            value="0">
                                        <input type='hidden' id='sub_inland_{{ $container->code }}_d{{ $arr->id }}'
                                            value="0">
                                        @endforeach
