                    ...
                    <div class="col-lg-12 no-padding">
                        <div class="row  justify-content-between">
                            <div class="col-lg-10 d-flex message  align-items-end align-self-end">
                                @if(isset($arreglo))
                                @if($arreglo->isEmpty())
                                <p class="warning-p"><span><i class="la la-info-circle"></i>No freight rates were found for
                                        this trade route.</span> You can create a quote manually.</p>
                                @endif
                                @endif
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <center>
                            ...
                            <button type="button"
                                class="btn m-btn--pill  btn-search__quotes btn-info quote_man create-manual">Create
                                Manual</span></button>
                        </center>
                    </div>
                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-8">
                                                                <div class="row col-lg-12">
                                                                    ...
                                                                    <div class="col-lg-4"><span class="portcss">Destination</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="card-p__quotes input-select{{$loop->iteration}}"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 b-top no-padding padding-min">
                                                                <div class="row justify-content-between">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="btn-detail__quotes btn-remarks">
                                                                            <a id='display_r{{$loop->iteration}}'
                                                                                onclick="display_r({{$loop->iteration}})" class="l"
                                                                                title="Cancel">
                                                                    ...
                                                                    <div class="col-lg-1 d-flex align-items-center">
                                                                        <span class="portalphacode" style="margin-right:15px;"> Via:
                                                                        </span> {{  $arr->via }}
                                                                    </div>
                                                                    @endif
                                                ...
                                                <div class="row no-margin margin-card" id='origin{{$loop->iteration}}'
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="row data-rates">
                                                            <div class="col-lg-2 colorphacode">{{ $localorigin['surcharge_name']}}
                                                            </div>
                                                            <div class="col-lg-2 colorphacode">{{ $localorigin['calculation_name']}}
                                                            </div>
                                                            ...
                                                            <div class="col-lg-1"><span
                                                                    class="colorphacode">{{ $localorigin['montoMarkup']}}</span>
                                                            </div>
                                                ...
                                                <div class="row no-margin margin-card" id='freight{{$loop->iteration}}'
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="row data-rates">
                                                            <div class="col-lg-2 colorphacode">{{ $localfreight['surcharge_name']}}
                                                            </div>
                                                            ...
                                                            <div class="col-lg-1"><span
                                                                    class="colorphacode">{{ $localfreight['montoMarkup']}}</span>
                                                            </div>
                                                        </div>
                                                        @endforeach
                                                        @endforeach
                                                ...
                                                <div class="row no-margin margin-card" id='destiny{{$loop->iteration}}'
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="row data-rates">
                                                            <div class="col-lg-2 colorphacode">{{ $localdestiny['surcharge_name']}}
                                                            </div>
                                                            <div class="col-lg-2 colorphacode">
                                                            ...
                                                            <div class="col-lg-1"><span
                                                                    class="colorphacode">{{ $localdestiny['montoMarkup']}}</span>
                                                            </div>
