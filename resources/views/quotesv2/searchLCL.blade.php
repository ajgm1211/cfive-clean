            ...
            <div class="m-portlet__body">
                ...
                <div class="form-group m-form__group row" id="lcl_air_load" style="display: none; margin-top:25px;">
                    ...
                    <div class="col-lg-10">
                        <ul class="nav nav-tabs" role="tablist" style="text-transform: uppercase; letter-spacing: 1px;">
                            <li class="nav-item">
                                <a href="#tab_1_1" class="nav-link {{ @$simple }}" data-toggle="tab"
                                    style=" font-weight: bold;" onclick="change_tab(1)"> Calculate by total shipment
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#tab_1_2" class="nav-link {{ @$paquete }}" data-toggle="tab"
                                    style=" font-weight: bold;" onclick="change_tab(2)"> Calculate by packaging </a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <!-- Simple -->
                            <div class="tab-pane fade  {{ @$simple }}" id="tab_1_1">
                                <div class="row">
                                        ...
                                        <div class="m-bootstrap-touchspin-brand">
                                            <div class="input-group">
                                                <input type="number" id="total_quantity"
                                                    value="{{ @$form['total_quantity'] }}" name="total_quantity" min="0"
                                                    step="0.0001" class="total_quantity form-control" placeholder=""
                                                    aria-label="...">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="m-bootstrap-touchspin-brand">
                                            <div class="input-group">
                                                <input type="number" id="total_weight"
                                                    value="{{ @$form['total_weight'] }}" name="total_weight" min="0"
                                                    step="0.0001" class="total_weight form-control" placeholder=""
                                                    aria-label="...">
                                                <div class="input-group-btn">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="m-bootstrap-touchspin-brand">
                                            <div class="input-group">
                                                <input type="number" id="total_volume"
                                                    value="{{ @$form['total_volume'] }}" name="total_volume" min="0"
                                                    step="0.0001" class="total_volume form-control" placeholder=""
                                                    aria-label="...">
                                                <div class="input-group-btn">
                                                    <button type="button" class="btn btn-default dropdown-toggle"
                                                        data-toggle="dropdown" aria-haspopup="true"
                                                        aria-expanded="false" style="height:2.5em">M<sup>3</sup> <span
                                                            class="caret"></span></button>
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                    </ul>
                                                </div><!-- /btn-group -->
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <span id="chargeable_weight_total"> {{ @$form['chargeable_weight'] }}
                                            m<sup>3</sup></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade {{ $paquete }} " id="tab_1_2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2" style="padding-right:0px;">
                                            <select name="type_load_cargo[]"
                                                ...
                                                style="height: 2.7em">
                                                <option {{ ($form['type_load_cargo'][$key] == "" ) ? 'selected' : ""}}
                                                    value="">Choose an option</option>
                                                <option {{ ($form['type_load_cargo'][$key] == "1" ) ? 'selected' : ""}}
                                                    value="1">Pallets</option>
                                                <option {{ ($form['type_load_cargo'][$key] == "2" ) ? 'selected' : ""}}
                                                    value="2">Packages</option>
                                            </select>

                                        </div>
                                        <div class="col-md-2" style="padding-right:0px;">
                                            <input id="quantity" min="1" value="{{ @$form['quantity'][$key] }}"
                                                name="quantity[]" class="quantity quantity_2 form-control size-12px"
                                        ...
                                        <div class="col-md-2">
                                            <div class="input-group">
                                                <input type="number" value="{{ @$form['weight'][$key] }}"
                                                    name="weight[]" min="0" step="0.0001"
                                                    class="weight weight_2 form-control size-12px" placeholder="Weight"
                                                    aria-label="...">
                                            </div><!-- /input-group -->
                                        </div>
                                        <div class="col-md-1">
                                            <input type="hidden" class="volume_input"
                                                value="{{ @$form['volume'][$key] }}" name="volume[]" />

                                            <input type="hidden" value="{{ @$form['quantity'][$key]  }}"
                                                class="quantity_input" id="quantity_input" name="total_quantity_pkg" />
                                            <input type="hidden"
                                                value="{{ @$form['weight'][$key] * @$form['quantity'][$key] }}"
                                                class="weight_input" id="weight_input" name="total_weight_pkg" />
                                        </div>
                                        <div class="col-md-4">

                                            <p class=""><span class="quantity">{{ @$form['quantity'][$key] }} un</span>
                                                <span class="volume"> {{ @$form['volume'][$key] }} m<sup>3</sup></span>
                                                <span class="weight">
                                                    {{ @$form['weight'][$key] * @$form['quantity'][$key] }}kg</span></p>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="template hide" id="lcl_air_load_template">
                                    <div class="row" style="padding-top: 15px;">
                                        ...
                                        <div class="col-md-5">
                                            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                                <div class="btn-group" role="group">
                                                    <input class="height form-control size-12px" min="0" name="height[]"
                                                        id="al" type="number" placeholder="H" />
                                                </div>
                                                <div class="btn-group" role="group">
                                                    <input class="width form-control size-12px" min="0" name="width[]"
                                                        id="an" type="number" placeholder="W" />
                                                </div>
                                                <div class="btn-group" role="group">
                                                    <input class="large form-control size-12px" min="0" name="large[]"
                                                        id="la" type="number" placeholder="L" />
                                                </div>
                                                <div class="btn-group" role="group">
                                                    <div class="input-group-btn">
                                                        <div class="btn-group">
                                        ...
                                        <div class="col-md-4">
                                            <br>
                                            <p class=""><span class="quantity"></span> <span class="volume"></span>
                                                <span class="weight"></span></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <span id="total_volume_pkg">{{ @$form['total_volume_pkg'] }}
                                            m<sup>3</sup></span>
                                        <span id="total_weight_pkg">{{ @$form['total_weight_pkg'] }} kg</span>
                                        <input type="hidden" id="total_quantity_pkg_input"
                                            value="{{ @$form['total_quantity_pkg'] }}" name="total_quantity_pkg" />
                                        <input type="hidden" id="total_volume_pkg_input"
                                            value="{{ @$form['total_volume_pkg'] }}" name="total_volume_pkg" />
                                        <input type="hidden" id="total_weight_pkg_input"
                                            value="{{ @$form['total_weight_pkg'] }}" name="total_weight_pkg" />
                                    </div>
                                    <div class="col-md-8">
                                        <b>Chargeable weight:</b>
                                        <span id="chargeable_weight_pkg"> {{ @$form['chargeable_weight'] }}
                                            m<sup>3</sup></span>
                                        <input type="hidden" id="chargeable_weight_pkg_input"
                                            value="{{ @$form['chargeable_weight'] }}" name="chargeable_weight" />
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 no-padding">
                        <div class="row  justify-content-between">
                            <div class="col-lg-10 d-flex message  align-items-end align-self-end">
                                @if(isset($arreglo))
                                @if($arreglo->isEmpty())
                                <p class="warning-p"><span><i class="la la-info-circle"></i>No freight rates were found
                                        for this trade route.</span> You can create a quote manually.</p>
                                @endif
                                @endif
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <button type="button"
                            class="btn m-btn--pill btn-search__quotes  btn-info quote_search">Search</button>
                        <button type="button"
                            class="btn m-btn--pill btn-search__quotes btn-info quote_man create-manual"
                            style="background-color: white;">Create Manual</span></button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="container-fluid">
        <div class="row padding search">
            <div class="container-fluid">
                <div class="col-lg-12">
                    <div class=""><span class="col-txt">Results</span></div>
                </div>
            </div>
        </div>
        <br>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8">
                                                        <div class="row col-lg-12">
                                                            <div class="col-lg-8" style="padding-left: 2px;"><span
                                    ...
                                    <div class="card-p__quotes input-select{{$loop->iteration}}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3" style="padding-right: 35px;">
                                                        <div class="table-r__quotes">
                                                            <div class="wth "><span
                                                                    class="darkblue validate">{{$arr->totalQuote  }}
                                                    ...
                                                    <div class="col-lg-1 no-padding d-flex align-items-center pos-btn">
                                                        <input type="checkbox" id="input-select{{$loop->iteration}}"
                                                            class="input-select no-check btnrate"
                                                    ...
                                                    <div class="col-lg-12 b-top no-padding padding-min">
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-lg-1 d-flex align-items-center">
                                                                <span class="portalphacode"
                                                                    style="margin-right:15px; white-space:nowrap"> TT:
                                                                </span> {{ $arr->transit_time   }}
                                                            </div>
                                                            <div class="col-lg-1 d-flex align-items-center">
                                                            ...
                                                            <div class="col-lg-3 no-padding d-flex justify-content-end">
                                                                ...
                                                                <div class="downexcel" style="margin-right: 10px;">
                                                                    <a id='excel_l{{$loop->iteration}}' href="#"
                                                                        onclick="downlodRequest({{ $arr->excelRequest }},{{ $arr->excelRequestLCL }})"
                                        ...
                                        <div class="row no-margin margin-card" id='origin{{$loop->iteration}}'
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row bg-light">
                                                    <div class="col-lg-2"><span class="portalphacode">Charge</span>
                                                    </div>
                                                    <div class="col-lg-2"><span class="portalphacode">Detail</span>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="wth"><span class="portalphacode">Units</span>
                                                            </div>
                                                            ...
                                                            <div class="wth"><span class="portalphacode">Currency</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row data-rates">
                                                    <div class="col-lg-2 colorphacode">
                                                        {{ $localorigin['surcharge_name']}}</div>
                                                    <div class="col-lg-2 colorphacode">
                                                        {{ $localorigin['calculation_name']}}</div>
                                                    <div class="col-lg-7 colorphacode">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="wth">
                                                                <span class="bg-rates"> {{ $localorigin['cantidad']}}
                                                                </span>
                                                            </div>
                                                            <div class="wth">
                                                                <span class="bg-rates">
                                                            ...
                                                            <div class="wth">
                                                                <span class="bg-rates">{{ $localorigin['markup']}}
                                                                </span>
                                                            </div>
                                                            <div class="wth">
                                                    ...
                                                    <div class="col-lg-1"><span
                                                            class="colorphacode">{{ $localorigin['montoMarkup']}}
                                                            {{ $arr->quoteCurrency }}</span></div>
                                                ...
                                                <div class="row bg-light">
                                                    <div class="col-lg-4 col-lg-offset-"><span
                                                            class="portalphacode">Subtotal Origin Charges: </span>
                                                        {{ $arr->totalOrigin  }} {{ $arr->quoteCurrency }}</div>
                                                    <div class="col-lg-7">
                                                        <div class="d-flex justify-content-between">
                                        ...
                                        <div class="row no-margin margin-card" id='freight{{$loop->iteration}}'
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row data-rates">
                                                    <div class="col-lg-2 colorphacode">
                                                        {{ $localfreight['surcharge_name']}}</div>
                                                    <div class="col-lg-2 colorphacode">
                                                        {{ $localfreight['calculation_name']}}</div>
                                                    <div class="col-lg-7 colorphacode">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="wth">
                                                                <span class="bg-rates"> {{ $localfreight['cantidad']}}
                                                                </span>
                                                            </div>
                                                            ...
                                                            <div class="wth">
                                                                <span class="bg-rates">{{ $localfreight['markup']}}
                                                                </span>
                                                            </div>
                                                            <div class="wth">
                                        ...
                                        <div class="row no-margin margin-card" id='destiny{{$loop->iteration}}'
                                            hidden='true'>
                                            <div class="col-lg-12">
                                                <div class="row">
                                                ...
                                                <div class="row data-rates">
                                                    <div class="col-lg-2 colorphacode">
                                                        {{ $localdestiny['surcharge_name']}}</div>
                                                    <div class="col-lg-2 colorphacode">
                                                        {{ $localdestiny['calculation_name']}}</div>
                                                    <div class="col-lg-7 colorphacode">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="wth">
                                                                <span class="bg-rates"> {{ $localdestiny['cantidad']}}
                                                                </span>
                                                            </div>
                                                            <div class="wth">
                                                                <span class="bg-rates">
                                                            ...
                                                            <div class="wth">
                                                                <span class="bg-rates">{{ $localdestiny['markup']}}
                                                                </span>
                                                            </div>
                                                            <div class="wth">
                                                    ...
                                                    <div class="col-lg-1"><span
                                                            class="colorphacode">{{ $localdestiny['montoMarkup']}}
                                                            {{ $arr->quoteCurrency }}</span></div>
                                                ...
                                                <div class="row bg-light">
                                                    <div class="col-lg-4 col-lg-offset-"><span
                                                            class="portalphacode">Subtotal Destination Charges: </span>
                                                        {{ $arr->totalDestiny  }} {{ $arr->quoteCurrency }}</div>
                                                    <div class="col-lg-7">
                                                        <div class="d-flex justify-content-between">
                                                            <div class="wth"><span class="portalphacode"> </span></div>
                                        ...
                                        <div class="row no-margin margin-card" id='remark{{$loop->iteration}}'
                                            hidden='true'>
                                            <div class="col-lg-12">
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6"><span class="monto-down">{!! $arr->remarks !!}
                                                        </span></div>
