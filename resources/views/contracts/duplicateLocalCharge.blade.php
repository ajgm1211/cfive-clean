...
<div class="m-portlet">
  ...
  {{ Form::model($localcharges, array('route' => array('contracts.storeLocalCharge', $localcharges->contract_id), 'id' => 'frmSurcharges')) }}
  <div class="m-portlet__body">
    ...
    <div class="form-group m-form__group row">
      ...
      <div class="col-lg-4">
        ...
        <div class="m-input-icon m-input-icon--right">
          {{ Form::select('calculationtype_id[]', $calculationT,$localcharges->calculationtype_id,['id' => 'calculationtype','class'=>'m-select2-general form-control ','style' => 'width:80%;','multiple' => 'multiple'  ]) }}
          <span class="m-input-icon__icon m-input-icon__icon--right">
            <span>
