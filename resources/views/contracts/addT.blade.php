    ...
    <div class="m-portlet m-portlet--full-height">
                            ...
                            <table class="table m-table m-table--head-separator-primary" id="sample_editable_1" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr   id='tr_clone'  >
                                        ...
                                        <td  width = '7%'>{!! Form::number('twuenty[]', 0, ['placeholder' => 'Enter 20','class' => 'form-control m-input','required' => 'required','style' => 'width:100%;' ,'min' => '0']) !!} </td>
                                        <td  width = '7%'>{!! Form::number('forty[]', 0, ['placeholder' => 'Enter 40','class' => 'form-control m-input','required' => 'required','style' => 'width:100%;' ,'min' => '0' ]) !!} </td>
                                        <td  width = '7%'> {!! Form::number('fortyhc[]', 0, ['placeholder' => 'Enter 40HC','class' => 'form-control m-input','required' => 'required','style' => 'width:100%;' ,'min' => '0' ]) !!}</td>
                                        <td  width = '7%'> {!! Form::number('fortynor[]', 0, ['placeholder' => 'Enter 40NOR','class' => 'form-control m-input','required' => 'required','style' => 'width:100%;' ,'min' => '0' ]) !!}</td>
                                        <td  width = '7%'> {!! Form::number('fortyfive[]', 0, ['placeholder' => 'Enter 45','class' => 'form-control m-input','required' => 'required','style' => 'width:100%;' ,'min' => '0' ]) !!}</td>
                                ...
                                <table cellpadding='4' cellspacing='4' class="col-md-12  m-table m-table--head-separator-primary" id="sample_editable_2" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width='10%'> {!! Form::number('ammount[]', null, ['placeholder' => 'Please enter the amount','class' => 'form-control m-input','min'=> '0','step'=>'0.01','style' => 'width:100%;']) !!}</td>
        ...
        <table>
            <tr id='tclone2' hidden="true" >
                ...
                <td> {!! Form::number('ammount[]', null, ['placeholder' => 'Please enter the ammount','class' => 'form-control m-input','style' => 'width:100%;','min' => '0','step'=>'0.01']) !!}</td>
