        ...
        data() {
            return {
                ...
                fields: [
                    ...
                    { key: 'carriers', label: 'Carrier', formatter: (value)=> { return this.badgecarriers(value) }, filterIsOpen:false }, 
                    ...
                    { key: 'gp_container', label: 'Equipment', formatter: (value)=> { return value.name }, filterIsOpen:false }, 
                    { key: 'direction', label: 'Direction', formatter: (value)=> { return value.name }, filterIsOpen:false },
