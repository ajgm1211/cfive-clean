        ...
        methods: {
            ...
            prepareData(){
                ...
                return {
                    ...
                    'validity': moment(this.vDates.startDate).format('YYYY/MM/DD'),
                    'expire': moment(this.vDates.endDate).format('YYYY/MM/DD'),
                    'status': 'publish',
                    'remarks': '',
            ...
            updateDates(val) {
                ...
                //this.data[sdName] = moment(event.startDate).format('YYYY-MM-DD');
                //this.data[edName] = moment(event.endDate).format('YYYY-MM-DD');
            }
