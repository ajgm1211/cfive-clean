<template>
    <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="float-right">
                                <button class="btn btn-link" v-b-modal.addItem>+ {{btnadd}}</button>
        ...
        <!-- Create Form -->
        <b-modal id="addItem" size="md" hide-header-close title="Add Contract" hide-footer>
            <FormView 
                :data="fdata" 
                :fields="form_fields"
                :vdatalists="datalists"
                btnTxt="Add Contract"
                @exit="closeModal('addItem')"
                @success="success"
