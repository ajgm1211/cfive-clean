	...
	<div class="container-fluid">
		...
		<div class="row mt-5">
			<div class="col-12 mb-2" style="padding: 0px 50px">
				<a href="/api/contractslcl/" class="p-light quote-link">
				...
				<b-card no-body class="card-tabs">
					<b-tabs card>
						...
						<b-tab title="Ocean Freight" active @click="changeView('freight')">
							...
							:equipment="equipment" 
							:datalists="datalists"
							:actions="actions.oceanfreightslcl"
...
<script>
	...
	export default {
		...
		data() {
			return {
				...
				//HELP DROPDOWN
      			helpOptions: [
					{
						title: "How to import an LCL contract",
						link: "https://support.cargofive.com/how-to-import-an-lcl-contract/"
					},
				]
			}
		},
		created() {
			...
			actions.contracts_lcl.retrieve(id)
			.then( ( response ) => {
