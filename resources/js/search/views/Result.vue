                                ...
                                <b-table-simple hover small class="sc-table">
                                    ...
                                    <b-tbody>
                                        ...
                                        <b-tr>
                                            ...
                                            <b-td></b-td>
                                            <b-td></b-td>
                                            <b-td><b style="font-size: 14px;">Total {{ chargeType }}</b></b-td>
                                            <b-td 
                                                v-for="(container,contKey) in request.containers"
                                                :key="contKey"
                                            
                                            ><b style="font-size: 14px;">{{ chargeType == 'Freight' ? rate.currency.alphacode : rate.client_currency.alphacode }} {{ rate.charge_totals_by_type[chargeType]['C'+container.code].toFixed(2) }}</b></b-td>
                                        </b-tr>
                                    </b-tbody>
        ...
        <div id="sticky-header-results" v-bind:class="{ activeSticky: isActive }">
            <div class="container-fluid">
                <div class="row result-header">
                    <div class="col-12 col-sm-3 d-flex justify-content-center align-items-center"><b>Carrier</b></div>
