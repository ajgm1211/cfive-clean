<template>
  <div class="container-cards">
      ...
      <div class="result-search">
        ...
        >
          <div>
            ...
            >
            <a
              v-else-if="result.companyCode == 'sealand' || result.companyCode == 'seau'"
    ...
    <div
      class="mb-4"
      v-for="(oneResult, oneResultKey) in orderedOneRates"
      :key="oneResultKey + 'one'"
    >
      <div class="result-search">
        <div class="banda-top one"><span>ONE QUOTE</span></div>
        ...
        <div class="row" style="min-height: 199px !important">
          ...
          <div class="row col-12 col-lg-8 margin-res">
            ...
            >
              ...
              >
                ...
                <div class="origin mr-4">
                  <span>origin</span>
                  <p class="mb-0">
                    {{ oneResult.departureName }}
                  </p>
                  <p v-if="oneResult.departureDateGmt">
                    {{ oneResult.departureDateGmt.substring(0, 10) }}
                  </p>
                </div>
                <!-- FIN ORGIEN -->
                ...
                >
                  ...
                  <div class="direction-desc mt-2">
                    <p class="mb-1">
                      <b>Transit Time: </b>
                      {{ oneResult.transitTime + " days" }}
                    </p>
                    <p v-if="oneResult.vehiculeName">
                      <b>Vessel: </b> {{ oneResult.vehiculeName }}
                    </p>
                  </div>
                </div>
                <!-- FIN LINEA DE RUTA -->
                ...
                <div class="destination ml-4">
                  <span>destination</span>
                  <p class="mb-0">
                    {{ oneResult.arrivalName }}
                  </p>
                  <p v-if="oneResult.arrivalDateGmt">
                    {{ oneResult.arrivalDateGmt.substring(0, 10) }}
                  </p>
                </div>
                <!-- FIN DESTINO -->
              </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="via">
                    <ul class="pl-0" style="list-style: none">
                      ...
                      <li>
                        <p><b>Vessel: </b>{{ oneResult.vehiculeName }}</p>
                      </li>
                    </ul>
                  </div>
                  <!-- FIN LINEA DE RUTA -->
              ...
              <div class="col-12 col-lg-6">
                ...
                <div class="row card-amount card-amount__res">
                  <div
                    class="col-2 pl-0 pr-0 prices-card-res"
                    :class="countContainersClass()"
                    v-for="(oneGlobalTotal, oneTotalKey) in oneResult
                      .pricingDetails.totalRatePerContainer"
                    :key="oneTotalKey"
                  >
                    <p>
            ...
            <div class="col-12 mt-3 mb-3 result-action">
              <div class="d-flex align-items-center">
                <span style="color: #006bfa; text-transform: capitalize"
                  ><b-icon icon="check-circle-fill"></b-icon> ONE QUOTE</span
                >
                <p
                  class="ml-4 mb-0"
                  v-if="oneResult.validityFrom && oneResult.validityTo"
                >
                  <b style="font-size:11px;">VALIDITY:</b>
                  {{
                    oneResult.validityFrom.substring(0, 10) +
                      " / " +
                      oneResult.validityTo.substring(0, 10)
                  }}
                </p>
              </div>
              ...
              <div class="d-flex justify-content-end align-items-center">
                <b-button
                  ...
                  v-b-toggle="
                    'remarks_' +
                      String(oneResult.contractReference) +
                      '_' +
                      String(oneResult.accordion_id)
                  "
                  ><b>remarks</b><b-icon icon="caret-down-fill"></b-icon
                ></b-button>
                <b-button
                  ...
                  v-b-toggle="
                    'schedules_' +
                      ...
                      String(oneResult.accordion_id)
                  "
                  v-if="oneResult.routingDetails.length"
                  ><b>schedules</b><b-icon icon="caret-down-fill"></b-icon
                ></b-button>
                <b-button
                  class="rs-btn"
          ...
          >
            <b-form-checkbox
              v-model="oneResult.addToQuote"
              class="btn-add-quote"
              name="check-button"
              button
              @change="addResultToQuote(oneResult)"
            >
              <b>add to quote</b>
            </b-form-checkbox>
          </div>
        ...
        <!-- INFORMACION DESPLEGADA -->
        <div
          :id="'my-accordion-' + oneResult.accordion_id"
          class="row mr-0 ml-0 accordion"
          role="tablist"
        >
          ...
          <b-collapse
            :id="
              'remarks_' +
                ...
                String(oneResult.accordion_id)"
            class="pt-5 pb-5 pl-5 pr-5 col-12"
            :accordion="'my-accordion-' + oneResult.accordion_id"
            role="tabpanel"
            v-model="oneResult.remarksCollapse"
          >
            <h5><b>Remarks</b></h5>
          ...
          <b-collapse
            ...
            :accordion="'my-accordion-' + oneResult.accordion_id"
            role="tabpanel"
            v-model="oneResult.detailCollapse"
          >
            <div
              v-for="(oneSurchargeType, oneSurchargeKey) in oneResult
                .pricingDetails.surcharges"
              :key="oneSurchargeKey"
            >
              <h5 v-show="(searchData.originCharges && oneSurchargeKey=='originSurcharges') || (searchData.destinationCharges && oneSurchargeKey=='destinationSurcharges') || oneSurchargeKey=='freightSurcharges'">
                <b>{{
                  oneSurchargeKey
                    .substring(0, oneSurchargeKey.length - 10)
                    .charAt(0)
                    .toUpperCase() +
                    oneSurchargeKey
                      .substring(0, oneSurchargeKey.length - 10)
              ...
              <b-table-simple 
                hover small responsive class="sc-table"
                v-show="(searchData.originCharges && oneSurchargeKey=='originSurcharges') || (searchData.destinationCharges && oneSurchargeKey=='destinationSurcharges') || oneSurchargeKey=='freightSurcharges'">
                <b-thead>
                  <b-tr>
                    <b-th style="width: 300px">Charge</b-th>
                    <b-th style="width: 325px">Detail</b-th>
                ...
                <b-tbody>
                  <b-tr
                    v-for="(oneSurchargeName,
                    oneNameKey) in oneSurchargeType"
                    :key="oneNameKey"
                  >
                    <b-td
                      ><b>{{
                        oneSurchargeName.chargeName != null
                          ? oneSurchargeName.chargeCode +
                            " - " +
                            oneSurchargeName.chargeName
                          : oneSurchargeName.chargeCode
                      }}</b></b-td
                    >
                    <b-td>{{ oneSurchargeName.calculationType }}</b-td>
                    <!-- <b-td></b-td>
                          <b-td></b-td> -->
                    <b-td
                      v-for="(oneSurchargeContainer,
                  ...
                  <b-tr>
                    ...
                    >
                    <b-td
                      v-for="(oneTypeTotal, oneTypeTotalKey) in oneResult
                        .pricingDetails.totalRatePerType[
                        'totalRate' +
                          oneSurchargeKey
                            .substring(0, oneSurchargeKey.length - 10)
          ...
          <b-collapse
            ...
            :accordion="'my-accordion-' + oneResult.accordion_id"
            role="tabpanel"
            v-model="oneResult.scheduleCollapse"
          >
            <h5 class="mb-5 title-schedule"><b>Schedule Information</b></h5>
            ...
            <b-tabs
              ...
              vertical
              class="d-none d-lg-flex"
              v-model="oneResult.activeTab"
            >
              <b-tab
                v-for="(route, routeKey) in oneResult.routingDetails"
                :key="routeKey"
              >
                <!-- INFORMACION PRINCIPAL -->
                <template #title>
                  ...
                  >
                    <div class="row" style="width: 100%">
                      ...
                      <div class="col-xl-6 schedule-info">
                        ...
                        <ul>
                          <li
                            v-for="(oneDeadline, oneDeadlineKey) in route
                              .details[0].deadlines"
                            :key="oneDeadlineKey"
                          >
                            <h5 class="sub-title-schedule">
                              <b>{{ oneDeadline.deadlineKey }}:</b>
                            </h5>
                            <p class="text-schedule">
                              {{
                                oneDeadline.deadline.substring(0, 10) +
                                  " " +
                                  oneDeadline.deadline.substring(
                                    11,
                                    oneDeadline.deadline.length - 4
                                  )
                              }}
                            </p>
                          </li>
                        ...
                        <div class="row" style="width: 100%">
                          ...
                          <div class="col-sm-6 schedule-info">
                            ...
                            <ul>
                              <li
                                v-for="(oneDeadline,
                                oneDeadlineKey) in route.details[0].deadlines"
                                :key="oneDeadlineKey"
                              >
                                <h5 class="sub-title-schedule">
                                  <b>{{ oneDeadline.deadlineKey }}:</b>
    ...
    <div
      class="mb-4"
      v-for="(coscoResult, coscoResultKey) in orderedCoscoRates"
      :key="coscoResultKey + 'cosco'"
    >
      <div class="result-search">
        <div class="banda-top cosco"><span>SYNCONHUB</span></div>
        ...
        <div class="row" style="min-height: 199px !important">
          ...
          <div class="row col-12 col-lg-8 margin-res">
            ...
            <div class="col-12">
              <h6 class="mt-4 mb-5 contract-title">
                <!-- {{ coscoResult.quoteLine }} -->
                <!-- {{ coscoResult.contractReference }} -->
              </h6>
            </div>
            <!-- FIN CONTRACT NAME -->
            ...
            >
              ...
              >
                ...
                <div class="origin mr-4">
                  <span>origin</span>
                  <p class="mb-0">
                    {{ coscoResult.departureName }}
                  </p>
                  <p v-if="coscoResult.departureDateGmt">
                    {{ coscoResult.departureDateGmt.substring(0, 10) }}
                  </p>
                </div>
                <!-- FIN ORGIEN -->
                ...
                >
                  ...
                  <div class="direction-desc mt-2">
                    <p class="mb-1">
                      <b>Transit Time: </b>
                      {{ coscoResult.transitTime + " days" }}
                    </p>
                    <p v-if="coscoResult.vehiculeName">
                      <b>Vessel: </b> {{ coscoResult.vehiculeName }}
                    </p>
                  </div>
                </div>
                <!-- FIN LINEA DE RUTA -->
                ...
                <div class="destination ml-4">
                  <span>destination</span>
                  <p class="mb-0">
                    {{ coscoResult.arrivalName }}
                  </p>
                  <p v-if="coscoResult.arrivalDateGmt">
                    {{ coscoResult.arrivalDateGmt.substring(0, 10) }}
                  </p>
                </div>
                <!-- FIN DESTINO -->
              </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="via">
                    <ul class="pl-0" style="list-style: none">
                      ...
                      <li>
                        <p><b>Vessel: </b>{{ coscoResult.vehiculeName }}</p>
                      </li>
                    </ul>
                  </div>
                  <!-- FIN LINEA DE RUTA -->
              ...
              <div class="col-12 col-lg-6">
                ...
                <div class="row card-amount card-amount__res">
                  <div
                    class="col-2 pl-0 pr-0 prices-card-res"
                    :class="countContainersClass()"
                    v-for="(coscoGlobalTotal, coscoTotalKey) in coscoResult
                      .pricingDetails.totalRatePerContainer"
                    :key="coscoTotalKey"
                  >
                    <p>
            ...
            <div class="col-12 mt-3 mb-3 result-action">
              <div class="d-flex align-items-center">
                <span style="color: #006bfa; text-transform: capitalize"
                  ><b-icon icon="check-circle-fill"></b-icon> SYNCONHUB</span
                >
                <p
                  class="ml-4 mb-0"
                  v-if="coscoResult.validityFrom && coscoResult.validityTo"
                >
                  <b style="font-size:11px;">VALIDITY:</b>
                  {{
                    coscoResult.validityFrom.substring(0, 10) +
                      " / " +
                      coscoResult.validityTo.substring(0, 10)
                  }}
                </p>
              </div>
              ...
              <div class="d-flex justify-content-end align-items-center">
                <b-button
                  ...
                  v-b-toggle="
                    'remarks_' +
                      String(coscoResult.contractReference) +
                      '_' +
                      String(coscoResult.accordion_id)
                  "
                  ><b>remarks</b><b-icon icon="caret-down-fill"></b-icon
                ></b-button>
                <b-button
                  ...
                  v-b-toggle="
                    'schedules_' +
                      ...
                      String(coscoResult.accordion_id)
                  "
                  v-if="coscoResult.routingDetails.length"
                  ><b>schedules</b><b-icon icon="caret-down-fill"></b-icon
                ></b-button>
                <b-button
                  class="rs-btn"
          ...
          >
            <b-form-checkbox
              v-model="coscoResult.addToQuote"
              class="btn-add-quote"
              name="check-button"
              button
              @change="addResultToQuote(coscoResult)"
            >
              <b>add to quote</b>
            </b-form-checkbox>
          </div>
        ...
        <!-- INFORMACION DESPLEGADA -->
        <div
          :id="'my-accordion-' + coscoResult.accordion_id"
          class="row mr-0 ml-0 accordion"
          role="tablist"
        >
          ...
          <b-collapse
            :id="
              'remarks_' +
                ...
                String(coscoResult.accordion_id)"
            class="pt-5 pb-5 pl-5 pr-5 col-12"
            :accordion="'my-accordion-' + coscoResult.accordion_id"
            role="tabpanel"
            v-model="coscoResult.remarksCollapse"
          >
            <h5><b>Remarks</b></h5>
          ...
          <b-collapse
            ...
            :accordion="'my-accordion-' + coscoResult.accordion_id"
            role="tabpanel"
            v-model="coscoResult.detailCollapse"
          >
            <div
              v-for="(coscoSurchargeType, coscoSurchargeKey) in coscoResult
                .pricingDetails.surcharges"
              :key="coscoSurchargeKey"
            >
              <h5 v-show="(searchData.originCharges && coscoSurchargeKey=='originSurcharges') || (searchData.destinationCharges && coscoSurchargeKey=='destinationSurcharges') || coscoSurchargeKey=='freightSurcharges'">
                <b>{{
                  coscoSurchargeKey
                    .substring(0, coscoSurchargeKey.length - 10)
                    .charAt(0)
                    .toUpperCase() +
                    coscoSurchargeKey
                      .substring(0, coscoSurchargeKey.length - 10)
              ...
              <b-table-simple 
                hover small responsive class="sc-table"
                v-show="(searchData.originCharges && coscoSurchargeKey=='originSurcharges') || (searchData.destinationCharges && coscoSurchargeKey=='destinationSurcharges') || coscoSurchargeKey=='freightSurcharges'">
                <b-thead>
                  <b-tr>
                    <b-th style="width: 300px">Charge</b-th>
                    <b-th style="width: 325px">Detail</b-th>
                ...
                <b-tbody>
                  <b-tr
                    v-for="(coscoSurchargeName,
                    coscoNameKey) in coscoSurchargeType"
                    :key="coscoNameKey"
                  >
                    <b-td
                      ><b>{{
                        coscoSurchargeName.chargeName != null
                          ? coscoSurchargeName.chargeCode +
                            " - " +
                            coscoSurchargeName.chargeName
                          : coscoSurchargeName.chargeCode
                      }}</b></b-td
                    >
                    <b-td>{{ coscoSurchargeName.calculationType }}</b-td>
                    <!-- <b-td></b-td>
                          <b-td></b-td> -->
                    <b-td
                      v-for="(coscoSurchargeContainer,
                  ...
                  <b-tr>
                    ...
                    >
                    <b-td
                      v-for="(coscoTypeTotal, coscoTypeTotalKey) in coscoResult
                        .pricingDetails.totalRatePerType[
                        'totalRate' +
                          coscoSurchargeKey
                            .substring(0, coscoSurchargeKey.length - 10)
                      ...
                      :key="coscoTypeTotalKey"
                    >
                      <b
                        >{{ coscoTypeTotal.currency }}
                        {{ coscoTypeTotal.total }}
                      </b></b-td
                    >
                  </b-tr>
                </b-tbody>
          ...
          <b-collapse
            ...
            :accordion="'my-accordion-' + coscoResult.accordion_id"
            role="tabpanel"
            v-model="coscoResult.scheduleCollapse"
          >
            <h5 class="mb-5 title-schedule"><b>Schedule Information</b></h5>
            ...
            <b-tabs
              ...
              vertical
              class="d-none d-lg-flex"
              v-model="coscoResult.activeTab"
            >
              <b-tab
                v-for="(route, routeKey) in coscoResult.routingDetails"
                :key="routeKey"
              >
                <!-- INFORMACION PRINCIPAL -->
                <template #title>
                  ...
                  >
                    <div class="row" style="width: 100%">
                      ...
                      <div class="col-xl-6 schedule-info">
                        ...
                        <ul>
                          <li
                            v-for="(coscoDeadline, coscoDeadlineKey) in route
                              .details[0].deadlines"
                            :key="coscoDeadlineKey"
                          >
                            <h5 class="sub-title-schedule">
                              <b>{{ coscoDeadline.deadlineKey }}:</b>
                            </h5>
                            <p class="text-schedule">
                              {{
                                coscoDeadline.deadline.substring(0, 10) +
                                  " " +
                                  coscoDeadline.deadline.substring(
                                    11,
                                    coscoDeadline.deadline.length - 4
                                  )
                              }}
                            </p>
                          </li>
                        ...
                        <div class="row" style="width: 100%">
                          ...
                          <div class="col-sm-6 schedule-info">
                            ...
                            <ul>
                              <li
                                v-for="(coscoDeadline,
                                coscoDeadlineKey) in route.details[0].deadlines"
                                :key="coscoDeadlineKey"
                              >
                                <h5 class="sub-title-schedule">
                                  <b>{{ coscoDeadline.deadlineKey }}:</b>
  ...
  methods: {
    ...
    callAPIs() {
      ...
      component.datalists.carriers_api.forEach(function(carrier) {
        component.$set(component.results, carrier.code, []);
      });
          ...
          axios
            ...
            .then((response) => {
              response.data.forEach(function(respData) {
                if (
                  respData.companyCode == "maersk" ||
                  respData.companyCode == "sealand" ||
                  respData.companyCode == "seau"
                ) {
    ...
    hideCharges(responseData) {
      if (!this.searchData.originCharges && !this.searchData.destinationCharges) {
        ...
        responseData.pricingDetails.totalRatePerContainer.forEach( function(totalPerCont) {
          ...
          //En caso exista un totalCommon debe usarse para evitar diferencias entre monedas diferentes y resultados negativos
          if(totalRateDestination.length > 0){
