<template>
  <div class="container-cards">
          ...
          <div class="row col-12 col-lg-8 margin-res">
            ...
            <div class="col-12">
              ...
              <h6 class="mt-4 mb-5 contract-title">
                ...
                <b-popover :target="'popover-name-'+cmaResultKey" triggers="hover" placement="top">
                  <ul class="pl-2 ml-2">
    ...
    <div
      class="mb-4"
      v-for="(cmaResult, cmaResultKey) in orderedCmaRates"
      :key="cmaResultKey + 'evergreen'"
    >
      <div class="result-search">
        <div class="banda-top evergreen"><span>EVERGREEN</span></div>
